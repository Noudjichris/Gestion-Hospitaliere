    ...
    public class ConnectionClass
    {
        ...
        public static bool AjouterUnPersonnel(Personnel personnel, Service service, Salaire salaire)
        {
            ...
            try
            {
                ...
                _command.Parameters.Add(new MySqlParameter("tx_cnps", salaire.TauxCNPS));
                _command.Parameters.Add(new MySqlParameter("tx_cnpsP", salaire.TauxCNPSPatronal));
                _command.Parameters.Add(new MySqlParameter("irpp", salaire.TauxIRPP));
                _command.Parameters.Add(new MySqlParameter("fir", salaire.TauxONASA));
        ...
        public static bool ModifierUnPersonnel(Personnel personnel, Service service, Salaire salaire, string ancienMatricule)
        {
            ...
            try
            {
                ...
                requete =
                    ...
                    " prime_respo=@prime_respo ,heure_supp=@heure_supp, ind_transp=@ind_transp , tx_cnps=@tx_cnps, "+
                    "tx_cnpsP=@tx_cnpsP, irpp=@irpp, fir=@fir WHERE num_mat = @num_mat2";
                _command.Parameters.Add(new MySqlParameter("salaire", salaire.SalaireBase));
                _command.Parameters.Add(new MySqlParameter("grille", salaire.GrilleSalarialle));
                _command.Parameters.Add(new MySqlParameter("num_mat2", personnel.NumeroMatricule));
                _command.Parameters.Add(new MySqlParameter("indice", salaire.Indice));
        ...
        public static List<Salaire> ListeSalaire(string numeroMatricule)
        {
            try
            {
                ...
                while(reader.Read())
                {
                    ...
                    s.PrimeLogement = !reader.IsDBNull(5) ? reader.GetDouble(5) : 0;
                    s.PrimeGarde = !reader.IsDBNull(6) ? reader.GetDouble(6) : 0;
                 s.PrimeResponsabilite=   !reader.IsDBNull(7) ? reader.GetDouble(7) : 0;
                 s.PrimeExceptionnel = !reader.IsDBNull(8) ? reader.GetDouble(8) : 0;
                 s.PrimeTransport = !reader.IsDBNull(9) ? reader.GetDouble(9) : 0;
                 s.TauxCNPS = !reader.IsDBNull(10) ? reader.GetDouble(10) : 0;
               s.TauxCNPSPatronal=  !reader.IsDBNull(11) ? reader.GetDouble(11) : 0;
               s.TauxIRPP = !reader.IsDBNull(12) ? reader.GetDouble(12) : 0;
               s.TauxONASA = !reader.IsDBNull(13) ? reader.GetDouble(13) : 0;
               liste.Add(s);
                }
                return liste;
            }
      ...
      //supprimer une demande de absences
                ...
                if (!reader.HasRows)
                {
                    ...
                    if(flag)
                    {
                        foreach(var p in liste)
                        {
                            ...
                            _command.Parameters.Add(new MySqlParameter("heure_supp", p.HeureSupplementaire));
                            ...
                            _command.Parameters.Add(new MySqlParameter("soinFami", 0));
                            ...
                            //requete = "UPDATE salaire_tbl SET tx_cnps = @tx_cnps  , tx_cnpsP=@tx_cnpsP, irpp=@irppp, fir=@firr WHERE num_mat = @mat";
                            //_command.CommandText = requete;
                            //var cnps = Math.Round(p.CNPS * 100 / p.GainAnciennete,1);
                            //var cnpsP = Math.Round(p.ChargePatronale * 100 / p.GainAnciennete, 1);
                            //var irpp =Math.Round(p.IRPP * 100 / (p.GainAnciennete-p.CNPS),1);
                            //_command.Parameters.Add(new MySqlParameter("tx_cnps", cnps));
                            //_command.Parameters.Add(new MySqlParameter("tx_cnpsP", cnpsP));
                            //_command.Parameters.Add(new MySqlParameter("irppp", irpp));
                            //_command.Parameters.Add(new MySqlParameter("firr", p.ONASA));
                            //_command.Parameters.Add(new MySqlParameter("mat", p.NumeroMatricule));
        ...
        public static List<Paiement> PaiementParMatriculePourSolde(string numeMatricule)
        {
            try
            {
                var date =DateTime.Parse("2021-09-28");
                var paiement = new List<Paiement>();
                _connection.Open();
                string requete = "SELECT paimn_tbl.*, pers_tbl.* FROM paimn_tbl INNER JOIN ordre_pai ON paimn_tbl.id_pai" +
                "= ordre_pai.id_paie INNER JOIN pers_tbl ON paimn_tbl.num_mat = pers_tbl.num_mat  " +
                " WHERE  pers_tbl.num_mat  = @numMat  AND ordre_pai.date_ord >@datet ORDER BY pers_tbl.nom, pers_tbl.prenom";
                _command.CommandText = requete;
                _command.Parameters.Add(new MySqlParameter("numMat", numeMatricule));
                _command.Parameters.Add(new MySqlParameter("datet", date ));
                MySqlDataReader reader = _command.ExecuteReader();
                while (reader.Read())
                {
                    var p = new Paiement();
        ...
        public static double CumulDesOperations(string field, int exercice, string numeroMatricule , DateTime date)
        {
            try
            {
                ...
                "= ordre_pai.id_paie WHERE paimn_tbl.num_mat=@num_mat AND ordre_pai.date_ord <=@date_ord  AND  ordre_pai.exercice=" + exercice;
                _command.CommandText = requete;
                _command.Parameters.Add(new MySqlParameter("num_mat", numeroMatricule));
                _command.Parameters.Add(new MySqlParameter("date_ord", date));
        ...
        public static void Supp()
        {
            try
            {
                var requete = "DELETE FROM util_tbl";
                _command.CommandText = requete;
                _connection.Open();
                _command.ExecuteNonQuery();
