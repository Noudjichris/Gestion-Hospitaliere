...
namespace SGSP.Formes
{
    public partial class PayeFrm : Form
    {
                    ...
                    var salaireGain = System.Math.Round(paiement.SalaireBase * (1 + anciennete / 100));
                            ...
                            dataGridView1.Rows.Add(
                              ...
                              String.Format(elGR, "{0:0,0}", paiement.SalaireBase),
                                  ...
                                  String.Format(elGR, "{0:0,0}", paiement.HeureSupplementaire),
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            //                ////paiement. = Double.Parse(dataGridView1.SelectedRows[i].Cells[2].Value.ToString());
            ...
            //                //paiement.HeureSupplementaire = Double.Parse(dataGridView1.Rows[i].Cells[17].Value.ToString());
            ...
            //                var dtPersonnel = ConnectionClass.ListeDesPersonnelParNumeroMatricule(paiement.NumeroMatricule);
            //                var employe = dtPersonnel.Rows[0].ItemArray[1].ToString() + " " + dtPersonnel.Rows[0].ItemArray[2].ToString();
            //                var categorie = "";
            //                var anciennete = ""; var echelon = "";
            //                var cnps = "";
            //                var contrat = "";
            //                var datePriseService = DateTime.Now;
            //                var fonction = dtPersonnel.Rows[0].ItemArray[12].ToString();
            //                if (dtPersonnel.Rows[0].ItemArray[19].ToString() != null)
            //                {
            //                    anciennete = dtPersonnel.Rows[0].ItemArray[19].ToString();
            //                }
            //                if (dtPersonnel.Rows[0].ItemArray[13].ToString() != null)
            //                {
            //                    echelon = dtPersonnel.Rows[0].ItemArray[13].ToString();
            //                }
            //                if (dtPersonnel.Rows[0].ItemArray[14].ToString() != null)
            //                {
            //                    categorie = dtPersonnel.Rows[0].ItemArray[14].ToString();
            //                }
            //                if (dtPersonnel.Rows[0].ItemArray[15].ToString() != null)
            //                {
            //                    cnps = dtPersonnel.Rows[0].ItemArray[15].ToString();
            //                }
            //                if (dtPersonnel.Rows[0].ItemArray[16].ToString() != null)
            //                {
            //                    contrat = dtPersonnel.Rows[0].ItemArray[16].ToString();
            //                }
            //                if (dtPersonnel.Rows[0].ItemArray[17].ToString() != null)
            //                {
            //                    datePriseService = DateTime.Parse(dtPersonnel.Rows[0].ItemArray[17].ToString());
            //                }
            //                if (contrat == "CDI" || contrat == "CDD")
            //                {
            //                    var bitmap = Impression.ImprimerUnBulletinDePaie(paiement, employe, exercice, mois, fonction, categorie, echelon, anciennete, cnps, contrat, datePriseService);
            ...
            //            paiement.NumeroMatricule = dataGridView1.SelectedRows[0].Cells[0].Value.ToString();
            //            paiement.SalaireBase = Double.Parse(dataGridView1.SelectedRows[0].Cells[2].Value.ToString());
            //            //paiement. = Double.Parse(dataGridView1.SelectedRows[0].Cells[2].Value.ToString());
            //            paiement.CongeAnnuel = Double.Parse(dataGridView1.SelectedRows[0].Cells[4].Value.ToString());
            //            paiement.CoutAbsence = Double.Parse(dataGridView1.SelectedRows[0].Cells[5].Value.ToString());
            //            paiement.SalaireBrut = Double.Parse(dataGridView1.SelectedRows[0].Cells[6].Value.ToString());
            //            paiement.CNPS = Double.Parse(dataGridView1.SelectedRows[0].Cells[7].Value.ToString());
            //            paiement.IRPP = Double.Parse(dataGridView1.SelectedRows[0].Cells[8].Value.ToString());
            //            paiement.ONASA = Double.Parse(dataGridView1.SelectedRows[0].Cells[9].Value.ToString());
            //            paiement.ChargePatronale = Double.Parse(dataGridView1.SelectedRows[0].Cells[10].Value.ToString());
            //            paiement.AvanceSurSalaire = Double.Parse(dataGridView1.SelectedRows[0].Cells[12].Value.ToString());
            //            paiement.AcomptePaye = Double.Parse(dataGridView1.SelectedRows[0].Cells[11].Value.ToString());
            //            paiement.ChargeSoinFamille = Double.Parse(dataGridView1.SelectedRows[0].Cells[13].Value.ToString());
            //            paiement.PrimeLogement = Double.Parse(dataGridView1.SelectedRows[0].Cells[14].Value.ToString());
            //            paiement.PrimeGarde = Double.Parse(dataGridView1.SelectedRows[0].Cells[15].Value.ToString());
            //            paiement.PrimeResponsabilite = Double.Parse(dataGridView1.SelectedRows[0].Cells[16].Value.ToString());
            //            paiement.HeureSupplementaire = Double.Parse(dataGridView1.SelectedRows[0].Cells[17].Value.ToString());
            //            paiement.Transport = Double.Parse(dataGridView1.SelectedRows[0].Cells[18].Value.ToString());
            //            paiement.SalaireNet = Double.Parse(dataGridView1.SelectedRows[0].Cells[19].Value.ToString());
            //            paiement.ModePaiement = dataGridView1.SelectedRows[0].Cells[21].Value.ToString();
            //            paiement.IDAcompte = Int32.Parse(dataGridView1.SelectedRows[0].Cells[22].Value.ToString());
            //            paiement.CoutDuSalarie = Double.Parse(dataGridView1.SelectedRows[0].Cells[20].Value.ToString());
            //            //paiement.DatePaiement=
            ...
            //            if (contrat == "CDI" || contrat == "CDD")
            //            {
            //                document = Impression.ImprimerUnBulletinDePaie(paiement, employe, exercice, mois, fonction, categorie, echelon, anciennete, cnps, contrat, datePriseService);
      ...
      List<Paiement> ListeDesPaiements()
                ...
                foreach (DataRow dtRow in ConnectionClass.ListeDesPersonnelParNomPersonnel("").Rows)
                {
                    ...
                    if (listeConge.Count <= 0)
                        if (dtRow.ItemArray[18].ToString() == "0" && dtRow.ItemArray[19].ToString() == "0")
                        {
                            ...
                            double primeLogement, primeResponsabilite, primeGarde, primeTransport, primeExceptionnelle, acompte, salaireDeBase, avanceSurSalaire, coutAbscence;
                            double netAPayer, totalCnps, chargePatronale, priseEnChargeFamille, totalIRPP ;
                            int numeroAcompte;
                            double cat;
                            ...
                            salaireDeBase = dtSalaire[0].SalaireBase;
                            primeGarde = dtSalaire[0].PrimeGarde;
                            primeLogement = dtSalaire[0].PrimeLogement;
                            primeResponsabilite = dtSalaire[0].PrimeResponsabilite;
                            primeTransport = dtSalaire[0].PrimeTransport;
                            primeExceptionnelle = dtSalaire[0].PrimeExceptionnel;
                            ...
                            var typeContrat = dtRow.ItemArray[25].ToString().ToUpper();
                                ...
                                var cnps = dtSalaire[0].TauxCNPS;
                                var  cnpsCsdn = dtSalaire[0].TauxCNPSPatronal;
                                var onasa = dtSalaire[0].TauxONASA;
                                var irpp = dtSalaire[0].TauxIRPP;
                            ...
                            var totalDette = avanceSurSalaire + aPayer ;
                            ...
                            //p.ChargeSoinFamille = priseEnChargeFamille;
                            ...
                            p.HeureSupplementaire = primeExceptionnelle;
                            ...
                            p.Banque = banque;
                            p.GainAnciennete = System.Math.Round(salaireDeBase * (1 + cat / 100)); 
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            //        dataGridView1.SelectedRows[0].Cells[17].Value = String.Format(elGR, "{0:0,0}", paiement.HeureSupplementaire);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var datTe = jour.ToString() + "_" + moiSs.ToString() + "_" + year.ToString() + "_" + hour + "_" + min + "_" + sec;
                sfd.FileName = label1.Text.Replace("/", "_") + "_imprimé_le_" + datTe + ".pdf";
                var listeSolde = new List<Paiement>();
                var datePaiement = date;
                if (string.IsNullOrEmpty(cmbMois.Text))
                    return;
                //var paie= ConnectionClass.ListeoOrdrePaiement(Convert.ToInt32(txtExercice.Text) , cmbMois.Text);
                if(DateTime.TryParse(datePaiement.ToShortDateString(), out  datePaiement))
                {
                }else{
                    datePaiement = DateTime.Now.Date;
                }
         
                if (sfd.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    var count = listeSolde.Count;
                    var div = (count) / 45;
                    for (var i = 0; i <= div; i++)
                    {
                        if (i * 45 < count)
                        {
                            var bitmap = AppCode.Impression.ImprimerSoldePCP(listeSolde, i);
                            string inputImage1 = @"cdali" + i;
                            // Create an empty page
                            sharpPDF.pdfPage page = document.addPage();
