...
namespace SGSP
{
    public partial class PersonnelFrm : Form
    {
        ...
        private double salaireBrut; decimal grilleSalariale, indice;
        double primeRespons, primeGarde, primeTransport, primeExcep, primeLogement,tauxCNPS, tauxIRPP, tauxCNPSPatronal,tauxONASA;
        #endregion
 ...
 if (double.TryParse(txtPrimeDeGarde.Text, out primeGarde)) { }
                 ...
                 if (double.TryParse(txtTauxCNPS.Text, out tauxCNPS)) { }
                if(double.TryParse(txtTauxCNPSP.Text , out tauxCNPSPatronal)){}
                if(double.TryParse(txtIRPP.Text , out tauxIRPP)){}
                if(double.TryParse(txtFIR.Text , out tauxONASA)){}
                ...
                salaire.TauxCNPS = tauxCNPS;
                salaire.TauxCNPSPatronal = tauxCNPSPatronal;
                salaire.TauxIRPP=tauxIRPP;
                salaire.TauxONASA = tauxONASA;
                 if (etat == "2")
                {
        ...
        private void PersonnelFrm_Load(object sender, EventArgs e)
        {
                ...
                var listeDiplome = new string[]
            {
                ...
                if (etat == "2")
                {
                    ...
                    if (dtsalaire.Count > 0)
                    {
                        txtSalaire.Text =  dtsalaire[0].SalaireBase.ToString();
                    ...
                    txtPrimeDeGarde.Text = dtsalaire[0].PrimeGarde.ToString();
                    txtPrimeExcep.Text = dtsalaire[0].PrimeExceptionnel.ToString();
                    txtPrimeResponsabilite.Text = dtsalaire[0].PrimeResponsabilite.ToString();
                    txtPrmeDeTransport.Text = dtsalaire[0].PrimeTransport.ToString();
                    txtLogement.Text = dtsalaire[0].PrimeLogement.ToString();
                    txtTauxCNPS.Text = dtsalaire[0].TauxCNPS.ToString();
                    txtTauxCNPSP.Text = dtsalaire[0].TauxCNPSPatronal.ToString();
                    txtIRPP .Text= dtsalaire[0].TauxIRPP.ToString();
                    txtFIR.Text = dtsalaire[0].TauxONASA.ToString();
                }
                else
                {
                    chkEnCours.Checked = true;
        ...
        private void dtpDateRetraite_ValueChanged(object sender, EventArgs e)
        {
            if (dtpDateRetraite.Value.Date >= DateTime.Now.Date)
            {
                chkRetraite.Checked = false;
                chkNonRetraite.Checked = true;
            }
