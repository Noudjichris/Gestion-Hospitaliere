...
namespace SGSP.AppCode
{
    public class Impression
    {
        ...
        public static Bitmap ImprimerInformatonDunPersonnel(string numeroMatricule)
        {
            ...
            //for (var i = 0; i <= 23; i++)
            //{
            //    var yLoc = unite_hauteur * i + 7 * unite_hauteur;
            //    if (i % 2 == 0)
            //    {
            //        graphic.FillRectangle(Brushes.LightSlateGray, unite_largeur, yLoc, unite_largeur * 24, unite_hauteur);
            //    }
            //    else
            //    {
            //        graphic.FillRectangle(Brushes.LightYellow, unite_largeur, yLoc, unite_largeur * 24, unite_hauteur);
            //    }
            ...
            graphic.DrawString("Service bancaire", fnt11, Brushes.Black, 2 * unite_largeur, 41 * unite_hauteur + 6);
            graphic.FillRectangle(Brushes.SaddleBrown, 2 * unite_largeur, 42 * unite_hauteur + 5, unite_largeur * 22, 3);
            graphic.DrawString("Compte bancaire :", fnt1, Brushes.Black, 2 * unite_largeur, 43 * unite_hauteur);
            graphic.DrawString("Code guichet :", fnt1, Brushes.Black, 2 * unite_largeur, 44 * unite_hauteur);
            graphic.DrawString("Code banque :", fnt1, Brushes.Black, 2 * unite_largeur, 45 * unite_hauteur);
            graphic.DrawString("Clé :", fnt1, Brushes.Black, 2 * unite_largeur, 46* unite_hauteur);
            graphic.FillRectangle(Brushes.SaddleBrown, 2 * unite_largeur, 47 * unite_hauteur + 5, unite_largeur * 22, 3);
            ...
            graphic.DrawString(dtPersonnel.Rows[0].ItemArray[18].ToString(), fnt33, Brushes.Black, 8 * unite_largeur, 43 * unite_hauteur);
            graphic.DrawString(dtPersonnel.Rows[0].ItemArray[23].ToString(), fnt33, Brushes.Black, 8 * unite_largeur, 44 * unite_hauteur);
            graphic.DrawString(dtPersonnel.Rows[0].ItemArray[25].ToString(), fnt33, Brushes.Black, 8 * unite_largeur, 45 * unite_hauteur);
            graphic.DrawString(dtPersonnel.Rows[0].ItemArray[24].ToString(), fnt33, Brushes.Black, 8 * unite_largeur, 46 * unite_hauteur);

            graphic.FillRectangle(Brushes.White, 2 * unite_largeur, 47 * unite_hauteur +9, unite_largeur * 24, 1*unite_hauteur);
       ...
       , DataGridView dgvPaiement, int exercice, string mois, int start)
            ...
            , string fonction, string categorie, string echelon,string anciennete, string numeroCNPS, string contrat, DateTime datePriseService)
        {
            ...
            #endregion
          Image logo = global::SGSP.Properties.Resources.Logo;
                graphic.DrawImage(logo, 15, 10, 23 * unite_largeur, 3 * unite_hauteur);
            ...
            var jourAbscence= paiement.CoutAbsence / tauxAbscence;
            ...
            graphic.DrawString(String.Format(elGR, "{0:0,0}", paiement.CoutAbsence), fnt1, Brushes.Black, 21 * unite_largeur+4, 23 * unite_hauteur + 23);
            ...
            graphic.DrawString(String.Format(elGR, "{0:0,0}", (paiement.SalaireBrut - paiement.CNPS)), fnt1,
                Brushes.Black, 11 * unite_largeur - 5, 29 * unite_hauteur + 13);
            ...
            graphic.DrawString("Avances sur salaires  ", fnt1, Brushes.Black,2* unite_largeur, 34 * unite_hauteur + 19);
            graphic.DrawString("Acomptes  ", fnt1, Brushes.Black, 10 * unite_largeur +10, 34 * unite_hauteur + 19);
            graphic.DrawString("Prise en charge soin Famille ", fnt1, Brushes.Black, 15 * unite_largeur+ 10, 34 * unite_hauteur + 19);

            graphic.DrawString(String.Format(elGR, "{0:0,0}",paiement.AvanceSurSalaire), fnt1, Brushes.Black, 3*unite_largeur+20, 35 * unite_hauteur + 19);
            graphic.DrawString(String.Format(elGR, "{0:0,0}",paiement.AcomptePaye), fnt1, Brushes.Black, 11 * unite_largeur +5, 35 * unite_hauteur + 19);
            graphic.DrawString(String.Format(elGR, "{0:0,0}", paiement.ChargeSoinFamille), fnt1, Brushes.Black, 18 * unite_largeur - 0, 35 * unite_hauteur + 19);
            ...
            graphic.DrawRectangle(Pens.SteelBlue, 9 * unite_largeur + 8, 34 * unite_hauteur + 18, 5 * unite_largeur-7, unite_hauteur + 2);
            ...
            graphic.DrawRectangle(Pens.SteelBlue,9 * unite_largeur + 8, 35 * unite_hauteur + 20, 5 * unite_largeur -7, unite_hauteur + 2);
            ...
            graphic.DrawString(String.Format(elGR, "{0:0,0}", paiement.HeureSupplementaire),  fnt1, Brushes.Black, unite_largeur+10, 44* unite_hauteur + 7);
            ...
            var primes = paiement.Transport + paiement.HeureSupplementaire+paiement.PrimeResponsabilite+paiement.PrimeGarde+paiement.PrimeLogement;
            ...
            graphic.DrawString("N'Djaména, le  " + DateTime.Now.ToShortDateString(), fnt1, Brushes.Black, 9* unite_largeur, 52 * unite_hauteur +10);
        ...
        public static Bitmap ImprimerListeDesAcomptes(DataGridView dgvAvance, string mois, int exercice)
        {
            ...
            {
            graphic.DrawString("Liste des acomptes du mois "+ mois + " " + exercice, fnt3, Brushes.Black, unite_largeur, 5 * unite_hauteur+10);
            }else
            {
                graphic.DrawString("Liste des acomptes", fnt3, Brushes.Black, unite_largeur, 5 * unite_hauteur+5);
            }
            graphic.DrawString("Emis le " + DateTime.Now, fnt0, Brushes.Black,18* unite_largeur, 5* unite_hauteur + 5);

            graphic.FillRectangle(Brushes.SaddleBrown, unite_largeur, 7 * unite_hauteur-2, 23 * unite_largeur + 2, unite_hauteur+5);
            //graphic.DrawRectangle(Pens.White, unite_largeur - 1, 15 * unite_hauteur - 1, 9 * unite_largeur, unite_hauteur + 2);
            graphic.DrawString("N° ", fnt11, Brushes.White, unite_largeur , 7 * unite_hauteur);
            graphic.DrawString("Date ", fnt11, Brushes.White, 2*unite_largeur + 10, 7 * unite_hauteur); 
            graphic.DrawString("Nom du salarié ", fnt11, Brushes.White, unite_largeur * 6, 7 * unite_hauteur);
            graphic.DrawString("Montant ", fnt11, Brushes.White, unite_largeur * 17, 7 * unite_hauteur);
            graphic.DrawString("Signature ", fnt11, Brushes.White, unite_largeur * 20, 7 * unite_hauteur);
            var total = 0.0;
            for (int i = 0; i < dgvAvance.Rows.Count; i++)
            {
                var YLOC = 8 * unite_hauteur + 6 + i * 23;
                
                graphic.DrawLine(Pens.Salmon, unite_largeur, YLOC, unite_largeur * 24,  YLOC);
               
                if(i%2==1)
                graphic.FillRectangle(Brushes.PeachPuff, unite_largeur, YLOC, unite_largeur * 23, 23 );
                
                graphic.DrawRectangle(Pens.SaddleBrown, unite_largeur, YLOC, 23 * unite_largeur + 2, 23);
            ...
            var LOC = 8 * unite_hauteur + 7 + dgvAvance.Rows.Count* 23;
            ...
            graphic.DrawString(string.Format(elGR, "{0:0,0}", total) + " F.CFA", fnt11, Brushes.White, 20 * unite_largeur-15, LOC+2);
       ...
       public static Bitmap ImprimerListeDesCNPS(List<Paiement> liste, double montant, double montantCNPS, string mois, int exercice, int start)
       {
           ...
           for (int i = start * 40; i < liste.Count; i++)
           {
               var YLOC = 9 * unite_hauteur + j * 22 ;
                   ...
                   graphic.DrawString(liste[i].Employe, fnt1, Brushes.Black, unite_largeur + 22, YLOC + 3);
                   graphic.DrawString(string.Format(elGR, "{0:0,0}",liste[i].GainSalarial), fnt1, Brushes.Black, unite_largeur * 12 + 15, YLOC + 3);
                   graphic.DrawString("20%", fnt1, Brushes.Black, unite_largeur * 15 + 27, YLOC + 3);
                   graphic.DrawString(string.Format(elGR, "{0:0,0}", liste[i].GainSalarial*20 / 100), fnt1, Brushes.Black, unite_largeur * 17 + 15, YLOC + 3);
                   graphic.DrawString(cnps.ToLower(), fnt1, Brushes.Black, unite_largeur * 20 - 8 ,YLOC + 3);
                   numero++;
                   j++;
           ...
           graphic.DrawString("Total", fnt11, Brushes.Black, unite_largeur + 10, LOC + 12);
           graphic.DrawString(string.Format(elGR, "{0:0,0}", montant), fnt11, Brushes.Black, 12 * unite_largeur + 15, LOC + 12);
           graphic.DrawString(string.Format(elGR, "{0:0,0}",Math.Round( montant*20/100)), fnt11, Brushes.Black, 17 * unite_largeur + 15, LOC + 12);
           graphic.DrawString("Arrêté le présent bordereau à la somme de : ", fnt1, Brushes.Black,20, LOC + unite_hauteur * 4-15);
           graphic.DrawString(Converti((int)Math.Round(montant * 20 / 100)) + "Frs CFA", fnt11, Brushes.Black, 9 * unite_largeur + 20, LOC + unite_hauteur * 4 - 15);
           ...
           graphic.DrawString("Le directeur ", fnt11, Brushes.Black, 10 * unite_largeur + 10, LOC + unite_hauteur * 7);
                ...
                if (dtP.Rows.Count > 0)
                {
                    ...
                    if (ecart <= 2 * unite_hauteur)
                    {
                        graphic.DrawString(dtP.Rows[0].ItemArray[1].ToString() + " " + dtP.Rows[0].ItemArray[2].ToString(), fnt11, Brushes.Black, 8 * unite_largeur + 10, index + 2 * unite_hauteur + 10);
                    }
                    else if (ecart > 2 * unite_hauteur && ecart <= 3 * unite_hauteur)
                    {
                        graphic.DrawString(dtP.Rows[0].ItemArray[1].ToString() + " " + dtP.Rows[0].ItemArray[2].ToString(), fnt11, Brushes.Black, 8 * unite_largeur + 10, index + 3 * unite_hauteur - 5);
                    }
                    else if (ecart > 3 * unite_hauteur && ecart <= 4 * unite_hauteur)
                    {
                        graphic.DrawString(dtP.Rows[0].ItemArray[1].ToString() + " " + dtP.Rows[0].ItemArray[2].ToString(), fnt11, Brushes.Black, 8 * unite_largeur + 10, index + 4 * unite_hauteur - 5);
                    }
                    else if (ecart > 4 * unite_hauteur && ecart <= 5 * unite_hauteur)
                    {
                        graphic.DrawString(dtP.Rows[0].ItemArray[1].ToString() + " " + dtP.Rows[0].ItemArray[2].ToString(), fnt11, Brushes.Black, 8 * unite_largeur + 10, index + 5* unite_hauteur - 5);
                    }
                    else if (ecart > 5 * unite_hauteur && ecart <= 6 * unite_hauteur)
                    {
                        graphic.DrawString(dtP.Rows[0].ItemArray[1].ToString() + " " + dtP.Rows[0].ItemArray[2].ToString(), fnt11, Brushes.Black, 8 * unite_largeur + 10, index + 6 * unite_hauteur - 5);
                    }
                    else if (ecart > 6 * unite_hauteur)
                    {
                        graphic.DrawString(dtP.Rows[0].ItemArray[1].ToString() + " " + dtP.Rows[0].ItemArray[2].ToString(), fnt11, Brushes.Black, 8 * unite_largeur + 10, index + 7 * unite_hauteur - 5);
                    } 
                }
           return bitmap;
       }
       ...
       public static Bitmap ImprimerListeDesIRPPFIR(List<Paiement> liste, double montant,double totalFIR, string mois, int exercice, int start)
       {
           ...
           for (int i = start * 40; i < liste.Count; i++)
           {
               ...
               graphic.DrawString("10,50%", fnt1, Brushes.Black, unite_largeur * 15 + 5, YLOC + 3);
               graphic.DrawString(string.Format(elGR, "{0:0,0}", liste[i].IRPP), fnt1, Brushes.Black, unite_largeur * 17 + 15, YLOC + 3);
               graphic.DrawString(string.Format(elGR, "{0:0,0}", liste[i].ONASA), fnt1, Brushes.Black, unite_largeur * 20 -0, YLOC + 3);
               graphic.DrawString(string.Format(elGR, "{0:0,0}", liste[i].IRPP + liste[i].ONASA), fnt1, Brushes.Black, unite_largeur * 21 +8, YLOC + 3);
               numero++;
               j++;
       ...
       public static Bitmap ImprimerListeRecapitulatifs(DataGridView dgvRecap, string mois, int exercice)
       {
        ...
        public static Bitmap ImprimerListeDesBancaries(DataGridView dgvView)
        {
            #region
            ...
            {
                Image logo = global::SGSP.Properties.Resources.Logo;
                graphic.DrawImage(logo, unite_largeur, 0, 23 * unite_largeur, 7 * unite_hauteur);
            }
            catch { } //definir les polices 
            Font fnt1 = new Font("Arial Narrow", 13, FontStyle.Regular);
            Font fnt0 = new Font("Arial Narrow", 13, FontStyle.Underline);
            Font fnt11 = new Font("Arial Narrow", 13, FontStyle.Bold);
            Font fnt4 = new Font("Arial Narrow", 16, FontStyle.Bold);

            graphic.DrawString("Page 1", fnt1, Brushes.Black, 12 * unite_largeur, 5);
            graphic.DrawString("Liste de personnel", fnt0, Brushes.Black, unite_largeur, 9 * unite_hauteur - 15);
            System.Globalization.CultureInfo elGR = System.Globalization.CultureInfo.CreateSpecificCulture("fr-FR");

            graphic.DrawRectangle(Pens.Black, 25, 10 * unite_hauteur, unite_largeur + 12, 2 * +unite_hauteur + 9);
            graphic.DrawRectangle(Pens.Black, 2 * unite_largeur + 8, 10 * unite_hauteur, unite_largeur * 10 - 18, 2 * +unite_hauteur + 9);
            graphic.DrawRectangle(Pens.Black, 12 * unite_largeur - 7, 10 * unite_hauteur, unite_largeur + 28, 2 * +unite_hauteur + 9);
            graphic.DrawRectangle(Pens.Black, 14 * unite_largeur - 8, 10 * unite_hauteur, unite_largeur + 27, 2 * +unite_hauteur + 9);
            graphic.DrawRectangle(Pens.Black, 16 * unite_largeur - 10, 10 * unite_hauteur, unite_largeur * 3 + 27, 2 * +unite_hauteur + 9);
            graphic.DrawRectangle(Pens.Black, 19 * unite_largeur + 20, 10 * unite_hauteur, unite_largeur + 16, 2 * +unite_hauteur + 9);
            graphic.DrawRectangle(Pens.Black, 21 * unite_largeur + 7, 10 * unite_hauteur, unite_largeur * 3 - 6, 2 * +unite_hauteur + 9);

            graphic.DrawString("N°", fnt11, Brushes.Black, unite_largeur + 5, 10 * unite_hauteur + 3);
            graphic.DrawString("Nom & Penom du salarié", fnt11, Brushes.Black, 2 * unite_largeur + 10, 10 * unite_hauteur + 3);
            graphic.DrawString("Code\nBanque", fnt11, Brushes.Black, 12 * unite_largeur - 5, 10 * unite_hauteur + 3);
            graphic.DrawString("Code\nguichet", fnt11, Brushes.Black, 14 * unite_largeur - 6, 10 * unite_hauteur + 3);
            graphic.DrawString("N° compte", fnt11, Brushes.Black, 16 * unite_largeur + 10, 10 * unite_hauteur + 3);
            graphic.DrawString("Clé", fnt11, Brushes.Black, 19 * unite_largeur + 28, 10 * unite_hauteur + 3);
            graphic.DrawString("Montant", fnt11, Brushes.Black, 21 * unite_largeur + 20, 10 * unite_hauteur + 3);


            var total = .0;
            for (int i = 0; i <= dgvView.Rows.Count - 1; i++)
            {
                int Yloc = unite_hauteur * i + 12 * unite_hauteur + 12;

                graphic.DrawRectangle(Pens.Black, 25, Yloc, unite_largeur + 12, unite_hauteur);
                graphic.DrawRectangle(Pens.Black, 2 * unite_largeur + 8, Yloc, unite_largeur * 10 - 18, unite_hauteur);
                ...
                var dt = ConnectionClass.ListeDesPersonnelParNumeroMatricule(dgvView.Rows[i].Cells[0].Value.ToString());
                if (dt.Rows.Count > 0)
                {
                    if (!string.IsNullOrEmpty(dt.Rows[0].ItemArray[18].ToString()))
                    {
                        graphic.DrawString(dt.Rows[0].ItemArray[18].ToString(), fnt1, Brushes.Black, unite_largeur * 16 + 5, Yloc);
                    }
                }

                if (dt.Rows.Count > 0)
                {
                    if (!string.IsNullOrEmpty(dt.Rows[0].ItemArray[23].ToString()))
                    {
                        graphic.DrawString(dt.Rows[0].ItemArray[23].ToString(), fnt1, Brushes.Black, unite_largeur * 12 - 4, Yloc);
                    }
                } if (dt.Rows.Count > 0)
                {
                    if (!string.IsNullOrEmpty(dt.Rows[0].ItemArray[24].ToString()))
                    {
                        graphic.DrawString(dt.Rows[0].ItemArray[24].ToString(), fnt1, Brushes.Black, unite_largeur * 14 - 4, Yloc);
                    }
                }
                if (dt.Rows.Count > 0)
                {
                    if (!string.IsNullOrEmpty(dt.Rows[0].ItemArray[25].ToString()))
                    {
                        graphic.DrawString(dt.Rows[0].ItemArray[25].ToString(), fnt1, Brushes.Black, unite_largeur * 19 + 25, Yloc);
                    }
                }
                graphic.DrawString((i + 1).ToString(), fnt1, Brushes.Black, unite_largeur + 3, Yloc);
                graphic.DrawString(dgvView.Rows[i].Cells[1].Value.ToString(), fnt1, Brushes.Black, 2 * unite_largeur + 15, Yloc);
                graphic.DrawString(String.Format(elGR, "{0:0,0}", double.Parse(dgvView.Rows[i].Cells[16].Value.ToString())),
                    fnt1, Brushes.Black, unite_largeur * 21 + 15, Yloc);
                //total += double.Parse(dgvView.Rows[i].Cells[16].Value.ToString());
            }

            for (var jj = 0; jj < dgvView.Rows.Count; jj++)
            {
                total += double.Parse(dgvView.Rows[jj].Cells[16].Value.ToString());
            }

            graphic.FillRectangle(Brushes.White, 10, 40 * unite_hauteur + 13, unite_largeur * 24, unite_hauteur * 10);
            if (dgvView.Rows.Count <= 27)
            {
                graphic.DrawRectangle(Pens.Black, 25, 39 * unite_hauteur + 15, unite_largeur * 23 + 9, unite_hauteur * 2);
                graphic.DrawString("Total (F. CFA)", fnt11, Brushes.Black, unite_largeur + 20, 40 * unite_hauteur);
                graphic.DrawString(String.Format(elGR, "{0:0,0}", total), fnt11, Brushes.Black, unite_largeur * 21, 40 * unite_hauteur);

            }
            return bitmap;
        }

        public static Bitmap ImprimerListeDesBancaries(DataGridView dgvView, int start)
        {
            #region
            int unite_hauteur = 23;
            int unite_largeur = 32;
            ...
            graphic.DrawRectangle(Pens.Black, 25, 2 * unite_hauteur, unite_largeur + 12, 2 * +unite_hauteur + 9);
            graphic.DrawRectangle(Pens.Black, 2 * unite_largeur + 8, 2 * unite_hauteur, unite_largeur * 10 - 18, 2 * +unite_hauteur + 9);
            ...
            graphic.DrawString("Nom & Penom du salarié", fnt11, Brushes.Black, 2 * unite_largeur + 15, 2 * unite_hauteur + 3);
            ...
            var total = .0;
            var j = 0;
            for (int i = 28 + start * 35; i < dgvView.Rows.Count; i++)
            {
            ...
            graphic.FillRectangle(Brushes.White, 10, 39 * unite_hauteur + 13, unite_largeur * 25, unite_hauteur * 10);
            if (dgvView.Rows.Count <= 28 + (1 + start) * 35)
            {
                graphic.DrawRectangle(Pens.Black, 25, 39 * unite_hauteur + 15, unite_largeur * 23 + 8, unite_hauteur * 2);
                graphic.DrawString("Total (F. CFA)", fnt11, Brushes.Black, unite_largeur + 20, 40 * unite_hauteur);
                graphic.DrawString(String.Format(elGR, "{0:0,0}", total), fnt11, Brushes.Black, unite_largeur * 21, 40 * unite_hauteur);
