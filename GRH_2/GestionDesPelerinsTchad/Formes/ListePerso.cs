...
namespace SGSP.Formes
{
    public partial class ListePerso : Form
    {
        ...
        public static string btnClick, mois,state, indiceAnciennete, fonction, indexRecherche, compteBancaire, numerMatricule, nomPersonnel, etatContrat, etatRetraite, typeContrat;
