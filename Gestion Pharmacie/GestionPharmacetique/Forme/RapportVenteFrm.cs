    ...
    public partial class RapportVenteFrm : Form
    {
        ...
        private void ListeDesRapportsVentes(DataTable dataTable)
        {
            try
            {
                ...
                if(comboBox1.Text=="Vente comptant" || comboBox1.Text=="")
                if(Montant >solde)
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (comboBox1.Text == "Vente comptant")
                    {
                        dataTable = ConnectionClass.ListeDesVentes(true,caissier, dateDebut, dateFin.Date.AddHours(24));
                    }
                    else if (comboBox1.Text == "Vente à crédit")
                    {
                        dataTable = ConnectionClass.ListeDesVentes(false,caissier, dateDebut, dateFin.Date.AddHours(24));
                    }
