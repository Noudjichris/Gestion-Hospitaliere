    ...
    public class ConnectionClassClinique
    {
        ...
        static ConnectionClassClinique()
        {
            string connectionString =
                @"server=172.24.114.7;user id=sos;password=sos2019;database=clinique_db"; //AdminSOS2019
        ...
        public static List<Facture> TableDesProFacturesProforma(int id)
        {
            var listefacture = new List<Facture>();
            try
            {
                requete = "SELECT pro_facture_tbl.*, empl_tbl.*, patient_tbl.*  FROM pro_facture_tbl   INNER JOIN  patient_tbl ON pro_facture_tbl.num_patient=patient_tbl.id " +
                    " INNER JOIN empl_tbl ON pro_facture_tbl.num_empl = empl_tbl.num_empl WHERE pro_facture_tbl.id_fact=" + id;
                //" WHERE pro_facture_tbl.date_fact>=@date1 AND pro_facture_tbl.date_fact <@date2 AND patient_tbl.entrep LIKE '%" + entreprise + "%'";
                command.CommandText = requete;
                connection.Open();
                var reader = command.ExecuteReader();
        ...
        public static bool AjouterUneEntreprise(Entreprise entreprise)
        {
            ...
            try
            {
                ...
                {
                    reader.Close();
                    requete = "INSERT INTO entre_tbl (entreprise,tele1,tele2,email,adresse,date_abon,tauxHon) "+
                        "VALUES(@entreprise,@tele1,@tele2,@email,@adresse,@date_abon,@tauxHon)";
        ...
        public static bool ModifierUneEntreprise(Entreprise entreprise)
        {
            ...
            try
            {
                ...
                requete = "UPDATE entre_tbl SET entreprise = @entreprise,tele1 = @tele1,tele2=@tele2,"+
                    " email=@email,adresse=@adresse , date_abon=@date_abon,tauxHon = @tauxHon  WHERE id = " + entreprise.NumeroEntreprise;
                command.Parameters.Add(new MySqlParameter("entreprise", entreprise.NomEntreprise));
                command.Parameters.Add(new MySqlParameter("tele1", entreprise.Telephone1));
                command.Parameters.Add(new MySqlParameter("tele2", entreprise.Telephone2));
                command.Parameters.Add(new MySqlParameter("email", entreprise.Email));
        ...
        public static List<Entreprise> ListeDesEntreprises()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    var entreprise = new Entreprise(id,entrepr,tele1,tele2,email,adresse,date,frais);
        ...
        public static List<Entreprise> ListeDesEntreprises(string entrepri)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    var date = reader.GetDateTime(6);
                    var frais = !reader.IsDBNull(7) ? reader.GetDouble(7) : 0.0;
                    var entreprise = new Entreprise(id, entreprises, tele1, tele2, email, adresse, date, frais);
                    listeEntreprise.Add(entreprise);
                }
            }
            catch (Exception ex)
        ...
        public static bool EnregistrerUneFacture(Facture facture, DataGridView dgvFacture, int numActe, string TypeFacture, double montantPaye, bool siConventionne)
        {
            var flag = false;
            try
            {
                ...
                {
                    requete = "INSERT INTO pro_facture_tbl (date_fact, montant_fact,num_patient,num_empl, num_acte, acte) " +
                  " VALUES(@date_fact1," + facture.MontantFactural * (100 - facture.PartPatient) / facture.PartPatient + "," + facture.IdPatient + ",'" + facture.NumeroEmploye +
                  "', " + facture.NumeroActe + ",'" + facture.Acte + "')";
                ...
                foreach (DataGridViewRow dtRow in dgvFacture.Rows)
                {
                    ...
                    if (siConventionne)
                    {
                        ...
                        command.Parameters.Add(new MySqlParameter("prix1", prix * (100 - facture.PartPatient) / 100));
                        command.Parameters.Add(new MySqlParameter("prix_total1", prix_total * (100 - facture.PartPatient) / 100));
        ...
        public static List<Facture> RecettesLaboratoireConventionne(DateTime date1, DateTime date2,string entreprise)
        {
            ...
            try
            {
                var requete = "SELECT  pro_det_fact.design, SUM(pro_det_fact.qte), pro_det_fact.prix,SUM(pro_det_fact.prix_total), pro_det_fact.groupage  FROM pro_det_fact INNER JOIN" +
                            ...
                            "patient_tbl.id WHERE pro_det_fact.groupage  LIKE '%Laboratoire%' AND patient_tbl.entrep='" + entreprise + "' AND " +
...
listeOccupation.Add(salle);
            ...
            try
            {
                ...
                transaction = connection.BeginTransaction();
                 requete = "INSERT INTO `emp_entr` (`nom`, `sexe`, `age`, `tele`, `id_entre`)" +
                    ...
                    requete = "INSERT INTO patient_tbl (`nom`,`prenom`,`sexe`,`age`,`telephone`,`entrep`,`rhesus`,`sc`,`date_enre`,`adresse`,`nosocial`,`fonction`)" +
           " VALUES(@nom,@prenom,@sexe,@age,@telephone,@entrep,@rhesus,@sc,@date_enre,@adresse,@nosocial,@fonction)";
        ...
        public static void ModifierEmployeeEntreprise(EmployeEntreprise employee,string sousCouvert)
        {
            try
            {
                connection.Open();
                ...
                string requete =
                    string.Format(
                        "UPDATE emp_entr SET nom = @nomEmpl, sexe = @sexeEmpl, age = @ageEmpl, tele = @teleEmpl , id_entre = @id_entre"+
                ...
                requete = "UPDATE patient_tbl SET  sc = @sc1  WHERE sc = @sc2"  ;
        ...
        public static List<EmployeEntreprise> ListeDesEmployeesEntreprise()
        {
           var list = new List<EmployeEntreprise>();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    var num_emplo = reader.GetInt32(0);
                    var nom_empl = reader.GetString(1);
                    var sexe = reader.GetString(2);
                    var age = reader.GetInt32(3);
                    var telephone = !reader.IsDBNull(4) ? reader.GetString(4) : "";
                    var idEntre = reader.GetInt32(5);
                    var employe = new EmployeEntreprise(num_emplo, nom_empl, sexe, age, telephone, idEntre);
                    list.Add(employe);
                }
            }
            catch (Exception exception)
        ...
        // ajouter un nouveau Employee
        public static bool EnregistrerUnCertifiactDeGrossesse(CertificatDeGrossesse certificat)
        {
            var flag = false;
            try
            {
                ...
                if (certificat.ID <= 0)
                {
                    requete = "INSERT INTO `certif_gross` ( `id_patient`, `num_doc`, `periode`,`ddr`, `date_ac`,`date_conge`)" +
                               " VALUES ( @id_patient, @num_doc, @periode, @ddr, @date_ac,@date_conge )";
                }
                else
                {
                    requete = "UPDATE `certif_gross` SET `num_doc`=@num_doc, `periode`=@periode,`ddr`=@ddr , `date_ac`=date_ac, `date_conge`=@date_conge WHERE id=" + certificat.ID;
                }
                command.Parameters.Add(new MySqlParameter("id_patient", certificat.IDPatient));
                command.Parameters.Add(new MySqlParameter("num_doc", certificat.Matricule));
                command.Parameters.Add(new MySqlParameter("periode", certificat.PeriodeGrossesse));
                command.Parameters.Add(new MySqlParameter("ddr", certificat.DateDDR));
                command.Parameters.Add(new MySqlParameter("date_ac", certificat.DateAccouchement));
                command.Parameters.Add(new MySqlParameter("date_conge", certificat.DateConge));
                command.CommandText = requete;
                command.ExecuteNonQuery();

                MonMessageBox.ShowBox("Données enregistrées avec succés dans la base de données",
                    "Enregistrement", "affirmation.png");
                flag = true;
        ...
        public static List<CertificatDeGrossesse> ListeDesCertificatDeGrossesse()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    certif.Matricule = reader.GetString(2);
                    certif.PeriodeGrossesse = reader.GetInt32(3);
                    certif .DateDDR  = reader.GetDateTime(4) ;
                    certif.DateAccouchement = reader.GetDateTime(5);
                    certif.DateConge  =reader.GetDateTime(6);
                    list.Add(certif);
                }
                return list;
            }
        ...
        public static bool AjouterUnCertificatNaissance(CertificatNaissance certificat)
        {
            ...
            try
            {
                ...
                if (certificat.ID <= 0)
                {
                    requete = "INSERT INTO `certif_nai` ( `idPatient`, `date_nai_mere`,  `lieu_nai_mere`, `num_empl`, `nom_bebe`,`date_nai_bebe`,  " +
                             " `lieu_nai_bebe`, `sexe_bebe`,`poids_bebe`, `nom_pere`, `prof_pere`, `date_nai_pere`, `lieu_nai_pere`) VALUES(@idPatient,@date_naissance_mere," +
                             "@lieu_naissance_mere,@num_empl,@nom_bebe,@date_nai_bebe,@lieu_nai_bebe,@sexe_bebe,@poids_bebe,@nom_pere,@prof_pere,@date_nai_pere,@lieu_nai_pere)";
                }
                else
                {
                    requete = "UPDATE `certif_nai` SET `idPatient`=@idPatient, `date_nai_mere`=@date_naissance_mere,  `lieu_nai_mere`=@lieu_naissance_mere," +
                        "`num_empl`=@num_empl, `nom_bebe`=@nom_bebe,`date_nai_bebe`=@date_nai_bebe, `lieu_nai_bebe`=@lieu_nai_bebe, `sexe_bebe`=@sexe_bebe," +
                        "`poids_bebe`=@poids_bebe, `nom_pere`=@nom_pere, `prof_pere`=@prof_pere, `date_nai_pere`=@date_nai_pere, `lieu_nai_pere`=@lieu_nai_pere WHERE id =" + certificat.ID;
                }
                command.Parameters.Add(new MySqlParameter("idPatient", certificat.IDPatient));
                command.Parameters.Add(new MySqlParameter("date_naissance_mere", certificat.DateNaissanceMere));
                command.Parameters.Add(new MySqlParameter("lieu_naissance_mere", certificat.LieuNaissanceMere));
                command.Parameters.Add(new MySqlParameter("num_empl", certificat.NumeroEmplye));
                command.Parameters.Add(new MySqlParameter("nom_bebe", certificat.NomEnfant));
                command.Parameters.Add(new MySqlParameter("date_nai_bebe", certificat.DateNaissanceEnfant));
                command.Parameters.Add(new MySqlParameter("lieu_nai_bebe", certificat.LieuNaissanceEnfant));
                command.Parameters.Add(new MySqlParameter("sexe_bebe", certificat.Sexe));
                command.Parameters.Add(new MySqlParameter("poids_bebe", certificat.Poids));
                command.Parameters.Add(new MySqlParameter("nom_pere", certificat. NomPere));
                command.Parameters.Add(new MySqlParameter("prof_pere", certificat.ProfessionPere));
                command.Parameters.Add(new MySqlParameter("date_nai_pere", certificat.DateNaissancePere));
                command.Parameters.Add(new MySqlParameter("lieu_nai_pere", certificat.LieuNaissancePere));

                command.CommandText = requete;
                command.ExecuteNonQuery();

                MonMessageBox.ShowBox("Données de certificat de naissance enregistrées avec succés dans la base de données",
                    "Enregistrement", "affirmation.png");
                flag = true;
            ...
            {
                flag = false;
                MonMessageBox.ShowBox("L'enregistrement des données a échoué", "Erreur d'insertion", exception, "erreur.png");
            }
            finally
            {
                connection.Close();
        ...
        public static List<CertificatNaissance> ListeDesCertificatDeNaissance()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    certif.ID = reader.GetInt32(0);
                    certif.IDPatient = reader.GetInt32(1);
                    certif.DateNaissanceMere = reader.GetDateTime(2);
                    certif.LieuNaissanceMere= reader.GetString(3);
                    certif.NumeroEmplye = reader.GetString(4);
                    certif.NomEnfant = reader.GetString(5);
                    certif.DateNaissanceEnfant = reader.GetDateTime(6);
                    certif.LieuNaissanceEnfant = reader.GetString(7);
                    certif.Sexe =!reader.IsDBNull(8) ?  reader.GetString(8) : "";
                    certif.Poids = !reader.IsDBNull(9) ? reader.GetFloat(9) : 0f;
                    certif.NomPere = reader.GetString(10);
                    certif.ProfessionPere = !reader.IsDBNull(11) ?  reader.GetString(11) : "";
                    certif.LieuNaissancePere = !reader.IsDBNull(13) ? reader.GetString(13) : "";
                    certif.DateNaissancePere = reader.GetDateTime(12);
                    list.Add(certif);
                }
                return list;
            }
        ...
        public static bool AjouterUnCertificatDeCes(CertificatDeDeces  certificat)
        {
            ...
            try
            {
                ...
                if (certificat.ID <= 0)
                {
                    requete = "INSERT INTO `certif_deces` ( `idPatient`, `idEmpl`, `date_nai`, `date_deces`, `cause_deces`,`genre`,`pere`,`mere`)" +
                              " VALUES ( @idPatient, @idEmpl, @date_nai, @date_deces, @cause_deces,@genre,@pere,@mere)";
                }
                else
                {
                    requete = "UPDATE `certif_deces` SET `idEmpl`=@idEmpl, `date_nai`=@date_nai, `date_deces`=@date_deces" +
                        ", `cause_deces`=@cause_deces,`genre`=@genre,`pere`=@pere,`mere`=@mere WHERE id= " + certificat.ID;
                }

                command.Parameters.Add(new MySqlParameter("idPatient", certificat.IDPatient));
                command.Parameters.Add(new MySqlParameter("idEmpl", certificat.IDEmploye));
                command.Parameters.Add(new MySqlParameter("genre", certificat.GenreDeces)); 
                command.Parameters.Add(new MySqlParameter("date_nai", certificat.DateNaissance));
                ...
                command.Parameters.Add(new MySqlParameter("pere", certificat.Pere));
                command.Parameters.Add(new MySqlParameter("mere", certificat.Mere));
                command.CommandText = requete;
                command.ExecuteNonQuery();

                MonMessageBox.ShowBox("Données de certificat enregistrées avec succés dans la base de données",
                    "Information Insertion", "affirmation.png");
                flag = true;
        ...
        public static List<CertificatDeDeces> ListeDesCertificatDeDeces()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    certif.DateNaissance = reader.GetDateTime(3);
                    certif.DateDeces = reader.GetDateTime(4);
                    certif.CauseDeces = reader.GetString(5);
                    certif.GenreDeces = !reader.IsDBNull(6) ? reader.GetString(6) : "";
                    certif.Pere = !reader.IsDBNull(7) ? reader.GetString(7) : "";
                    certif.Mere= !reader.IsDBNull(8) ? reader.GetString(8) : "";
                    list.Add(certif);
                }
                return list;
            }
