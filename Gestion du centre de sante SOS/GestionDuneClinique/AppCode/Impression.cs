...
return bitmap;
            ...
            Patient patient, string modePaiement, double remise, string caissier)
        {
            ...
            graphic.DrawString("NIF : 9017308A " , fnt4, Brushes.Black, 11*unite_largeur-3, 5 * unite_hauteur+3);
            ...
            graphic.DrawRectangle(Pens.Lavender, 10, 8 * unite_hauteur, 17 * unite_largeur, 5 * unite_hauteur + 10);
            graphic.FillRectangle(Brushes.WhiteSmoke, 10, 8 * unite_hauteur, 17 * unite_largeur + 2, unite_hauteur);

            graphic.DrawString("Informations du patient  ", fnt1, Brushes.Black, 6 * unite_largeur, 8 * unite_hauteur);
            graphic.DrawString("N° identifiant :", fnt1, Brushes.Black, 3 * unite_largeur, 9 * unite_hauteur + 5);
            graphic.DrawString("Patient :", fnt1, Brushes.Black, 3 * unite_largeur, 10 * unite_hauteur + 10);
            graphic.DrawString("Sexe :   ", fnt1, Brushes.Black, 3 * unite_largeur, 11 * unite_hauteur + 7);
            graphic.DrawString("Age :    ", fnt1, Brushes.Black, 3 * unite_largeur, 12 * unite_hauteur + 4);

            graphic.DrawString(patient.NumeroPatient.ToString(), fnt2, Brushes.Black, 6 * unite_largeur, 9 * unite_hauteur + 5);
            graphic.DrawString(patient.Nom.ToUpper() + " " + patient.Prenom.ToUpper(), fnt1, Brushes.Black, 6 * unite_largeur, 10 * unite_hauteur + 10);
            graphic.DrawString(patient.Sexe + "                         GS/RH :   " + patient.Rhesus + "     Adresse : " + patient.Adresse, fnt1, Brushes.Black, 6 * unite_largeur, 11 * unite_hauteur + 7);
            graphic.DrawString(AfficherAge(patient.An, patient.Mois) + "                Tél :   " + patient.Telephone + "            Fonction : " + patient.Fonction, fnt1, Brushes.Black, 6 * unite_largeur, 12 * unite_hauteur + 4);

            graphic.FillRectangle(Brushes.WhiteSmoke, 10 - 5, 16 * unite_hauteur, 17 * unite_largeur, unite_hauteur);
            ...
            graphic.FillRectangle(Brushes.WhiteSmoke, 10, 37 * unite_hauteur + 10, 17 * unite_largeur, unite_hauteur);
            graphic.DrawString("TOTAL ", fnt11, Brushes.Black, 10, 37 * unite_hauteur + 10);
            graphic.DrawString(totalNet.ToString() + " F CFA", fnt11, Brushes.Black, 14 * unite_largeur, 37 * unite_hauteur + 10);
            graphic.DrawString("Total remise :    ".ToUpper() + remise + " FCFA", fnt11, Brushes.Black, 11 * unite_largeur - 0, 39 * unite_hauteur - 8);
        ...
        public static Bitmap ImprimerAnalyse(int numeroFacture, Patient patient, DateTime dateAnalyse, string caissier, int indexes, string acte)
        {
            ...
            {
                Image logo = global::GestionDuneClinique.Properties.Resources.logo;
                graphic.DrawImage(logo, unite_largeur, 0, 16 * unite_largeur, 5 * unite_hauteur);
            }
            catch { }
            //definir les polices 
            ...
            Font fnt4 = new Font("Arial Narrow", 11, FontStyle.Bold);
            #endregion
            ...
            graphic.DrawString("NIF : 9017308A ", fnt4, Brushes.Black, 11 * unite_largeur + 8, 3 * unite_hauteur + 13);
            ...
            graphic.DrawString("Qté".ToUpper(), fnt1, Brushes.Black, 13 * unite_largeur - 0, 15 * unite_hauteur - 15, drawFormatRight);
            graphic.DrawString("Frais".ToUpper(), fnt1, Brushes.Black, 14 * unite_largeur + 15, 15 * unite_hauteur - 15, drawFormatRight);
            graphic.DrawString("Total".ToUpper(), fnt1, Brushes.Black, 17 * unite_largeur - 5, 15 * unite_hauteur - 15, drawFormatRight);
            ...
            for (var i = 0; i <= listeFacture.Count - 1; i++)
            {
                ...
                graphic.DrawString(listeFacture[i].Quantite.ToString(), fnt1, Brushes.Black, 13 * unite_largeur - 0, Yloc, drawFormatRight);
                graphic.DrawString(listeFacture[i].Prix.ToString(), fnt1, Brushes.Black, 14 * unite_largeur + 15, Yloc, drawFormatRight);
                graphic.DrawString(listeFacture[i].PrixTotal.ToString(), fnt1, Brushes.Black, 17 * unite_largeur - 5, Yloc, drawFormatRight);
                total += listeFacture[i].PrixTotal;
            }

            var liste = ConnectionClassClinique.TableDesProFacturesProforma(numeroFacture);
            var netPayer = liste[0].MontantFactural;

            graphic.FillRectangle(Brushes.White, unite_largeur, 35 * unite_hauteur - 0, 16 * unite_largeur + 20, 32 * unite_hauteur - 2);
            graphic.FillRectangle(Brushes.Silver, unite_largeur, 35 * unite_hauteur - 0, 16 * unite_largeur + 20, unite_hauteur + 2);
            graphic.DrawString("Total ", fnt2, Brushes.Black, unite_largeur, 35 * unite_hauteur);
            graphic.DrawString(total.ToString() + " F CFA", fnt2, Brushes.Black, 17 * unite_largeur - 5, 35 * unite_hauteur, drawFormatRight);
            if (total != netPayer)
            {
                graphic.DrawString("Total remise : " + (total - netPayer).ToString() + " F CFA", fnt2, Brushes.Black, 17 * unite_largeur - 5, 36 * unite_hauteur + 2, drawFormatRight);
                graphic.DrawString("Net à payer : " + (netPayer).ToString() + " F CFA", fnt2, Brushes.Black, 17 * unite_largeur - 5, 37 * unite_hauteur + 4, drawFormatRight);
                graphic.DrawString("Arrêtée la présente facture à la somme de : " + Converti((long)(netPayer)) + " Francs CFA", fnt11, Brushes.Black, unite_largeur, 38 * unite_hauteur + 5);
            }
            else
                graphic.DrawString("Arrêtée la présente facture à la somme de : " + Converti((long)total) + " Francs CFA", fnt11, Brushes.Black, unite_largeur, 38 * unite_hauteur + 5);
            //graphic.DrawString(Converti((long)total) + " Francs CFA", fnt11, Brushes.Black, unite_largeur, 38 * unite_hauteur-0);
            graphic.DrawString("Caissier(e)  :  ".ToUpper() + caissier.ToUpper(), fnt2, Brushes.Black, 9 * unite_largeur - 15, 39 * unite_hauteur + 15, drawFormatCenter);
        ...
        public static Bitmap RapportDuneEntreprise(DataGridView dtGrid, Entreprise entreprise, DateTime date, double montantTotal, double reduction)
        {
            ...
            try
            {
                ...
                Font fnt2 = new Font("Century Gothic", 14, FontStyle.Bold);
               ...
               graphic.DrawString("FACTURE DU  " + date.ToShortDateString(), fnt3, Brushes.Black, 6* unite_largeur, 17 * unite_hauteur - 15);
                graphic.DrawLine(Pens.Black, 6 * unite_largeur, 18 * unite_hauteur - 10, 15 * unite_largeur, 18 * unite_hauteur - 10);
                graphic.DrawString("Date d'émission :  " + DateTime.Now.ToShortDateString(), fnt1, Brushes.Black, 19 * unite_largeur, 8 * unite_hauteur+20);

                graphic.DrawRectangle(Pens.Black, unite_largeur - 5, 13 * unite_hauteur + 10, 24 * unite_largeur, 3 * unite_hauteur - 5);
                graphic.FillRectangle(Brushes.Black, unite_largeur - 5, 12 * unite_hauteur + 13, 24 * unite_largeur + 2, unite_hauteur);
                graphic.DrawString("Information de l' entreprise  ".ToUpper(), fnt1, Brushes.White, 2 * unite_largeur, 12 * unite_hauteur + 13);
                graphic.DrawString("Nom :", fnt1, Brushes.Black, 2 * unite_largeur, 13 * unite_hauteur + 12);
                graphic.DrawString("Tél :   ", fnt1, Brushes.Black, 2 * unite_largeur, 14 * unite_hauteur + 9);
                graphic.DrawString("Adresse :    ", fnt1, Brushes.Black, 2 * unite_largeur, 15 * unite_hauteur + 6);

                graphic.DrawString(entreprise.NomEntreprise, fnt1, Brushes.Black, 6 * unite_largeur, 13 * unite_hauteur + 12);
                graphic.DrawString(entreprise.Telephone1 + " / " + entreprise.Telephone2, fnt1, Brushes.Black, 6 * unite_largeur, 14 * unite_hauteur + 9);
                graphic.DrawString(entreprise.Adresse, fnt1, Brushes.Black, 6 * unite_largeur, 15 * unite_hauteur + 6);

                //graphic.DrawString("Page 1 ", fnt11, Brushes.Black, 12 * unite_largeur, 5);
                //graphic.FillRectangle(Brushes.Black, unite_largeur - 5, 12 * unite_hauteur + 13, 24 * unite_largeur + 2, unite_hauteur);
                graphic.FillRectangle(Brushes.Black, unite_largeur - 3, 19 * unite_hauteur - 15, 24 * unite_largeur + 6, unite_hauteur);
                ...
                if (flag == true)
                {
                    if (reduction <= 0)
                    {
                        ...
                        graphic.DrawString(        String.Format(elGR, "{0:0,0}",  montantTotal) + " F CFA", fnt2, Brushes.White, 18 * unite_largeur, Kloc);
        ...
        public static Bitmap RapportDuneEntrepriseParPage(DataGridView dtGrid, Entreprise entreprise, DateTime date, double montantTotal,double reduction, int start)
        {
            ...
            try
            {
                ...
                graphic.FillRectangle(Brushes.Black, unite_largeur - 3, 2 * unite_hauteur - 10, 24 * unite_largeur + 6, unite_hauteur);
    ...
    // cretificat de grossesse
        public static Bitmap CertificatDeGrossesse(CertificatDeGrossesse certificat)
        {
            ...
            try
            {
                Image logo = global::GestionDuneClinique.Properties.Resources.certificatGrossesse;
                graphic.DrawRectangle(Pens.Black, 10, 10, largeur_facture - 20, hauteur_facture - 30);
                graphic.DrawImage(logo, 20,  20, 16*unite_largeur+0, 13*unite_hauteur+20);
            }
            catch { }
            //definir les polices 
            Font fnt1 = new Font("Century Gothic", 12.30f, FontStyle.Regular | FontStyle.Italic);
            Font fnt11 = new Font("Century Gothic", 8, FontStyle.Regular);
            Font fnt2 = new Font("Bodoni MT", 28, FontStyle.Underline);
            Font fnt3 = new Font("Century Gothic", 12.80f, FontStyle.Regular | FontStyle.Italic);
            Font fnt22 = new Font("Century Gothic", 12.70f, FontStyle.Bold | FontStyle.Italic);

           #endregion
               
            graphic.DrawString("Je soussignée, ", fnt1, Brushes.Black, 20, 16 * unite_hauteur);
            graphic.DrawString(certificat.NomDocteur.ToUpper(), fnt22, Brushes.Black, 5 * unite_largeur -25, 16 * unite_hauteur );
            graphic.DrawString("Docteur en médecine ", fnt1, Brushes.Black,11* unite_largeur-2, 16 * unite_hauteur);
            
            graphic.DrawString("enregistré sous le numéro ", fnt1, Brushes.Black, 20, 17 * unite_hauteur+6);
            graphic.DrawString(certificat.Matricule, fnt22, Brushes.Black, 7 * unite_largeur+25, 17 * unite_hauteur + 6);
            graphic.DrawString("certifie que ", fnt1, Brushes.Black, 13*unite_largeur+15, 17 * unite_hauteur+6);
            
            graphic.DrawString("Mme : ", fnt1, Brushes.Black, 20, 19 * unite_hauteur);
            graphic.DrawString(certificat.NomPatient.ToUpper(), fnt22, Brushes.Black, 3 * unite_largeur+0, 19 * unite_hauteur );
            graphic.DrawString("est enceinte de : ", fnt1, Brushes.Black, 20, 21 * unite_hauteur);
            graphic.DrawString( Converti(certificat.PeriodeGrossesse) + "("+certificat.PeriodeGrossesse+")", fnt22, Brushes.Black, 8*unite_largeur, 21 * unite_hauteur+0);
            graphic.DrawString("Semaines", fnt1, Brushes.Black, 14*unite_largeur, 21 * unite_hauteur-20);
            graphic.DrawString("Date des Dernières Règles(DDR) : ", fnt1, Brushes.Black, 20, 23 * unite_hauteur +0);
            graphic.DrawString(certificat.DateDDR.ToShortDateString(), fnt22, Brushes.Black, 9*unite_largeur-0, 23 * unite_hauteur + 0);

            graphic.DrawString("Et qu' elle accouchera vers le : ", fnt1, Brushes.Black, 20, 25 * unite_hauteur + 0);
            graphic.DrawString(certificat.DateAccouchement.ToShortDateString(), fnt22, Brushes.Black, 9 * unite_largeur-0, 25 * unite_hauteur + 0);
            graphic.DrawString("Le congé prénatal est prévu le : ", fnt1, Brushes.Black, 20, 26 * unite_hauteur + 7);
            graphic.DrawString(certificat.DateConge.ToShortDateString(), fnt22, Brushes.Black, 9 * unite_largeur-0, 26 * unite_hauteur + 7);

            graphic.DrawString("En foi,  de quoi, ce certificat est etabli, délivré pour ", fnt1, Brushes.Black, 20, 28 * unite_hauteur + 7);
            graphic.DrawString("servir et Valoir ce que de droit ", fnt1, Brushes.Black, 20, 29 * unite_hauteur + 14);

            graphic.DrawString("N'Djaména le : "+DateTime.Now.ToShortDateString(), fnt3, Brushes.Black, 20, 32 * unite_hauteur + 0);

            graphic.DrawString("Le Médecin " , fnt3, Brushes.Black, 7*unite_largeur, 35 * unite_hauteur + 0);
        ...
        public static Bitmap CertificatDeNaissance(CertificatNaissance certificat)
        {
            ...
            try
            {
                Image logo = global::GestionDuneClinique.Properties.Resources.certificatNaissance;
                graphic.DrawImage(logo, 2 * unite_largeur, 0, 20 * unite_largeur, 8 * unite_hauteur);
            }
            catch { }
            //definir les polices 
            Font fnt1 = new Font("Century Gothic", 13, FontStyle.Regular);
            Font fnt11 = new Font("Century Gothic", 13, FontStyle.Bold | FontStyle.Underline | FontStyle.Italic);
            Font fnt2 = new Font("Century Gothic", 25, FontStyle.Underline | FontStyle.Bold);
            Font fnt3 = new Font("Century Gothic", 20, FontStyle.Underline);
            Font fnt22 = new Font("Century Gothic", 13, FontStyle.Bold);

            #endregion
            var listePatient = ConnectionClassClinique.ListeDesPatients(certificat.IDPatient);
            var nomPatient = "";
            foreach (var p in listePatient)
            {
                nomPatient = p.Nom + " " + p.Prenom;
                certificat.ProfessionMere = p.Fonction;
            }
           
            var sexe = "";
            var titre = "";var neEnfsnt = "";
            ...
            var nomEmploye = ConnectionClassClinique.ListeDesEmployees("num_empl", certificat.NumeroEmplye)[0].NomEmployee;
            
            
            
            graphic.DrawString("CERTIFICAT DE NAISSANCE", fnt2, Brushes.Black, 12 * unite_largeur, 9 * unite_hauteur-0,drawFormatCenter);

            graphic.DrawString(nomEmploye.ToUpper(), fnt22, Brushes.Black, 10 * unite_largeur, 12 * unite_hauteur - 19,drawFormatCenter);
            graphic.DrawString("Je, soussigné, ...................................................",fnt1, Brushes.Black, 2* unite_largeur , 12 * unite_hauteur - 15);
            graphic.DrawString("Docteur en Médecine, enregistré", fnt1, Brushes.Black, 23 * unite_largeur, 12 * unite_hauteur - 15,drawFormatRight) ;
            graphic.DrawString("sous le numéro .....................................", fnt1, Brushes.Black,  2*unite_largeur , 13 * unite_hauteur-15);
            graphic.DrawString(certificat.NumeroEmplye, fnt22, Brushes.Black, 9 * unite_largeur, 13 * unite_hauteur - 19,drawFormatCenter) ;
            graphic.DrawString(", déclare la naissance d'un enfant de sexe", fnt1, Brushes.Black, 23 * unite_largeur, 13 * unite_hauteur - 15,drawFormatRight) ;
            graphic.DrawString(sexe.ToUpper(), fnt22, Brushes.Black, 3 * unite_largeur+5, 14 * unite_hauteur - 19);
            graphic.DrawString("................................. "+titre +"..................................................................................",
                fnt1, Brushes.Black, 23 * unite_largeur, 14 * unite_hauteur - 15,drawFormatRight) ;
            graphic.DrawString(certificat.NomEnfant.ToUpper(), fnt22, Brushes.Black, 17 * unite_largeur, 14 * unite_hauteur - 19,drawFormatCenter) ;

            graphic.DrawString(neEnfsnt+" le ................................... à .............................. à ..........................................",
                fnt1, Brushes.Black, 23*unite_largeur, 15 * unite_hauteur - 15, drawFormatRight) ;
            graphic.DrawString(certificat.DateNaissanceEnfant.ToShortDateString(), fnt22, Brushes.Black, 7 * unite_largeur-25, 15 * unite_hauteur - 19);
            graphic.DrawString(certificat.DateNaissanceEnfant.Hour +"h:"+certificat.DateNaissanceEnfant.Minute +"mn", fnt22, Brushes.Black, 12 * unite_largeur, 15 * unite_hauteur - 19);
            graphic.DrawString(certificat.LieuNaissanceEnfant.ToUpper(), fnt22, Brushes.Black, 20 * unite_largeur-15, 15 * unite_hauteur - 19,drawFormatCenter);
            graphic.DrawString("de père ....................................................................... né le ......" +
                "...............................",                 fnt1, Brushes.Black, 23 * unite_largeur, 16 * unite_hauteur - 15,drawFormatRight) ;
            
            graphic.DrawString(certificat.NomPere.ToUpper(), fnt22, Brushes.Black, 10 * unite_largeur - 10, 16 * unite_hauteur - 19,drawFormatCenter) ;
            graphic.DrawString(certificat.DateNaissancePere.ToShortDateString(), fnt22, Brushes.Black, 20 * unite_largeur, 16 * unite_hauteur - 19,drawFormatCenter) ;
            graphic.DrawString("à ..................................... de profession ................................................ et de mère", fnt1, Brushes.Black, 23 * unite_largeur, 17 * unite_hauteur - 15, drawFormatRight);

            graphic.DrawString(certificat.LieuNaissancePere.ToUpper(), fnt22, Brushes.Black, 6 * unite_largeur - 10, 17 * unite_hauteur - 19, drawFormatCenter);
            graphic.DrawString(certificat.ProfessionPere.ToUpper(), fnt22, Brushes.Black, 16 * unite_largeur, 17 * unite_hauteur - 19, drawFormatCenter);
            graphic.DrawString(".................................................................................... née le ................................ à", fnt1, Brushes.Black, 23 * unite_largeur, 18 * unite_hauteur - 15, drawFormatRight);

            graphic.DrawString(     nomPatient.ToUpper(), fnt22, Brushes.Black, 9 * unite_largeur - 10, 18 * unite_hauteur - 19, drawFormatCenter);
            graphic.DrawString(certificat.DateNaissanceMere.ToShortDateString(), fnt22, Brushes.Black, 19 * unite_largeur+25, 18 * unite_hauteur - 19, drawFormatCenter);
            graphic.DrawString("......................................... de profession ..................................................................", fnt1, Brushes.Black, 23 * unite_largeur, 19 * unite_hauteur - 15, drawFormatRight);

            graphic.DrawString(certificat.LieuNaissanceMere.ToUpper(), fnt22, Brushes.Black, 6 * unite_largeur - 10, 19 * unite_hauteur - 19, drawFormatCenter);
            graphic.DrawString(certificat.ProfessionMere.ToUpper(), fnt22, Brushes.Black, 17 * unite_largeur + 25, 19 * unite_hauteur - 19, drawFormatCenter); ;



            graphic.DrawString("Ce certificat est délivré et remis pour servir et valoir ce que de droit.  ",
                fnt1, Brushes.Black, 2*unite_largeur, 20 * unite_hauteur + 0);
            //graphic.DrawString(certificat.NomEnfant.ToUpper(), fnt22, Brushes.Black, 13 * unite_largeur, 19 * unite_hauteur+15);
            graphic.DrawString("N’Djamena, le " + DateTime.Now.ToShortDateString(), fnt1, Brushes.Black, 12 * unite_largeur, 24 * unite_hauteur - 7,drawFormatCenter) ;
            graphic.DrawString("Le Medecin " , fnt11, Brushes.Black, 12 * unite_largeur, 27 * unite_hauteur - 7, drawFormatCenter);
        ...
        public static Bitmap CertificatDeDeces(CertificatDeDeces certificat)
        {
            ...
            graphic.DrawString(certificat.DateNaissance.Date.ToShortDateString(), fnt22, Brushes.Black, 6 * unite_largeur, 11 * unite_hauteur - 5);
            graphic.DrawString(certificat.DateNaissance.ToShortTimeString(), fnt22, Brushes.Black, 18 * unite_largeur, 11 * unite_hauteur - 5);
            ...
            graphic.DrawString(certificat.GenreDeces.ToUpper(), fnt22, Brushes.Black, 13 * unite_largeur, 10 * unite_hauteur - 5);
        ...
        public static Bitmap ImprimerStatistiqueDeLaboratoire(DataGridView dgvConsultation, DateTime dt1, DateTime dt2,string service)
        {
            #region facture1
            //les dimension de la facture
            int unite_hauteur = 23;
            ...
            graphic.DrawString("STATISTIQUE ET RELEVE "+service+" DU CENTRE MEDICAL SOS VILLAGES ENFANTS DE N'DJAMENA DU "
            ...
            for (var rows = 0; rows < dgvConsultation.Rows.Count; rows++)
            {
                ...
                if (rows == 0)
                {
                    ...
                    graphic.DrawString(dgvConsultation.Rows[rows].Cells[3].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 12 + 0, yLoc + 5);
                    graphic.DrawString(dgvConsultation.Rows[rows].Cells[5].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 15 + 15, yLoc + 5);
                    graphic.DrawString(dgvConsultation.Rows[rows].Cells[7].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 18 + 0, yLoc + 5);
