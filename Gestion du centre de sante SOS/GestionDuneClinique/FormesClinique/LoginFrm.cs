    ...
    public partial class LoginFrm : Form
    {
        ...
        private void LoginFrm_Load(object sender, EventArgs e)
        {
            var listeUtilisateur =
             ConnectionClassClinique.ListesDesUtilisateurs().Where(l => !l.TypeUtilisateur.ToLower().Contains("labo"));
        ...
        private void timer4_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    var utilisateur = ConnectionClassClinique.SeConnecter(nomUtil, motPasse);
                    if (utilisateur != null)
                    {
                        ...
                        ConnectionClassClinique.Tracker(nomUtil, nom, true);
                        
                        //_synthesizer = new SpeechSynthesizer();
                        //var words = "Bonjour " + utilisateur.NomEmploye +" Bienvenue au système de gestion de la clinique Alshifa. La temperarure du jour est 38 degres Celcius";
