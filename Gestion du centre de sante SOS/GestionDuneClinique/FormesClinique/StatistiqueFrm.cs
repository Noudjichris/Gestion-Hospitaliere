...
namespace GestionDuneClinique.FormesClinique
{
    public partial class StatistiqueFrm : Form
    {
        ...
        //}
#endregion
        void StatistiqueDesActes()
        {
            try
            {
                dgvStatistique.CellBorderStyle = DataGridViewCellBorderStyle.None;
                dgvStatistique.Columns.Clear();
                dgvStatistique.Columns.Add("SERVICES", "SERVICES "+comboBox2.Text.ToUpper());
                dgvStatistique.Columns[0].Width = dgvStatistique.Width / 4 - 50;
                ...
                var acte = comboBox2.Text.Substring(0,1).ToUpper() + comboBox2.Text.Substring(1).ToLower();
                dgvStatistique.Rows.Clear();
                dgvStatistique.Rows.Add(" ", "Patient", "", acte, "", "Patient", "", acte, "", "", "", "", "", "");
                dgvStatistique.Rows.Add("SEXE ", "M", "F", "Nbre", "Nbre", "M", "F", "Nbre", "Nbre", "To enf", "Nbre", "To adl","Nbre","Tot M","Tot F", "Nbre F", "Nbre", "Total", "Nbre");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                if (dgvStatistique.Rows.Count > 0)
                {
                    ...
                    {
                        var service = "DU " + comboBox2.Text;
                        if (comboBox2.Text.StartsWith("E") || comboBox2.Text.StartsWith("A") ||
                            comboBox2.Text.StartsWith("O") || comboBox2.Text.StartsWith("U") || comboBox2.Text.StartsWith("I"))
                        {
                            service = "D' " + comboBox2.Text;
                        }
                            statistiqueBitmap = AppCode.Impression.ImprimerStatistiqueDeLaboratoire(dgvStatistique, dateTimePicker1.Value.Date, dateTimePicker2.Value.Date,service
                                );
                    }
