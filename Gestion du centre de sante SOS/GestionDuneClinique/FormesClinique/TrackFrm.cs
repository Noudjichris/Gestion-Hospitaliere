...
namespace GestionDesPelerinsTchad.Formes
{
    public partial class TrackFrm : Form
    {
        ...
        {
            var dt = ConnectionClassClinique.Log();
Track(dt);
        }
        ...
        {
            var dt = ConnectionClassClinique.Log(dateTimePicker1.Value.Date);
            Track(dt);
        }

        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            var dt = ConnectionClassClinique.Log(textBox1.Text);
            Track(dt);
        }
        ...
        {
           if(
                MonMessageBox.ShowBox("Voulez vous vider les donnees","Confirmation","confirmation.png")=="1")
           {
               ConnectionClassClinique.ViderLog();
            var dt = ConnectionClassClinique.Log();
            Track(dt);
            }
        }
