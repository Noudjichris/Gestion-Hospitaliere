    ...
    public class ConnectionClassClinique
    {
        ...
        static ConnectionClassClinique()
        {
            string connectionString =
                //@"server=192.168.1.1;user id=Al-shifa;password=Al-shifa2021;database=clinique_db";
            //@"server=localhost;user id=hnda;password=hnda2017;database=clinique_db";
        ...
        public static List<Patient> ListeDesPatientsParEntreprise(string nomPatient, string entrep)
        {
            ...
            try
            {
                requete = "SELECT * FROM patient_tbl WHERE nom LIKE '" + nomPatient + 
                    "%' AND entrep =@entrep ORDER BY nom, prenom";
        ...
        public static bool EnregisterLesAnalyses(Analyse analyse, string etat)
        {
            ...
            try
            {
                ...
                if (etat == "1")
                {
                    requete = "INSERT INTO liste_analyse_tbl (type_anal, montant,montantNRC,montantAs,montantCICR, montantMSF,descrip) " +
                        "VALUES(@type_anal,@montant,@montantNRC,@montantAs,@montantCICR,@montantMSF,@descrip)";
                }
                else
                {
                    requete = "UPDATE liste_analyse_tbl SET type_anal=@type_anal, montant=@montant,montantCICR=@montantCICR,descrip = " +
                     " @descrip , montantNRC = @montantNRC, montantAs =@montantAs , montantMSF=@montantMSF WHERE num_anal = " + analyse.NumeroListeAnalyse;
                ...
                command.Parameters.Add(new MySqlParameter("montantNRC", analyse.FraisNRC));
                command.Parameters.Add(new MySqlParameter("montantAs", analyse.FraisAssure));
                command.Parameters.Add(new MySqlParameter("montantCICR", analyse.FraisCICR));
                command.Parameters.Add(new MySqlParameter("montantMSF", analyse.FraisMSF));
                command.CommandText = requete;
                command.ExecuteNonQuery();
                flag = true;
        ...
        public static List<Analyse> ListeDesAnalyses()
        {
            ...
            try
            {
                ...
                while(reader.Read())
                {
                    ...
                    analyse.FraisNRC = reader.GetDouble(4);
                    analyse.FraisAssure = !reader.IsDBNull(5) ? reader.GetDouble(5) : 0.0;
                    analyse.FraisCICR = !reader.IsDBNull(6) ? reader.GetDouble(6) : 0.0;
                    analyse.FraisMSF= !reader.IsDBNull(7) ? reader.GetDouble(7) : 0.0;
        ...
        public static List<Analyse> ListeDesAnalyses(int numAnal)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    analyse.FraisCICR = !reader.IsDBNull(6) ? reader.GetDouble(6) : 0.0;
                    analyse.FraisMSF = !reader.IsDBNull(7) ? reader.GetDouble(7) : 0.0;
                    analyse.NumeroGroupe = !reader.IsDBNull(8) ? reader.GetInt32(8) : 0;
                    listeAnalyse.Add(analyse);
                }
            }
            catch (Exception ex)
        ...
        public static List<Analyse> ListePrixDesAnalyses()
        {
            var listeAnalyse = new List<Analyse>();
            try
            {
                requete = "SELECT prix_analyse_tbl.*, liste_analyse_tbl.*  FROM liste_analyse_tbl "+
                    " INNER JOIN prix_analyse_tbl ON liste_analyse_tbl.num_anal=prix_analyse_tbl.id_analyse ORDER BY type_anal";
                command.CommandText = requete;
                connection.Open();
                var reader = command.ExecuteReader();
                while (reader.Read())
                {
                    ...
                    analyse.TypeAnalyse = reader.GetString(5);
                    analyse.IndexPrix = !reader.IsDBNull(3) ? reader.GetInt32(3) :0;
                    analyse.Frais = reader.GetDouble(2);
                    listeAnalyse.Add(analyse);
                }
            }
        ...
        public static bool AjouterLesAnalysesEffectues(Analyse analyse,DataGridView dgvAnal, string patient)
        {
            ...
            try
            {
                ...
                command.Parameters.Add(new MySqlParameter("partern", analyse.Partenaire));
                ...
                transaction.Commit();
                flag = true;
                MonMessageBox.ShowBox("L'analyse du patient " + patient +" est enregistrée avec succés", "Affirmation", "affirmation.png");
            }
            catch (Exception ex)
            {
                if (transaction != null)
        ...
        public static List<Analyse> ListeDesAnalysesEffectuees()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    analyse.Partenaire = reader.IsDBNull(5) ? reader.GetString(5) : "";
                    listeAnalyse.Add(analyse);
                }
            }
            catch (Exception ex)
        ...
        public static DataTable TableDesAnalysesEffectuesDuJour()
        {
            ...
            try
            {
                requete = "SELECT analyse_tbl.num, analyse_tbl.date_anal, patient_tbl.nom, patient_tbl.prenom, " +
                    " empl_tbl.nom_empl, analyse_tbl.montantTotal,analyse_tbl.num_patient,analyse_tbl.partern  FROM  analyse_tbl INNER JOIN empl_tbl ON analyse_tbl.num_empl" +
                "= empl_tbl.num_empl INNER JOIN patient_tbl ON analyse_tbl.num_patient = patient_tbl.id  order BY analyse_tbl.num DESC  LIMIT 15";
                command.CommandText = requete;
                //command.Parameters.Add(new MySqlParameter("date2", DateTime.Now.Date.AddDays(-2))); ;WHERE analyse_tbl.date_anal>=@date2 ORDER BY 
                connection.Open();
                var reader = command.ExecuteReader();
                dt.Load(reader);
            }
         ...
         public static DataTable TableDesDetailsFacturesProforma(int idPatient,DateTime date1, DateTime date2)
        {
            ...
            try
            {
               requete ="SELECT pro_facture_tbl.num_patient, pro_facture_tbl.date_fact,pro_det_fact.id_fact,"+
                   "pro_det_fact.design,pro_det_fact.prix,pro_det_fact.qte,pro_det_fact.prix_total FROM pro_facture_tbl"+
        ...
        public static DataTable DetailsDesAnalyseEffectuesParMedecin(string idMedecin, DateTime date1, DateTime date2)
        {
            ...
            try
            {
                requete = "SELECT det_anal.id_anal, analyse_tbl.date_anal, liste_analyse_tbl.type_anal, " +
                    ...
                    " WHERE (analyse_tbl.date_anal >= @date1) AND (analyse_tbl.date_anal < @date2) AND analyse_tbl.num_empl ='" + idMedecin +
        ...
        public static DataTable DetailsDesAnalyseEffectuesParMedecin(DateTime date1, DateTime date2)
        {
            var listeDT = new DataTable();
            try
            {
                requete = "SELECT det_anal.id_anal, analyse_tbl.date_anal, liste_analyse_tbl.type_anal, " +
                    " det_anal.frais, SUM(det_anal.nbre) FROM analyse_tbl INNER JOIN det_anal ON analyse_tbl.num =" +
                    "det_anal.id_anal INNER JOIN liste_analyse_tbl ON det_anal.id_liste_anal = liste_analyse_tbl.num_anal " +
                    " WHERE (analyse_tbl.date_anal >= @date11) AND (analyse_tbl.date_anal < @date22) GROUP BY " +
                    " liste_analyse_tbl.type_anal, det_anal.frais ORDER BY liste_analyse_tbl.type_anal";
                command.CommandText = requete;
                command.Parameters.Add(new MySqlParameter("date11", date1));
                command.Parameters.Add(new MySqlParameter("date22", date2));
                connection.Open();
                var reader = command.ExecuteReader();
                listeDT.Load(reader);
            }
        ...
        public static List<Analyse> DetailsDesAnalyseEffectues(int numAnal, int idPatient, string typeAnalyse)
        {
            var listeAnalyse = new List<Analyse>();
            try
            {
                   requete = "SELECT liste_analyse_tbl.type_anal, det_anal.frais, patient_tbl.id, analyse_tbl.num"+
                    " FROM patient_tbl INNER JOIN analyse_tbl ON patient_tbl.id = analyse_tbl.num_patient INNER JOIN"+
                    " det_anal ON analyse_tbl.num = det_anal.id_anal INNER JOIN liste_analyse_tbl ON det_anal.id_liste_anal "+
                    "= liste_analyse_tbl.num_anal WHERE (patient_tbl.id = " + idPatient +") AND (analyse_tbl.num = " +
                    numAnal + " AND liste_analyse_tbl.type_anal = @type_anal)";
                command.CommandText = requete;
                command.Parameters.Add(new MySqlParameter("type_anal", typeAnalyse));
                connection.Open();
                var reader = command.ExecuteReader();
                while (reader.Read())
                {
                    ...
                    analyse.NumeroAnalyse = reader.GetInt32(0);
                    analyse.NumeroListeAnalyse = reader.GetInt32(1);
                    //var resultat = !reader.IsDBNull(2) ? reader.GetString(2) : "";
                    analyse.Frais = reader.GetDouble(3);
                    analyse.NombreAnalyse = !reader.IsDBNull(4) ? reader.GetInt32(4) : 1;
                    listeAnalyse.Add(analyse);
                }
        ...
        public static List<Consultation> CountConsultation(int idPatient, DateTime dt1, DateTime dt2)
        {
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    var rv = !reader.IsDBNull(3) ? reader.GetDateTime(3) : DateTime.Now;
                    var descript = !reader.IsDBNull(4) ? reader.GetString(4) : "";
        ...
        public static List<Consultation> ListeDesConsultations()
        {
            ...
            try
            {
                requete = "SELECT consult_tbl.num_consult, consult_tbl.type_consul, consult_tbl.date_consult, "+
                    ...
                    "= empl_tbl.num_empl INNER JOIN patient_tbl ON consult_tbl.num_pat = patient_tbl.id    ORDER BY consult_tbl.num_consult DESC LIMIT 5";
                command.CommandText = requete;
                //command.Parameters.Add(new MySqlParameter("date", DateTime.Now.Date.AddDays(-1)));WHERE consult_tbl.date_consult>=@date
                connection.Open();
                var reader = command.ExecuteReader();
                while (reader.Read())
                {
                    ...
                    var numEmpl = reader.GetString(5);
                    var numPat = reader.GetInt32(6);
                    var nomEmpl = reader.GetString(7);
                    var nomPatient = reader.GetString(8) + " " + reader.GetString(9);
                    var frais = reader.GetDouble(10);
                    var specialite = !reader.IsDBNull(11) ? reader.GetString(11) : "";
                    var partenaire = !reader.IsDBNull(12) ? reader.GetString(12) : "";
                    var consultation = new Consultation(numConsult, typeConsult, dateConsult, 
                        rv,descript,numEmpl,numPat,nomEmpl,nomPatient,frais,specialite, partenaire);
                    listeConsultation.Add(consultation);
                }
        ...
        public static DataTable ListeConsultationParMedecin(string nomEmpl, DateTime date1, DateTime date2)
        {
            var dt = new DataTable();
            try
            {
                ...
                requete = "SELECT consult_tbl.type_consul, COUNT(consult_tbl.type_consul), consult_tbl.frais, "+
                    " COUNT(consult_tbl.type_consul) * consult_tbl.frais, consult_tbl.special FROM consult_tbl INNER JOIN empl_tbl ON " +
        ...
        public static bool AjouterUneEntreprise(Entreprise entreprise)
        {
            ...
            try
            {
                ...
                {
                    reader.Close();
                    requete = "INSERT INTO entre_tbl (entreprise,tele1,tele2,email,adresse,date_abon,tauxHon,index_prix) " +
                        "VALUES(@entreprise,@tele1,@tele2,@email,@adresse,@date_abon,@tauxHon,index_prix)";
                    ...
                    command.Parameters.Add(new MySqlParameter("index_prix", entreprise.IndexPrix));
                    command.CommandText = requete;
                    command.ExecuteNonQuery();
                    flag = true;
        ...
        public static bool ModifierUneEntreprise(Entreprise entreprise)
        {
            ...
            try
            {
                ...
                requete = "UPDATE entre_tbl SET entreprise = @entreprise,tele1 = @tele1,tele2=@tele2,"+
                    " email=@email,adresse=@adresse , date_abon=@date_abon,tauxHon = @tauxHon , index_prix=@index_prix WHERE id = " + entreprise.NumeroEntreprise;
                command.Parameters.Add(new MySqlParameter("entreprise", entreprise.NomEntreprise));
                command.Parameters.Add(new MySqlParameter("tele1", entreprise.Telephone1));
                command.Parameters.Add(new MySqlParameter("tele2", entreprise.Telephone2));
                command.Parameters.Add(new MySqlParameter("email", entreprise.Email));
        ...
        public static List<Entreprise> ListeDesEntreprises()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    var index = !reader.IsDBNull(8) ? reader.GetInt32(8) : 0;
                    var entreprise = new Entreprise(id,entrepr,tele1,tele2,email,adresse,date,frais,index);
        ...
        public static List<Entreprise> ListeDesEntreprises(string entrepri)
        {
            ...
            try
            {
                ...
                command.CommandText = requete;
                command.Parameters.Add(new MySqlParameter("entrepr", entrepri));
                connection.Open();
                var reader = command.ExecuteReader();
                while (reader.Read())
                {
                    ...
                    var frais = !reader.IsDBNull(7) ? reader.GetDouble(7) : 0.0;
                    var index = !reader.IsDBNull(8) ? reader.GetInt32(8) : 0;
                    var entreprise = new Entreprise(id, entreprises, tele1, tele2, email, adresse, date, frais, index);
                    listeEntreprise.Add(entreprise);
                }
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                if (count < 1)
                {
                    requete = "INSERT INTO `empl_tbl` (`num_empl`, `nom_empl`, `Addresse`, `telephone1`, `telephone2`," +
                            "`email`, `titre`) VALUES (@num_empl, @nom_empl, @Addresse, @telephone1, @telephone2, @email, @titre )";
            ...
            try
            {
                ...
                string requete =
                    string.Format(
                        ...
                        ", email = @email, titre = @titre WHERE (num_empl = '{0}')", employe.NumMatricule);
        ...
        public static List<Employe> ListeDesEmployees()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    string photo = !reader.IsDBNull(7) ? reader.GetString(7) : "";
        ...
        public static bool EnregistrerUneFacture(Facture facture, DataGridView dgvFacture,double montantPaye)
        {
            var flag = false;
            try
            {
                ...
                foreach(DataGridViewRow dtRow in dgvFacture.Rows)
                {
                    ...
                    requete = "INSERT INTO det_fact (id_fact, design,prix,qte,prix_total,groupage) VALUES(@id_fact1,@design,@prix,@qte,@prix_total,@groupage)";
       ...
       public static void SupprimerUneOccupation(int numeroOccupation)
        {
            try
            {
                ...
                command.ExecuteNonQuery();
                    ...
                    requete = "DELETE FROM pro_facture_tbl WHERE num_acte = " + numeroOccupation + " AND acte ='HOSPITALISATION'";
                    command.CommandText = requete;
                    command.Transaction = transaction;
                    command.ExecuteNonQuery();
                    transaction.Commit();
            ...
            try
            {
                if (MonMessageBox.ShowBox("Voulez vous supprimer ces données?", "Confirmation", "confirmation.png") == "1")
                {
                   ...
                   transaction=  connection.BeginTransaction();
                    ...
                    requete = "DELETE FROM pro_facture_tbl WHERE num_acte = " + id + " AND acte ='OBSERVATION'";
                    command.CommandText = requete;
                    command.Transaction = transaction;
                    command.ExecuteNonQuery();
                    transaction.Commit();
