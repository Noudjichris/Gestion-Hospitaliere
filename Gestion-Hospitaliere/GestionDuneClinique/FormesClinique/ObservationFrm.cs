...
namespace GestionDuneClinique.FormesClinique
{
    public partial class ObservationFrm : Form
    {
        ...
        private void groupBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            var pen1 = new Pen(Color.DarkOrange, 0);
            var area1 = new Rectangle(0, 0, this.groupBox1.Width - 1, this.groupBox1.Height - 1);
            var linearGradientBrush = new LinearGradientBrush(area1, Color.DarkOrange, Color.DarkOrange, LinearGradientMode.Vertical);
                                ...
                                else
                                {
                                    ...
                                    dataGridView3.Rows.Clear();
                                        var liste = from o in ConnectionClassClinique.ListeDesObservationsFaite()
                                                    ...
                                                    where o.DateDebut >= DateTime.Parse("01/"+    observation.DateDebut.Month+"/" + observation.DateDebut.Year)
                                                    where o.DateDebut < DateTime.Parse("28/"+    observation.DateDebut.Month +"/" + observation.DateDebut.Year).AddDays(4)
