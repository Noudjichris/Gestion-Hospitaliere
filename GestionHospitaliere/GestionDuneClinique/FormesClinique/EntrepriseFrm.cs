...
namespace GestionDuneClinique.Formes
{
    public partial class EntrepriseFrm : Form
    {
        ...
        string nomEntrep, tele1, tele2, email, adresse, etat, attache;
        int id;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (txtEntreprise.Text != "" && txtTele1.Text != "" && txtAdresse.Text != "")
            {
                ...
                if (checkBox1.Checked)
                    attache = cmbEntreprise.Text;
                else
                    attache = "";
                double montantLimite=0;
                if (checkBox2.Checked)
                {
                    if (double.TryParse(txtPlafond.Text, out montantLimite))
                    {
                    }
                    else
                    {
                ...
                var entreprise = new Entreprise(id, nomEntrep, tele1, tele2, email, adresse,dateAbonn,fraisHonoraire,attache,checkBox2.Checked,montantLimite);
                if (etat == "1")
                {
        ...
        {  
            ...
            foreach (Entreprise entrep in listeEntrep)
            {
                dgvEntrp.Rows.Add(entrep.NumeroEntreprise,
                             ...
                             entrep.PrixHonoraire,entrep.Attache,entrep.SiLimite,entrep.MontantLimite
                             );
            }
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (dgvEntrp.SelectedRows.Count > 0)
            {
                ...
                cmbEntreprise.Text = dgvEntrp.SelectedRows[0].Cells[8].Value.ToString();
                checkBox2.Checked = bool.Parse(dgvEntrp.SelectedRows[0].Cells[9].Value.ToString());
                txtPlafond.Text = dgvEntrp.SelectedRows[0].Cells[10].Value.ToString();
            }
            //if (txtEntreprise.Text != "" && txtTele1.Text != "" && txtAdresse.Text != "")
            //{
            //    if (string.IsNullOrEmpty(txtFraisHon.Text) || Double.TryParse(txtFraisHon.Text, out fraisHonoraire))
        ...
        {
            if (checkBox2.Checked)
            {   txtPlafond.ReadOnly = false;
                txtPlafond.Enabled = true;
        }
            else
            {
                txtPlafond.ReadOnly = true;
