...
namespace GestionAcademique
{
    public partial class Form1 : Form
    {
        ...
        private void menuStrip1_Paint(object sender, PaintEventArgs e)
        {
            ...
            var linearGradientBrush = new LinearGradientBrush(area1, Color.SteelBlue,
                Color.DodgerBlue, LinearGradientMode.Vertical);
            mGraphics.FillRectangle(linearGradientBrush, area1);
            mGraphics.DrawRectangle(pen1, area1);
        }
        ...
        private void panel1_Paint(object sender, PaintEventArgs e)
        {
            ...
            var  linearGradientBrush = new LinearGradientBrush(area1, Color.SteelBlue,
                Color.SteelBlue, LinearGradientMode.Vertical);
            mGraphics.FillRectangle(linearGradientBrush, area1);
            mGraphics.DrawRectangle(pen1, area1);
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            xLocation = 205;
            yLocation = 120;
            pictureBox2.Location = new Point(groupBox3.Width - pictureBox2.Width - 1, pictureBox2.Location.Y);
            pictureBox1.Location = new Point(groupBox3.Width - 2*pictureBox2.Width - 10, pictureBox2.Location.Y);
            timer2.Start();
            SeDeconnecter();
       ...
       public static int  height, width, xLocation, yLocation;
        ...
        private void logToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //if (LoginFrm.ShowBox() == "1")
            {
                //if (LoginFrm.typeUtilisateur == "admin")
                {
                    var frm = new GestionDuneClinique.FormesClinique.RequeteFrm();
                    frm.Location = new Point(xLocation, yLocation);
        ...
        {
            var path1 =  @"C:\Program Files\CDALI\PharmLogi\GestionPharmacetique.exe";
            var path2 =  @"C:\Program Files (x86)\CDALI\PharmLogi\GestionPharmacetique.exe";
        ...
        {
            var frm = new SGSP.Formes.JournalDeCaisseFrm();
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            var witdh = this.groupBox3.Width - 2 * pictureBox2.Width - 20;
            if (label2.Location.X > width)
            {
                label2.Location = new Point(15, label2.Location.Y);
            }
        }

        private void tableDesExamensToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            var frm = new GestionDuneClinique.FormesClinique.GroupeFrm();
            frm.ShowDialog();
        }

        private void facturesConventionnésToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var frm = new GestionDuneClinique.FormesClinique.ProFactureFrm();
            frm.Size = new Size(width + 190, height);
            frm.Location = new Point(18, 117);
            frm.ShowDialog();
        }   
