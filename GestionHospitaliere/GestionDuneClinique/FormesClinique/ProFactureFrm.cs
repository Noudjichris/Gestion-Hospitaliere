            ...
            try
            {
                ...
                }else if(e.ColumnIndex==10)
                {
                    ...
                    var dateFacture = DateTime.Parse(dataGridView2.Rows[e.RowIndex].Cells[1].Value.ToString());
                     bitmap = Impression.ImprimerAnalyse(numeroFacture, patient, dateFacture, dataGridView2.Rows[e.RowIndex].Cells[6].Value.ToString(),1);
                ...
                else if (e.ColumnIndex == 11)
                {
                    ...
                    var numeroFacture = Convert.ToInt32(dataGridView2.Rows[e.RowIndex].Cells[0].Value.ToString());
                    var dateFacture = DateTime.Parse(dataGridView2.Rows[e.RowIndex].Cells[1].Value.ToString());
                    bitmap = Impression.ImprimerAnalyse(numeroFacture, patient, dateFacture, dataGridView2.Rows[e.RowIndex].Cells[6].Value.ToString(),2);
                    if (printDialog1.ShowDialog() == DialogResult.OK)
                    {
                        printDocument1.PrinterSettings = printDialog1.PrinterSettings;
                        printPreviewDialog1.ShowDialog();
