...
namespace GestionDuneClinique.Formes
{
    public partial class RapportEntrepriseFrm : Form
    {
        ...
        private void RapportEntreprise_Load(object sender, EventArgs e)
        {
            ...
            cll2.Width = dataGridView1.Width / 5-30;
            cll3.Width = dataGridView1.Width / 6;
            cll4.Width = dataGridView1.Width / 20;
            cll5.Width = dataGridView1.Width / 16;
            cll6.Width = dataGridView1.Width / 16;
            cll7.Width = dataGridView1.Width / 16;
            cll8.Width = dataGridView1.Width / 16;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                foreach (DataGridViewRow dtGrid in dgvPatient.Rows)
                    {
                        ...
                        if (Int32.TryParse(dtGrid.Cells[0].Value.ToString(), out idPatient))
                        {
                            ...
                            var dtCredit = ConnectionClassPharmacie.ListeDesCredit(dtGrid.Cells[1].Value.ToString(), cmbEntreprise.Text, dtp1.Value.Date, dtp2.Value.Date.AddHours(24));
                            var total = 0.0;
                ...
                montantPharmacie = totalPharmacie;
                ...
                if (etatImpression == "1")
                {
                    ...
                    if (dataGridView1.Rows.Count > 0 && cmbEntreprise.Text != "")
                    {
                        ...
                        var entreprise = new Entreprise(listeEntreprise[0].NumeroEntreprise, listeEntreprise[0].NomEntreprise, listeEntreprise[0].Telephone1,
                            listeEntreprise[0].Telephone2, listeEntreprise[0].Email, listeEntreprise[0].Adresse, listeEntreprise[0].DateAbonnement, listeEntreprise[0].PrixHonoraire, listeEntreprise[0].Attache, listeEntreprise[0].SiLimite, listeEntreprise[0].MontantLimite);
                        ...
                        sfd.FileName =  "Rapport  _imprimé_le_" + date + ".pdf";

                        if (sfd.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                        {
                            rapportBitmap = Impression.RapportDuneEntreprise(dataGridView1, entreprise,dtp1.Value, dtp2.Value, Double.Parse(lblTotal.Text), reduction);
                ...
                if (cmbEntreprise.Text != "")
                {
                    ...
                    var dateFin = dtp2.Value.Date;
                        ...
                        for (var  i =0; i<dataGridView1.Rows.Count;i++)
                        {
                            ...
                            facture.DateFacture=DateTime.Parse(dataGridView1.Rows[i].Cells[2].Value.ToString());
                                facture.Designation = dataGridView1.Rows[i].Cells[3].Value.ToString();
                                facture.PrixTotal = double.Parse(dataGridView1.Rows[i].Cells[6].Value.ToString());
                                facture.Quantite = Int32.Parse(dataGridView1.Rows[i].Cells[4].Value.ToString());
                                facture.Prix = double.Parse(dataGridView1.Rows[i].Cells[5].Value.ToString());
                                listeFacture.Add(facture);
                                montantTotal += double.Parse(dataGridView1.Rows[i].Cells[6].Value.ToString());
                        ...
                        if (sfd.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                        {
                            var rapportCaissier = Impression.RapportPatient("FACTURE du "+dateDebut.ToShortDateString() +
                           ...
                           if (dgvPatient.SelectedRows.Count > 0)
                           {
                               ...
                               foreach (DataGridViewRow dtGrid in dgvPatient.SelectedRows)
                               {
                                   ...
                                   if (Int32.TryParse(dtGrid.Cells[0].Value.ToString(), out idPatient))
                                   {
                                       ...
                                       var dtCredit = ConnectionClassPharmacie.ListeDesCredit(nomPatient,cmbEntreprise.Text, dtp1.Value.Date, dtp2.Value.Date.AddHours(24));
                ...
                if (dataGridView2.Rows.Count > 0 && cmbEntreprise.Text != "")
                {
                    ...
                    #region MyRegion
                     SaveFileDialog sfd = new SaveFileDialog();
                        ...
                        sfd.InitialDirectory = pathFolder;
                        sfd.FileName =  "Rapport de _imprimé_le_" + date + ".pdf";
                        ...
                        if (sfd.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                        {
                            ...
                            if (rowCount > 11)
                            {
                                var Count = (dataGridView1.Rows.Count - 11) / 23;

                                for (var i = 0; i <= Count; i++)
                                {
                                    if (i * 23 < dataGridView1.Rows.Count)
                                    {
...
//            }
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            frm.state = "2";
            frm.entreprise = cmbEntreprise.Text;
            frm.dateDebut = dtp1.Value.Date;frm.dateFin = dtp2.Value.Date;
            frm.Location = new Point(Location.X, Location.Y + 5);
            frm.Size = new Size(Width, Height - 10);
            frm.montantPharmacie = montantPharmacie;
            frm.ShowDialog();
        }
