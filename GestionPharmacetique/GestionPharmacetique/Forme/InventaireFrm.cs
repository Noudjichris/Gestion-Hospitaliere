    ...
    public partial class InventaireFrm : Form
    {
        ...
        void ListeInventaire()
        {
            try
            {
                ...
                var listeFamille = from h in ConnectionClass.ListeDesFamille()
                                       where !h.Designation.Equals("HOSPITALISATION")
                                       select  h;
                ...
                if (checkBox1.Checked)
                {
                    foreach (var p in listeFamille)
                    {
                        ...
                        var l = ConnectionClass.ListeDesMedicamentsRechercherParFamilleQuantiteSupZero(p.Designation);
                        if (l.Count > 0)
                        {
                            dgvProduit.Rows.Add(
                                        p.Designation, "", "", "", "", "", "", ""
                ...
                else
                {
                    foreach (var p in listeFamille)
                    {
                        ...
                        var l = ConnectionClass.ListeDesMedicamentsRechercherParFamille(p.Designation);
                        if (l.Count() > 0)
                        {
                            dgvProduit.Rows.Add(
                                        p.Designation, "", "", "", "", "", "", ""
