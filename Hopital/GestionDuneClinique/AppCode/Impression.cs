...
namespace GestionDuneClinique.AppCode
{
    public class Impression
    {
        ...
        public static Bitmap ImprimerAnalyse(int numeroFacture, Patient patient, DateTime dateAnalyse, string caissier)
        {
            ...
            graphic.DrawString("N'DJAMENA LE  " + DateTime.Now.ToString(), fnt1, Brushes.Black, unite_largeur, 13 * unite_hauteur + 5);
            graphic.DrawString("BON DE SOIN N° " + numeroFacture, fnt3, Brushes.Black, 6 * unite_largeur, 11 * unite_hauteur + 8);
        ...
        public static Bitmap FichePatient(  Patient patient)
        {
            ...
            {
                Image logo = global::GestionDuneClinique.Properties.Resources.logo;
                graphic.DrawImage(logo, 1 * unite_largeur, 2 * unite_hauteur, 12*unite_largeur, 3*unite_hauteur+15);
            }
            catch { }
            //definir les polices 
            Font fnt1 = new Font("Century Gothic", 11, FontStyle.Regular);
...
return bitmap;
        ...
        //    Patient patient, string modePaiement, double remise,double resteAPayer, string caissier)
        //{
        ...
        //        int detail_hauteur_facture = 22 * unite_hauteur + 5;
        //        int hauteur_facture = 45 * unite_hauteur + 7;
        ...
        //        graphic.Clear(Color.White);
        //        Image logo = global::GestionDuneClinique.Properties.Resources.logo;
        //        graphic.DrawImage(logo, 5, 5, 17 * unite_largeur - 20, 5 * unite_hauteur - 10);

        //        logo = global::GestionDuneClinique.Properties.Resources.rectangleEntete;
        //        graphic.DrawImage(logo, 10, 6 * unite_hauteur + 5, 17 * unite_largeur - 28, unite_hauteur + 2);
        //        logo = global::GestionDuneClinique.Properties.Resources.rectangle;
        //        graphic.DrawImage(logo, 5, 7 * unite_hauteur + 7, 17 * unite_largeur - 18, 4 * unite_hauteur + 10);

        //        graphic.DrawImage(logo, 5, 12 * unite_hauteur + 5, 17 * unite_largeur - 18, unite_hauteur + 9);

        //        logo = global::GestionDuneClinique.Properties.Resources.rectangleEntete;
        //        graphic.DrawImage(logo, 10, 13 * unite_hauteur + 20, 11 * unite_largeur - 18, unite_hauteur + 5);
        //        graphic.DrawImage(logo, 11 * unite_largeur - 10, 13 * unite_hauteur + 20, 1 * unite_largeur + 3, unite_hauteur + 5);
        //        graphic.DrawImage(logo, 12 * unite_largeur - 6, 13 * unite_hauteur + 20, 2 * unite_largeur, unite_hauteur + 5);
        //        graphic.DrawImage(logo, 14 * unite_largeur - 6, 13 * unite_hauteur + 20, 2 * unite_largeur + 17, unite_hauteur + 5);

        //        logo = global::GestionDuneClinique.Properties.Resources.rectangle1;
        //        graphic.DrawImage(logo, 10, 14 * unite_hauteur + 20, 11 * unite_largeur - 18, detail_hauteur_facture + 5);
        //        graphic.DrawImage(logo, 11 * unite_largeur - 10, 14 * unite_hauteur + 20, 1 * unite_largeur + 3, detail_hauteur_facture + 5);
        //        graphic.DrawImage(logo, 12 * unite_largeur - 6, 14 * unite_hauteur + 20, 2 * unite_largeur, detail_hauteur_facture + 5);
        //        graphic.DrawImage(logo, 14 * unite_largeur - 6, 14 * unite_hauteur + 20, 2 * unite_largeur + 17, detail_hauteur_facture + 5);
        ...
        //        graphic.DrawString("N'Djaména le, " + listeFacture[0].DateFacture, fnt1, Brushes.Black, 10, 5 * unite_hauteur + 5);
        //        graphic.DrawString("FACTURE DE SOIN N° " + DateTime.Now.Year + "/" + numeroFacture, fnt3, Brushes.Black, 4 * unite_largeur, 12 * unite_hauteur + 4);
        //        graphic.DrawString("Date validation :  " + listeFacture[0].DateFacture.AddDays(15), fnt1, Brushes.Black, 9 * unite_largeur + 16, 5 * unite_hauteur + 5);
        ...
        //        graphic.DrawString("Informations du patient  ", fnt11, Brushes.White, 6 * unite_largeur, 6 * unite_hauteur + 5);
        //        graphic.DrawString("N° identifiant :", fnt1, Brushes.Black, 2 * unite_largeur, 7 * unite_hauteur + 10);
        //        graphic.DrawString("Patient :", fnt1, Brushes.Black, 2 * unite_largeur, 8 * unite_hauteur + 10);
        //        graphic.DrawString("Sexe :   ", fnt1, Brushes.Black, 2 * unite_largeur, 9 * unite_hauteur + 7);
        //        graphic.DrawString("Age :    ", fnt1, Brushes.Black, 2 * unite_largeur, 10 * unite_hauteur + 4);

        //        graphic.DrawString(patient.NumeroPatient.ToString(), fnt2, Brushes.Black, 5 * unite_largeur, 7 * unite_hauteur + 5);
        //        graphic.DrawString(patient.Nom.ToUpper() + " " + patient.Prenom.ToUpper(), fnt1, Brushes.Black, 5 * unite_largeur, 8 * unite_hauteur + 10);
        //        graphic.DrawString(patient.Sexe + "                         GS/RH :   " + patient.Rhesus + "     Adresse : " + patient.Adresse, fnt1, Brushes.Black, 5 * unite_largeur, 9 * unite_hauteur + 7);
        //        graphic.DrawString(AfficherAge(patient.An, patient.Mois) + "                Tél :   " + patient.Telephone + "            Fonction : " + patient.Fonction, fnt1, Brushes.Black, 5 * unite_largeur, 10 * unite_hauteur + 4);

        //        graphic.DrawString("Acte médical  ", fnt11, Brushes.White, 20, 13 * unite_hauteur + 20);
        //        graphic.DrawString("Qté  ", fnt11, Brushes.White, 11 * unite_largeur - 8, 13 * unite_hauteur + 20);
        //        graphic.DrawString("P unit  ", fnt11, Brushes.White, 12 * unite_largeur + 5, 13 * unite_hauteur + 20);
        //        graphic.DrawString("P Total  ", fnt11, Brushes.White, 14 * unite_largeur + 0, 13 * unite_hauteur + 20);

        //        var total = 0.0;
        //        for (var i = 0; i <= dtGrid.Rows.Count - 1; i++)
        //        {
        //            var Yloc = unite_hauteur * i + 15 * unite_hauteur + 3;
        ...
        //        graphic.FillRectangle(Brushes.White, 10, 36 * unite_hauteur + 19, 17 * unite_largeur - 10, 10 * unite_hauteur);
        //        logo = global::GestionDuneClinique.Properties.Resources.rectangleEntete;
        //        graphic.DrawImage(logo, 9, 36 * unite_hauteur + 19, 17 * unite_largeur - 26, unite_hauteur + 7);
        //        logo = global::GestionDuneClinique.Properties.Resources.rect;
        //        graphic.DrawImage(logo, 9 * unite_largeur, 37 * unite_hauteur + 26, 8 * unite_largeur - 22, unite_hauteur + 7);
        //        graphic.DrawString("TOTAL ", fnt11, Brushes.White, 20, 36 * unite_hauteur + 20);
        //        graphic.DrawString(string.Format(elGR, "{0:0,0}", totalNet) + " F CFA", fnt11, Brushes.White, 13 * unite_largeur - 10, 36 * unite_hauteur + 20);
        //        graphic.DrawString("Total remise :  ".ToUpper() + string.Format(elGR, "{0:0,0}", remise) + " FCFA", fnt11, Brushes.Black, 10 * unite_largeur - 25, 37 * unite_hauteur + 28);

        //        graphic.DrawString("Arrêtée la présente facture à la somme de : ........................................................................... ",
        //            fnt22, Brushes.Black, 10, 39 * unite_hauteur + 20);
        //        graphic.DrawString(".......................................................................................................................................................... ",
        //           fnt22, Brushes.Black, 10, 40 * unite_hauteur + 20);
        //        var lettre = Converti((long)totalNet) + " Francs CFA";
        //        if (lettre.Length > 40)
        //        {
        //            graphic.DrawString(lettre.Substring(0, 40), fnt22, Brushes.Black, 8 * unite_largeur + 28, 39 * unite_hauteur + 15);
        //            graphic.DrawString(lettre.Substring(40), fnt22, Brushes.Black, unite_largeur, 40 * unite_hauteur + 15);
        //        }
        //        else
        //        {
        //            graphic.DrawString(lettre, fnt22, Brushes.Black, 9 * unite_largeur + 5, 39 * unite_hauteur + 15);
        //        }
        ...
        //fonction pour dessiner le recu de la facuter
        public static Bitmap FactureOfficielle(int numeroFacture, DataGridView dtGrid,
            Patient patient, string modePaiement, double remise,double reste,  string caissier)
        {
            ...
            try
            {
                ...
                int unite_largeur = 32;
                int largeur_facture = 24 * unite_largeur + 0;
                int detail_hauteur_facture = 17 * unite_hauteur + 5;
                int hauteur_facture = 35 * unite_hauteur+15 ;
                ...
                graphic.Clear(Color.White);
                Image logo = global::GestionDuneClinique.Properties.Resources.logo;
                graphic.DrawImage(logo, unite_largeur, 5, 10 * unite_largeur - 20,3 * unite_hauteur +10);

                //logo = global::GestionDuneClinique.Properties.Resources.rectangleEntete;
                graphic.DrawLine(Pens.Black, unite_largeur, 6 * unite_hauteur +5, 24 * unite_largeur, 6*unite_hauteur +5);

                //logo = global::GestionDuneClinique.Properties.Resources.rectangle;
                //graphic.DrawImage(logo, unite_largeur-4, 7 * unite_hauteur, 18 * unite_largeur+8, unite_hauteur + 10);
                //logo = global::GestionDuneClinique.Properties.Resources.rectangle; 
                //graphic.DrawImage(logo, unite_largeur-4, 8 * unite_hauteur +10, 18 * unite_largeur+8 , 2 * unite_hauteur + 7);

                //logo = global::GestionDuneClinique.Properties.Resources.rectangle1;
                //graphic.DrawImage(logo, unite_largeur, 12* unite_hauteur + 0, 12* unite_largeur -1, unite_hauteur + 8);
                //graphic.DrawImage(logo, unite_largeur *13-4, 12 * unite_hauteur + 0, 3 * unite_largeur + 1, unite_hauteur + 8);
                //graphic.DrawImage(logo, unite_largeur*16-4 , 12 * unite_hauteur + 0, 4 * unite_largeur+1, unite_hauteur + 8);
                //graphic.DrawImage(logo, unite_largeur *20-4, 12 * unite_hauteur + 0, 4 * unite_largeur + 0, unite_hauteur +8);

                //logo = global::GestionDuneClinique.Properties.Resources.rectangle1;
                //graphic.DrawImage(logo, unite_largeur , 13 * unite_hauteur +6, 12 * unite_largeur -1, detail_hauteur_facture + 5);
                //graphic.DrawImage(logo, unite_largeur * 13-4, 13 * unite_hauteur + 6,3 * unite_largeur + 1, detail_hauteur_facture + 5);
                //graphic.DrawImage(logo, unite_largeur*16 - 4 , 13 * unite_hauteur + 6, 4 * unite_largeur+1, detail_hauteur_facture + 5);
                //graphic.DrawImage(logo, unite_largeur *20-4 ,13 * unite_hauteur +6, 4 * unite_largeur + 1, detail_hauteur_facture + 5);

                //definir les polices 
                Font fnt1 = new Font("Arial Narrow", 15, FontStyle.Regular);
                Font fnt11 = new Font("Arial Narrow", 14, FontStyle.Bold);
                Font fnt2 = new Font("Arial Narrow", 20, FontStyle.Bold);
                Font fnt3 = new Font("Arial Narrow", 22, FontStyle.Bold);
                Font fnt22 = new Font("Arial Narrow", 15, FontStyle.Regular);

                #endregion

                var listeFacture = ConnectionClassClinique.ListeDesFactures(numeroFacture);
                graphic.DrawString("Vous servir est notre devise - Bon  Retablissement " , fnt1, Brushes.Black, 12 * unite_largeur+0, 3 * unite_hauteur + 0);
                graphic.DrawString("Date  : " + listeFacture[0].DateFacture, fnt1, Brushes.Black, 17 * unite_largeur, 5 * unite_hauteur + 5);
                graphic.DrawString("FACTURE DE SOIN N° " + DateTime.Now.Year + "/" + numeroFacture, fnt3, Brushes.Black,  unite_largeur, 5 * unite_hauteur-5);
                //graphic.DrawString("Date validation :  " + listeFacture[0].DateFacture.AddDays(15), fnt1, Brushes.Black, 9 * unite_largeur + 16, 5 * unite_hauteur + 5);
                //graphic.DrawRectangle(Pens.Black,     10, 8 * unite_hauteur, 17 * unite_largeur - 10, 5 * unite_hauteur + 10);
                //graphic.FillRectangle(Brushes.Black, 10, 8 * unite_hauteur, 17 * unite_largeur - 10, unite_hauteur);

                graphic.DrawString(patient.Nom.ToUpper() + " " + patient.Prenom.ToUpper(), fnt2, Brushes.Black, 2* unite_largeur, 7* unite_hauteur + 3);
                graphic.DrawString("N° identifiant :  " + patient.NumeroPatient.ToString(), fnt2, Brushes.Black, 2 * unite_largeur, 8 * unite_hauteur + 10);
                graphic.DrawString("Sexe :   " + patient.Sexe, fnt1, Brushes.Black, 2 * unite_largeur, 9 * unite_hauteur + 12);
                graphic.DrawString("Age :    " + AfficherAge(patient.An, patient.Mois), fnt1, Brushes.Black, 5* unite_largeur, 9 * unite_hauteur + 12);

                // graphic.DrawString(+ "     Adresse : " + patient.Adresse, fnt2, Brushes.Black, 5 * unite_largeur, 7 * unite_hauteur + 5);
                graphic.DrawString("GS/RH :   " + patient.Rhesus , fnt1, Brushes.Black, 10* unite_largeur, 9 * unite_hauteur + 12);
                graphic.DrawString("Tél :   " + patient.Telephone,  fnt1, Brushes.Black, 13* unite_largeur, 9 * unite_hauteur +12);

                graphic.DrawString("Acte médical  ", fnt11, Brushes.Black, unite_largeur+20, 12 * unite_hauteur + 2);
                graphic.DrawString("Quantité  ", fnt11, Brushes.Black, 13 * unite_largeur +10, 12 * unite_hauteur + 2);
                graphic.DrawString("Prix unit  ", fnt11, Brushes.Black, 16 * unite_largeur+25, 12 * unite_hauteur + 2);
                graphic.DrawString("Montant  ", fnt11, Brushes.Black, 21* unite_largeur +0, 12 * unite_hauteur + 2);

                var total = 0.0;
                for (var i = 0; i <= dtGrid.Rows.Count - 1; i++)
                {
                    var Yloc = unite_hauteur * i + 14 * unite_hauteur -5;
                    graphic.DrawString(dtGrid.Rows[i].Cells[0].Value.ToString().ToUpper(), fnt1, Brushes.Black,unite_largeur+ 20, Yloc);
                    graphic.DrawString(dtGrid.Rows[i].Cells[2].Value.ToString(), fnt1, Brushes.Black, 14 * unite_largeur + 0, Yloc);
                    graphic.DrawString(string.Format(elGR, "{0:0,0}", Double.Parse(dtGrid.Rows[i].Cells[1].Value.ToString())), fnt1, Brushes.Black, 17 * unite_largeur , Yloc);
                    graphic.DrawString(string.Format(elGR, "{0:0,0}", Double.Parse(dtGrid.Rows[i].Cells[3].Value.ToString())), fnt1, Brushes.Black, 21 * unite_largeur -5, Yloc);
                    total += Double.Parse(dtGrid.Rows[i].Cells[3].Value.ToString());
                }
                var totalNet = total - remise;
                //graphic.FillRectangle(Brushes.White, 10, 37 * unite_hauteur + 5, 17 * unite_largeur, 15*unite_hauteur);
                graphic.FillRectangle(Brushes.White, 20, 31 * unite_hauteur-5, 25 * unite_largeur , 10 * unite_hauteur);
                if (dtGrid.Rows.Count <= 15)
                {
                    //logo = global::GestionDuneClinique.Properties.Resources.rectangle1;
                    // graphic.DrawImage(logo, unite_largeur-3, 31 * unite_hauteur -10, 23 * unite_largeur +5, unite_hauteur + 7);
                    var LOC = unite_hauteur * dtGrid.Rows.Count + 15 * unite_hauteur - 5;
                    graphic.DrawLine(Pens.Black, unite_largeur,LOC-3, 24 * unite_largeur, LOC-3);
                    graphic.DrawString("Total :", fnt11, Brushes.Black, 15 * unite_largeur - 0, LOC);
                    graphic.DrawString(string.Format(elGR, "{0:0,0}", totalNet) + " F CFA", fnt11, Brushes.Black, 20 * unite_largeur -5, LOC);
                    if (reste > 0)
                    {
                       
                        var dtPaie = ConnectionClassClinique.TableDetailPaiement(numeroFacture);
                        if (dtPaie.Rows.Count <= 1)
                        {
                            graphic.DrawString("Total payé ", fnt11, Brushes.Black, 15 * unite_largeur - 8, LOC + unite_hauteur);
                            graphic.DrawString(string.Format(elGR, "{0:0,0}", totalNet - reste) + " F CFA", fnt11, Brushes.Black, 20 * unite_largeur - 5, LOC + unite_hauteur);
                            graphic.DrawString("Reste à payer :", fnt11, Brushes.Black, 15 * unite_largeur - 8, LOC + 2 * unite_hauteur);
                            graphic.DrawString(string.Format(elGR, "{0:0,0}", reste) + " F CFA", fnt11, Brushes.Black, 20 * unite_largeur - 5, LOC + 2 * unite_hauteur);
                            graphic.DrawLine(Pens.Black, unite_largeur, 3 * unite_hauteur + LOC + 3, 24 * unite_largeur, 3 * unite_hauteur + LOC + 3);
                        }
                        else
                        {
                            var totalPaye = .0;
                            for(var k =0; k <dtPaie.Rows.Count; k++ )
                            {
                                var WLOC = LOC + unite_hauteur +10+ k * unite_hauteur;
                                totalPaye += double.Parse(dtPaie.Rows[k].ItemArray[2].ToString());
                                graphic.DrawString(dtPaie.Rows[k].ItemArray[1].ToString(), fnt11, Brushes.Black, 15 * unite_largeur - 5, WLOC);
                                graphic.DrawString(string.Format(elGR, "{0:0,0}", double.Parse(dtPaie.Rows[k].ItemArray[2].ToString())) + " F CFA", fnt11, Brushes.Black, 20 * unite_largeur - 5, WLOC);
                            }
                            LOC += dtPaie.Rows.Count * unite_hauteur;
                            graphic.DrawLine(Pens.Black, unite_largeur, 2* unite_hauteur + LOC + 1, 24 * unite_largeur, 2 * unite_hauteur + LOC + 1);
                            graphic.DrawString("Total  payé : ", fnt11, Brushes.Black, 15 * unite_largeur - 8, LOC + 2 * unite_hauteur+2);
                            graphic.DrawString(string.Format(elGR, "{0:0,0}", totalPaye) + " F CFA", fnt11, Brushes.Black, 20 * unite_largeur - 5, LOC + 2 * unite_hauteur+2);

                            graphic.DrawString("Reste à payer :", fnt11, Brushes.Black, 15* unite_largeur - 5, LOC + 3 * unite_hauteur+2);
                            graphic.DrawString(string.Format(elGR, "{0:0,0}", reste) + " F CFA", fnt11, Brushes.Black, 20 * unite_largeur - 5, LOC + 3 * unite_hauteur+2);
                            graphic.DrawLine(Pens.Black, unite_largeur, 4 * unite_hauteur + LOC + 5, 24 * unite_largeur, 4 * unite_hauteur + LOC + 5);
                        }
                    }
                    else
                    {
                        ...
                        if (dtPaie.Rows.Count <= 1)
                        {
                            graphic.DrawLine(Pens.Black, unite_largeur, 1 * unite_hauteur + LOC + 5, 24 * unite_largeur, 1 * unite_hauteur + LOC + 5);
                        }
                        else
                        {
                            var totalPaye = .0;
                            for (var k = 0; k < dtPaie.Rows.Count; k++)
                            {
                               var  WLOC =LOC + 10+  unite_hauteur+k * unite_hauteur;
                                totalPaye += double.Parse(dtPaie.Rows[k].ItemArray[2].ToString());
                                graphic.DrawString(dtPaie.Rows[k].ItemArray[1].ToString(), fnt11, Brushes.Black, 15 * unite_largeur - 5, WLOC);
                                graphic.DrawString(string.Format(elGR, "{0:0,0}", double.Parse(dtPaie.Rows[k].ItemArray[2].ToString())) + " F CFA", fnt11, Brushes.Black, 20 * unite_largeur - 5, WLOC);
                            }
                    ...
                    {
                        //logo = global::GestionDuneClinique.Properties.Resources.rect;
                        //graphic.DrawImage(logo, 17 * unite_largeur, 24 * unite_hauteur + 1, 7 * unite_largeur, unite_hauteur + 5);
                        var tauxRemise =100- remise * 100 / total ;
                        graphic.DrawString("Total  :  " + string.Format(elGR, "{0:0,0}", total) + " FCFA", fnt11, Brushes.Black, 1* unite_largeur +5, LOC + 0);
                        graphic.DrawString("Part patient  : ("+tauxRemise +"%) " + string.Format(elGR, "{0:0,0}", total-remise) + " FCFA", fnt11, Brushes.Black, 7 * unite_largeur - 5, LOC +0);

                        graphic.DrawString("Caissier(e) :  ".ToUpper() + caissier.ToUpper(), fnt11, Brushes.Black, 9 * unite_largeur + 0, 31 * unite_hauteur + 5);
                    }
                    else
                    {
                            graphic.DrawString("Caissier(e) :  ".ToUpper() + caissier.ToUpper(), fnt11, Brushes.Black, 9 * unite_largeur + 0, 31 * unite_hauteur + 5);
        ...
        public static Bitmap FactureOfficielle(DataGridView dtGrid, double remise, string caissier, int start)
        {
            ...
            try
            {
                ...
                int detail_hauteur_facture = 20 * unite_hauteur + 13;
                int hauteur_facture = 29 * unite_hauteur;
               ...
               var  logo = global::GestionDuneClinique.Properties.Resources.rectangleEntete;
                //graphic.DrawImage(logo, unite_largeur, 5 * unite_hauteur, 14 * unite_largeur, unite_hauteur + 10);
             
                logo = global::GestionDuneClinique.Properties.Resources.rectangleEntete;
                graphic.DrawImage(logo, unite_largeur, 1 * unite_hauteur + 0, 12 * unite_largeur - 1, unite_hauteur + 8);
                graphic.DrawImage(logo, unite_largeur * 13 - 4, 1 * unite_hauteur + 0, 3 * unite_largeur + 1, unite_hauteur + 8);
                graphic.DrawImage(logo, unite_largeur * 16 - 4, 1 * unite_hauteur + 0, 4 * unite_largeur + 1, unite_hauteur + 8);
                graphic.DrawImage(logo, unite_largeur * 20 - 4, 1 * unite_hauteur + 0, 4 * unite_largeur + 0, unite_hauteur + 8);

                logo = global::GestionDuneClinique.Properties.Resources.rectangle1;
                graphic.DrawImage(logo, unite_largeur, 2 * unite_hauteur + 6, 12 * unite_largeur - 1, detail_hauteur_facture + 5);
                graphic.DrawImage(logo, unite_largeur * 13 - 4, 2 * unite_hauteur + 6, 3 * unite_largeur + 1, detail_hauteur_facture + 5);
                graphic.DrawImage(logo, unite_largeur * 16 - 4, 2 * unite_hauteur + 6, 4 * unite_largeur + 1, detail_hauteur_facture + 5);
                graphic.DrawImage(logo, unite_largeur * 20 - 4, 2 * unite_hauteur + 6, 4 * unite_largeur + 1, detail_hauteur_facture + 5);

                //definir les polices 
                Font fnt1 = new Font("Arial Narrow", 10, FontStyle.Regular);
                Font fnt11 = new Font("Arial Narrow", 11, FontStyle.Bold);
                Font fnt2 = new Font("Arial Narrow", 12, FontStyle.Bold);
                Font fnt3 = new Font("Arial Narrow", 16, FontStyle.Bold);
                Font fnt22 = new Font("Arial Narrow", 10, FontStyle.Regular);
                #endregion

                graphic.DrawString("Acte médical  ", fnt11, Brushes.White, unite_largeur + 20, 2 * unite_hauteur + 8);
                graphic.DrawString("Quantité  ", fnt11, Brushes.White, 13* unite_largeur + 16, 2 * unite_hauteur + 8);
                graphic.DrawString("Prix unit  ", fnt11, Brushes.White, 16 * unite_largeur + 25, 2 * unite_hauteur + 8);
                graphic.DrawString("Montant  ", fnt11, Brushes.White, 21 * unite_largeur + 0, 2* unite_hauteur + 8);

                var total = 0.0;
                var j = 0;
                for (var i = start*20+8; i <= dtGrid.Rows.Count - 1; i++)
                {
                    var Yloc = unite_hauteur * j + 3 * unite_hauteur - 5;
                    graphic.DrawString(dtGrid.Rows[i].Cells[0].Value.ToString().ToUpper(), fnt1, Brushes.Black, unite_largeur + 20, Yloc);
                    graphic.DrawString(string.Format(elGR, "{0:0,0}", Double.Parse(dtGrid.Rows[i].Cells[2].Value.ToString())), fnt1, Brushes.Black, 14 * unite_largeur + 0, Yloc);
                    graphic.DrawString(string.Format(elGR, "{0:0,0}", Double.Parse(dtGrid.Rows[i].Cells[1].Value.ToString())), fnt1, Brushes.Black, 17 * unite_largeur, Yloc);
                    graphic.DrawString(string.Format(elGR, "{0:0,0}", Double.Parse(dtGrid.Rows[i].Cells[3].Value.ToString())), fnt1, Brushes.Black, 21 * unite_largeur + 0, Yloc);
                    total += Double.Parse(dtGrid.Rows[i].Cells[3].Value.ToString());
                    j++;
                }
                var totalNet = total - remise;
                //graphic.FillRectangle(Brushes.White, 10, 37 * unite_hauteur + 5, 17 * unite_largeur, 15*unite_hauteur);
                graphic.FillRectangle(Brushes.White, 20, 23 * unite_hauteur - 4, 25 * unite_largeur, 10 * unite_hauteur);
                if (dtGrid.Rows.Count <= start * 20 + 8)
                {
                    logo = global::GestionDuneClinique.Properties.Resources.rectangleEntete;
                    graphic.DrawImage(logo, unite_largeur - 4, 23 * unite_hauteur - 6, 23 * unite_largeur + 6, unite_hauteur + 7);

                    graphic.DrawString("Total ", fnt11, Brushes.White, 2 * unite_largeur, 23 * unite_hauteur - 4);
                    graphic.DrawString(string.Format(elGR, "{0:0,0}", totalNet) + " F CFA", fnt11, Brushes.White, 21 * unite_largeur - 10, 23 * unite_hauteur - 4);
                    var lettre = Converti((long)totalNet) + " Francs CFA";
                    if (remise > 0)
                    {
                        logo = global::GestionDuneClinique.Properties.Resources.rect;
                        graphic.DrawImage(logo, 17 * unite_largeur, 24 * unite_hauteur + 1, 7 * unite_largeur, unite_hauteur + 5);
                        graphic.DrawString("Total remise :  ".ToUpper() + string.Format(elGR, "{0:0,0}", remise) + " FCFA", fnt11, Brushes.Black, 17 * unite_largeur + 15, 24 * unite_hauteur + 3);
                        graphic.DrawString("Arrêtée la présente facture à la somme de : ",
                             fnt22, Brushes.Black, 2 * unite_largeur, 25 * unite_hauteur + 15);
                        graphic.DrawString("................................................................................................................................................................ ",
                           fnt22, Brushes.Black, 9 * unite_largeur - 15, 25 * unite_hauteur + 15);
                        graphic.DrawString(lettre, fnt22, Brushes.Black, 9 * unite_largeur - 15, 25 * unite_hauteur + 12);
                        graphic.DrawString("Caissier(e) :  ".ToUpper() + caissier.ToUpper(), fnt11, Brushes.Black, 10 * unite_largeur + 0, 27 * unite_hauteur + 5);
                    }
                    else
                    {
                            graphic.DrawString("Arrêtée la présente facture à la somme de : ",
                                 fnt22, Brushes.Black, 2 * unite_largeur, 24 * unite_hauteur + 15);
                            graphic.DrawString("................................................................................................................................................................ ",
                               fnt22, Brushes.Black, 9 * unite_largeur - 15, 24 * unite_hauteur + 15);
                            graphic.DrawString(lettre, fnt22, Brushes.Black, 9 * unite_largeur - 15, 24 * unite_hauteur + 12);
                            graphic.DrawString("Caissier(e) :  ".ToUpper() + caissier.ToUpper(), fnt11, Brushes.Black, 10 * unite_largeur + 0, 26 * unite_hauteur + 5);
        ...
        public static Bitmap FactureConsultation(int numeroConsultation,DateTime dateConsultation, DataGridView dtGrid, Patient patient, string caissier)
        {
            ...
            try
            {
                ...
                //definir les polices 
                Font fnt1 = new Font("Arial Narrow", 15, FontStyle.Regular);
                Font fnt11 = new Font("Arial Narrow", 15, FontStyle.Bold);
                Font fnt2 = new Font("Arial Narrow", 20, FontStyle.Bold);
                Font fnt3 = new Font("Arial Narrow", 22, FontStyle.Bold);
                Font fnt22 = new Font("Arial Narrow", 15, FontStyle.Regular);
                ...
                graphic.DrawString("Vous servir est notre devise - Bon  Retablissement ", fnt1, Brushes.Black, 12 * unite_largeur + 0, 3 * unite_hauteur + 0);
                graphic.DrawString("Date facture : " + dateConsultation.ToShortDateString(), fnt1, Brushes.Black, 17 * unite_largeur, 5 * unite_hauteur + 5);
                graphic.DrawString("FACTURE DE SOIN N° " + DateTime.Now.Year + "/" + numeroConsultation, fnt3, Brushes.Black, unite_largeur, 5 * unite_hauteur - 5);
                //graphic.DrawString("Date validation :  " + listeFacture[0].DateFacture.AddDays(15), fnt1, Brushes.Black, 9 * unite_largeur + 16, 5 * unite_hauteur + 5);

                var patientNom = patient.Nom.ToUpper() + " " + patient.Prenom.ToUpper();
                if (!string.IsNullOrEmpty(patient.SousCouvert))
                {
                    patientNom = patientNom + " S/C " + patient.SousCouvert;
                }
                graphic.DrawString(patientNom, fnt2, Brushes.Black, 2 * unite_largeur, 7 * unite_hauteur - 10);
                graphic.DrawString("N° identifiant :  " + patient.NumeroPatient.ToString(), fnt2, Brushes.Black, 2 * unite_largeur, 8 * unite_hauteur + 2);
                graphic.DrawString("Sexe :   " + patient.Sexe, fnt1, Brushes.Black, 2 * unite_largeur, 9 * unite_hauteur + 5);
                graphic.DrawString("Age :    " + AfficherAge(patient.An, patient.Mois), fnt1, Brushes.Black, 5 * unite_largeur, 9 * unite_hauteur + 5);

                // graphic.DrawString(+ "     Adresse : " + patient.Adresse, fnt2, Brushes.Black, 5 * unite_largeur, 7 * unite_hauteur + 5);
                graphic.DrawString("GS/RH :   " + patient.Rhesus, fnt1, Brushes.Black, 10 * unite_largeur, 9 * unite_hauteur + 5);
                graphic.DrawString("Tél :   " + patient.Telephone, fnt1, Brushes.Black, 13 * unite_largeur, 9 * unite_hauteur + 5);
                graphic.DrawString("Convention :   " + patient.NomEntreprise, fnt1, Brushes.Black, 2 * unite_largeur, 10 * unite_hauteur + 5);
                ...
                var total = 0.0;
                for (var i = 0; i <= dtGrid.SelectedRows.Count - 1; i++)
                {
                    var Yloc = unite_hauteur * i + 15 * unite_hauteur - 5;
                    graphic.DrawString(dtGrid.SelectedRows[i].Cells[1].Value.ToString().ToUpper(), fnt1, Brushes.Black, unite_largeur + 20, Yloc);
                    graphic.DrawString("1", fnt1, Brushes.Black, 14 * unite_largeur + 0, Yloc);
                    graphic.DrawString(string.Format(elGR, "{0:0,0}", Double.Parse(dtGrid.SelectedRows[i].Cells[7].Value.ToString())), fnt1, Brushes.Black, 17 * unite_largeur, Yloc);
                    graphic.DrawString(string.Format(elGR, "{0:0,0}", Double.Parse(dtGrid.SelectedRows[i].Cells[7].Value.ToString())), fnt1, Brushes.Black, 21 * unite_largeur - 5, Yloc);
                    total += Double.Parse(dtGrid.SelectedRows[i].Cells[7].Value.ToString());
                }

                //var LOC = unite_hauteur * dtGrid.Rows.Count + 15 * unite_hauteur - 5;
                graphic.DrawLine(Pens.Black, unite_largeur, 23 * unite_hauteur -3, 24 * unite_largeur, 23 * unite_hauteur -3);
                graphic.DrawLine(Pens.Black, unite_largeur, 24* unite_hauteur +3, 24 * unite_largeur, 24 * unite_hauteur + 3);
                graphic.DrawString("Total :", fnt11, Brushes.Black, 17 * unite_largeur-10 , 23*unite_hauteur);
                    graphic.DrawString(string.Format(elGR, "{0:0,0}", total ) + " F CFA", fnt11, Brushes.Black, 20 * unite_largeur -5, 23*unite_hauteur);
                    
                        graphic.DrawString("Caissier(e) :  ".ToUpper() + caissier.ToUpper(), fnt11, Brushes.Black, 9 * unite_largeur + 0, 28 * unite_hauteur + 5);
        ...
        //        for (var i = 0; i <= dtGrid.Rows.Count - 1; i++)
        //        {
        //            var Yloc = unite_hauteur * i + 14* unite_hauteur+10;
        ...
        //        }
        //        graphic.FillRectangle(Brushes.White, 9, 37 * unite_hauteur - 10, 17 * unite_largeur - 26, unite_hauteur * 7);

        //        logo = global::GestionDuneClinique.Properties.Resources.rectangleEntete;
        //        graphic.DrawImage(logo, 9, 37 * unite_hauteur - 10, 17 * unite_largeur - 26, unite_hauteur + 7);
        //        logo = global::GestionDuneClinique.Properties.Resources.rect;

        //        graphic.DrawString("Total ", fnt2, Brushes.White, 15, 37 * unite_hauteur - 11);
        //        graphic.DrawString(string.Format(elGR, "{0:0,0}",total) + " F CFA", fnt2, Brushes.White, 13 * unite_largeur - 20, 37 * unite_hauteur - 11);

        //        graphic.DrawString("Arrêtée la présente facture des examens à la somme de : ", fnt1, Brushes.Black, 15, 38* unite_hauteur -5);
        //        graphic.DrawString(Converti((long)total) + " Francs CFA", fnt1, Brushes.Black, unite_largeur, 39 * unite_hauteur -7);
        //        graphic.DrawString("Caissier(e)  :  ".ToUpper() + caissier.ToUpper(), fnt2, Brushes.Black, 4 * unite_largeur - 15, 41 * unite_hauteur -25);
        //        //graphic.DrawString( fnt2, Brushes.Black, 9 * unite_largeur, 37 * unite_hauteur + 20);
        ...
        //    catch { return null; }
        //}
        public static Bitmap FactureOfficiellePourBonDesActes(int numeroFacture, DataGridView dtGrid,
           Patient patient, DateTime datefacture, string caissier)
        {
            ...
            try
            {
                ...
                int unite_largeur = 32;
                int largeur_facture = 24 * unite_largeur + 0;
                int detail_hauteur_facture = 15 * unite_hauteur + 5;
                int hauteur_facture = 35 * unite_hauteur + 15;
                ...
                graphic.DrawString("Vous servir est notre devise - Bon  Retablissement ", fnt1, Brushes.Black, 12 * unite_largeur + 0, 3 * unite_hauteur + 0);
                graphic.DrawString("Date  : " + datefacture, fnt1, Brushes.Black, 17 * unite_largeur, 5 * unite_hauteur + 5);
                graphic.DrawString("BON DE SOIN N° " + DateTime.Now.Year + "/" + numeroFacture, fnt3, Brushes.Black, unite_largeur, 5 * unite_hauteur - 5);
                //graphic.DrawString("Date validation :  " + listeFacture[0].DateFacture.AddDays(15), fnt1, Brushes.Black, 9 * unite_largeur + 16, 5 * unite_hauteur + 5);
                //graphic.DrawRectangle(Pens.Black,     10, 8 * unite_hauteur, 17 * unite_largeur - 10, 5 * unite_hauteur + 10);
                //graphic.FillRectangle(Brushes.Black, 10, 8 * unite_hauteur, 17 * unite_largeur - 10, unite_hauteur);
                var patientNom = patient.Nom.ToUpper() + " " + patient.Prenom.ToUpper();
                ...
                graphic.DrawString(patientNom, fnt2, Brushes.Black, 2 * unite_largeur, 7 * unite_hauteur -10);
                graphic.DrawString("N° identifiant :  " + patient.NumeroPatient.ToString(), fnt2, Brushes.Black, 2 * unite_largeur, 8 * unite_hauteur + 3);
                graphic.DrawString("Sexe :   " + patient.Sexe, fnt1, Brushes.Black, 2 * unite_largeur, 9 * unite_hauteur + 5);
                graphic.DrawString("Age :    " + AfficherAge(patient.An, patient.Mois), fnt1, Brushes.Black, 5 * unite_largeur, 9 * unite_hauteur + 5);
                ...
                {
                    var Yloc = unite_hauteur * i + 14 * unite_hauteur - 5;
                    graphic.DrawString(dtGrid.Rows[i].Cells[1].Value.ToString().ToUpper(), fnt1, Brushes.Black, unite_largeur + 20, Yloc);
                    graphic.DrawString(dtGrid.Rows[i].Cells[3].Value.ToString(), fnt1, Brushes.Black, 14 * unite_largeur + 0, Yloc);
                    graphic.DrawString(string.Format(elGR, "{0:0,0}", Double.Parse(dtGrid.Rows[i].Cells[2].Value.ToString())), fnt1, Brushes.Black, 17 * unite_largeur, Yloc);
                    graphic.DrawString(string.Format(elGR, "{0:0,0}", Double.Parse(dtGrid.Rows[i].Cells[4].Value.ToString())), fnt1, Brushes.Black, 21 * unite_largeur - 5, Yloc);
                    total += Double.Parse(dtGrid.Rows[i].Cells[4].Value.ToString());
                }
                graphic.FillRectangle(Brushes.White, 20, 29 * unite_hauteur - 5, 25 * unite_largeur, 10 * unite_hauteur);
                if (dtGrid.Rows.Count <= 15)
                {
                  var Loc = unite_hauteur * dtGrid.Rows.Count+ 15 * unite_hauteur +5;
                    graphic.DrawLine(Pens.Black, unite_largeur, Loc-8, 24 * unite_largeur,Loc-8);
                    graphic.DrawString("Total  à payer :", fnt11, Brushes.Black, 16 * unite_largeur +2, Loc );
                    graphic.DrawString(string.Format(elGR, "{0:0,0}", total ) + " F CFA", fnt11, Brushes.Black, 20 * unite_largeur -5 , Loc);
                  
                        graphic.DrawString("Caissier(e) :  ".ToUpper() + caissier.ToUpper(), fnt11, Brushes.Black, 9 * unite_largeur + 0, 30 * unite_hauteur + 5);
        ...
        /********************************************************************/
        public static Bitmap RapportDuneEntreprise(DataGridView dtGrid, Entreprise entreprise, DateTime date, double montantTotal, decimal totalConsultation, decimal totalActes, decimal totalPharmacie, double reduction)
        {
            Bitmap bitmap;
            try
            {
                ...
                {
                    flag = true;
                    hauteur_facture = 55 * unite_hauteur+20 ;
                }
                else
                {
                    flag = false;
                    hauteur_facture = 49 * unite_hauteur + 20;
                }
                ...
                graphic.Clear(Color.White);
                    ...
                    Image logo = global::GestionDuneClinique.Properties.Resources.logo;
                    graphic.DrawImage(logo, unite_largeur,  unite_hauteur+5, 13 * unite_largeur, 3 * unite_hauteur+0);
                ...
                Font fnt2 = new Font("Arial Narrow", 14, FontStyle.Bold);
                Font fnt3 = new Font("Arial Narrow", 18, FontStyle.Bold | FontStyle.Underline);
                Font fnt22 = new Font("Arial Narrow", 10, FontStyle.Regular);

               #endregion

                 graphic.DrawString("Page 1", fnt0, Brushes.Black, 23*unite_largeur,  05);


               graphic.DrawString("FACTURE DU  " + date.ToShortDateString(), fnt3, Brushes.Black, 9* unite_largeur, 11 * unite_hauteur - 13);
               
                graphic.DrawString("Date d'émission :  " + DateTime.Now.ToShortDateString(), fnt1, Brushes.Black, 19 * unite_largeur, 5 * unite_hauteur+0);

                graphic.DrawRectangle(Pens.Black, unite_largeur - 5, 6 * unite_hauteur + 10, 24 * unite_largeur, 4 * unite_hauteur - 7);
                graphic.FillRectangle(Brushes.WhiteSmoke, unite_largeur - 4, 6 * unite_hauteur + 13, 24 * unite_largeur -2, unite_hauteur-2);
                graphic.DrawString("Information de l' entreprise  ".ToUpper(), fnt1, Brushes.Black, 2 * unite_largeur, 6 * unite_hauteur + 13);
                graphic.DrawString("Nom :", fnt1, Brushes.Black, 2 * unite_largeur, 7 * unite_hauteur + 12);
                graphic.DrawString("Tél :   ", fnt1, Brushes.Black, 2 * unite_largeur, 8 * unite_hauteur + 9);
                graphic.DrawString("Adresse :    ", fnt1, Brushes.Black, 2 * unite_largeur, 9 * unite_hauteur + 6);

                graphic.DrawString(entreprise.NomEntreprise, fnt1, Brushes.Black, 6 * unite_largeur, 7 * unite_hauteur + 12);
                graphic.DrawString(entreprise.Telephone1 + " / " + entreprise.Telephone2, fnt1, Brushes.Black, 6 * unite_largeur, 8 * unite_hauteur + 9);
                graphic.DrawString(entreprise.Adresse, fnt1, Brushes.Black, 6 * unite_largeur, 9 * unite_hauteur + 6);
                ...
                graphic.FillRectangle(Brushes.WhiteSmoke, unite_largeur - 3, 13 * unite_hauteur - 15, 24 * unite_largeur + 6, unite_hauteur);
                graphic.DrawString("Nom & Prenom  ".ToUpper(), fnt11, Brushes.Black, unite_largeur, 13 * unite_hauteur - 15);
                graphic.DrawString("Date  ".ToUpper(), fnt11, Brushes.Black, 8 * unite_largeur, 13 * unite_hauteur - 15);
                graphic.DrawString("Désignation ".ToUpper(), fnt11, Brushes.Black, 12 * unite_largeur, 13 * unite_hauteur - 15);
                graphic.DrawString("Qté ".ToUpper(), fnt11, Brushes.Black, 20 * unite_largeur+10, 13 * unite_hauteur - 15, drawFormatRight);
                graphic.DrawString("P unit ".ToUpper(), fnt11, Brushes.Black, 22 * unite_largeur + 5, 13 * unite_hauteur - 15, drawFormatRight);
                graphic.DrawString("Montant  ".ToUpper(), fnt11, Brushes.Black, 24 * unite_largeur + 10, 13 * unite_hauteur - 15, drawFormatRight);
                ...
                for (var i = 0; i < dtGrid.Rows.Count - 1; i++)
                {
                    ...
                    if (patient.ToLower().Contains("s/c"))
                    {
                      var listeEmp = ConnectionClassClinique.ListeDesEmployeesEntreprise(patient.Substring(0, patient.IndexOf("/") - 1));
                        ...
                        if (listeEmp.Count > 0)
                        {
                            if (!string.IsNullOrWhiteSpace(listeEmp[0].Matricule))
                            {
                    ...
                    else if (patient.ToUpper().Contains(" SC "))
                    {
                        
                        patient = patient.Substring(0, patient.IndexOf("SC ") ) +
                            "\n" + patient.Substring(patient.IndexOf("SC ") +1) ;
                    }
                    else
                    {
                     }
                    //if (patient.Length > 40)
                    //    patient = patient.Substring(0, 40);
                
                    if (dtGrid.Rows[i].Cells[1].Value.ToString().ToUpper().Contains("TOTAL"))
                    {
                        graphic.DrawString(dtGrid.Rows[i].Cells[6].Value.ToString(), fnt11, Brushes.Black, 24 * unite_largeur +10, Yloc, drawFormatRight);
                        graphic.DrawString(dtGrid.Rows[i].Cells[1].Value.ToString().ToUpper(), fnt11, Brushes.Black, 1 * unite_largeur, Yloc+3);
                    }
                    else if (!dtGrid.Rows[i].Cells[1].Value.ToString().ToUpper().Contains("TOTAL") && dtGrid.Rows[i].Cells[2].Value.ToString() == "")
                    {
                        graphic.FillRectangle(Brushes.WhiteSmoke, 20, Yloc, 24 * unite_largeur + 10, unite_hauteur);
                        graphic.DrawString(dtGrid.Rows[i].Cells[1].Value.ToString().ToUpper(), fnt11, Brushes.Black, 1 * unite_largeur, Yloc);
                    }
                    else
                    {
                        if (entreprise.NomEntreprise == "PCP MEMBRE FAMILLE PERSONNEL")
                        {
                            if (patient.Contains("/"))
                            {
                                graphic.FillRectangle(Brushes.WhiteSmoke, 20, Yloc, 24 * unite_largeur + 10, unite_hauteur);
                        ...
                        {
                            graphic.DrawString(dtGrid.Rows[i].Cells[3].Value.ToString().Substring(0, 35).ToUpper() + "...",
                        ...
                        graphic.DrawString(dtGrid.Rows[i].Cells[6].Value.ToString(), fnt1, Brushes.Black, 24 * unite_largeur + 10, Yloc, drawFormatRight);
                    }
                    graphic.DrawString(dtGrid.Rows[i].Cells[4].Value.ToString(), fnt1, Brushes.Black, 20 * unite_largeur+10, Yloc, drawFormatRight);
                    graphic.DrawString(dtGrid.Rows[i].Cells[5].Value.ToString(), fnt1, Brushes.Black, 22 * unite_largeur + 5, Yloc, drawFormatRight);
                }
                ...
                if (flag == true)
                {
                    if (reduction <= 0)
                    {
                        graphic.FillRectangle(Brushes.WhiteSmoke, 20, Kloc, 24 * unite_largeur + 10, unite_hauteur + 8);
                        //graphic.DrawString("Total ", fnt2, Brushes.Black, unite_largeur, Kloc);
                        //graphic.DrawString( string.Format(elGR, "{0:0,0}",  montantTotal) + " F CFA", fnt2, Brushes.Black, 17 * unite_largeur, Kloc);
                        //graphic.DrawString("Arrêtée la présente facture à la somme de : ", fnt1, Brushes.Black, 20, Kloc + 2 * unite_hauteur);
                        //graphic.DrawString(Converti((long)montantTotal) + " Francs CFA", fnt1, Brushes.Black, 9 * unite_largeur-10, Kloc + 2 * unite_hauteur);
                        if (reduction <= 0)
                        {
                            graphic.FillRectangle(Brushes.WhiteSmoke, 20, Kloc, 24 * unite_largeur + 10, unite_hauteur + 8);
                            graphic.DrawString("Total  :  " + string.Format(elGR, "{0:0,0}", montantTotal), fnt11, Brushes.Black, 1 * unite_largeur + 5, Kloc);
                            graphic.DrawString("Total Consultation :    " + string.Format(elGR, "{0:0,0}", totalConsultation), fnt11, Brushes.Black, 6 * unite_largeur - 10, Kloc);
                            graphic.DrawString("Total acte  :    " + string.Format(elGR, "{0:0,0}", totalActes), fnt11, Brushes.Black, 13 * unite_largeur - 20, Kloc);
                            graphic.DrawString("Total pharmacie   :  " + string.Format(elGR, "{0:0,0}", totalPharmacie), fnt11, Brushes.Black, 18 * unite_largeur - 20, Kloc);

                            graphic.DrawString("Arrêtée la présente facture à la somme de :  " + Converti((long)montantTotal) + " Francs CFA", fnt1, Brushes.Black, 1 * unite_largeur, Kloc + 2 * unite_hauteur);
                        ...
                        else
                        {
                            ...
                            graphic.FillRectangle(Brushes.WhiteSmoke, 20, Kloc, 24 * unite_largeur + 10, unite_hauteur + 8);
                            graphic.DrawString("Total  :  " + montantTotal + "F CFA", fnt11, Brushes.White, unite_largeur, Kloc);
                            graphic.DrawString("Total réduction :  " + reduction.ToString() + " F CFA", fnt11, Brushes.White, 9 * unite_largeur, Kloc);
                            graphic.DrawString("Net Total :  " + montant.ToString() + " F CFA", fnt11, Brushes.White, 18 * unite_largeur, Kloc);
                            graphic.DrawString("Arrêtée la présente facture à la somme de :  "+Converti((long)montant) + " Francs CFA", fnt1, Brushes.Black, 1 * unite_largeur, Kloc + 2 * unite_hauteur);
                    ...
                    else
                    {
                        var montant = montantTotal - reduction;
                        graphic.FillRectangle(Brushes.WhiteSmoke, 20, Kloc, 24 * unite_largeur + 10, unite_hauteur + 8);
                        graphic.DrawString("Total  :  " + string.Format(elGR, "{0:0,0}", montantTotal) + "F CFA", fnt11, Brushes.Black, unite_largeur, Kloc);
                        graphic.DrawString("Total réduction :  " + string.Format(elGR, "{0:0,0}", reduction) + " F CFA", fnt11, Brushes.Black, 10 * unite_largeur, Kloc);
                        graphic.DrawString("Net Total :  " + string.Format(elGR, "{0:0,0}", montant) + " F CFA", fnt11, Brushes.Black, 19 * unite_largeur, Kloc);
                        graphic.DrawString("Arrêtée la présente facture à la somme de : "+Converti((long)montant),  fnt1, Brushes.Black, 1 * unite_largeur , Kloc + 2 * unite_hauteur);
        ...
        public static Bitmap RapportDuneEntrepriseParPage(DataGridView dtGrid, Entreprise entreprise, DateTime date, double montantTotal,
             decimal totalConsultation, decimal totalActes, decimal totalPharmacie, double reduction, int start)
        {
            Bitmap bitmap;
            try
            {
                ...
                {
                    hauteur_facture = 47 * unite_hauteur + 20;
                    flag = false;
                }
                ...
                graphic.FillRectangle(Brushes.WhiteSmoke, unite_largeur - 3, 2 * unite_hauteur - 10, 24 * unite_largeur + 6, unite_hauteur);
                graphic.DrawString("Nom & Prenom  ".ToUpper(), fnt11, Brushes.Black, unite_largeur, 2 * unite_hauteur - 10);
                graphic.DrawString("Date  ".ToUpper(), fnt11, Brushes.Black, 8 * unite_largeur, 2 * unite_hauteur - 10);
                graphic.DrawString("Désignation ".ToUpper(), fnt11, Brushes.Black, 11 * unite_largeur, 2 * unite_hauteur - 10);
                graphic.DrawString("Qté ".ToUpper(), fnt11, Brushes.Black, 20 * unite_largeur + 10, 2 * unite_hauteur - 10, drawFormatRight);
                graphic.DrawString("P unit ".ToUpper(), fnt11, Brushes.Black, 22 * unite_largeur + 5, 2 * unite_hauteur - 10, drawFormatRight);
                graphic.DrawString("Montant  ".ToUpper(), fnt11, Brushes.Black, 24 * unite_largeur + 10, 2 * unite_hauteur - 10, drawFormatRight);
                ...
                for (var i = 36 + start * 45; i < dtGrid.Rows.Count - 1; i++)
                {
                    ...
                    else
                    {
                        ...
                        graphic.DrawString(patient, fnt0, Brushes.Black, unite_largeur - 0, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[2].Value.ToString(), fnt1, Brushes.Black, 8 * unite_largeur, Yloc);
                        if (dtGrid.Rows[i].Cells[3].Value.ToString().Length > 35)
                        {
                            graphic.DrawString(dtGrid.Rows[i].Cells[3].Value.ToString().Substring(0, 35).ToUpper() + "...",
        ...
        public static Bitmap RapportDuneEntrepriseAvecCharge(DataGridView dtGrid, Entreprise entreprise, DateTime date, double montantTotal,double charge)
        {
            ...
            try
            {
               ...
               if(dtGrid.Rows.Count<=13)
               {
                ...
                {
                    Image logo = global::GestionDuneClinique.Properties.Resources.logo;
                    graphic.DrawImage(logo, unite_largeur,  10, 14* unite_largeur, 4* unite_hauteur);
                ...
                Font fnt2 = new Font("Century Gothic", 13, FontStyle.Bold);
                Font fnt3 = new Font("Century Gothic", 17, FontStyle.Bold | FontStyle.Underline);
                Font fnt22 = new Font("Century Gothic", 11, FontStyle.Regular);
                 #endregion

                graphic.DrawString("Page 1", fnt0, Brushes.Black, 32 * unite_largeur,  2);

                //graphic.FillRectangle(Brushes.Black, unite_largeur - 5, 5 * unite_hauteur, 34 * unite_largeur, 2 * unite_hauteur);

                graphic.DrawString("FACTURE DU  " + date.ToShortDateString(), fnt3, Brushes.Black, 10 * unite_largeur, 10 * unite_hauteur - 10);
                //graphic.DrawLine(Pens.Black, 8 * unite_largeur, 18 * unite_hauteur - 10, 17 * unite_largeur, 18 * unite_hauteur - 10);
                graphic.DrawString("Date d'émission :  " + DateTime.Now.ToShortDateString(), fnt1, Brushes.Black, 28 * unite_largeur, 4 * unite_hauteur);

                //graphic.FillRectangle(Brushes.Black, unite_largeur - 5, 5 * unite_hauteur + 13, 34 * unite_largeur + 1, unite_hauteur);
                graphic.DrawRectangle(Pens.Black, unite_largeur - 5, 5 * unite_hauteur + 13, 34 * unite_largeur + 1,4* unite_hauteur-8);
                graphic.DrawString("Information de l' entreprise  ".ToUpper(), fnt1, Brushes.Black, 4 * unite_largeur, 5 * unite_hauteur + 13);
                graphic.DrawString("Nom :", fnt1, Brushes.Black, 4 * unite_largeur, 6 * unite_hauteur + 12);
                graphic.DrawString("Tél :   ", fnt1, Brushes.Black, 4 * unite_largeur, 7 * unite_hauteur + 9);
                graphic.DrawString("Adresse :    ", fnt1, Brushes.Black, 4 * unite_largeur, 8 * unite_hauteur + 6);

                graphic.DrawString(entreprise.NomEntreprise, fnt1, Brushes.Black, 8 * unite_largeur, 6 * unite_hauteur + 12);
                graphic.DrawString(entreprise.Telephone1 + " / " + entreprise.Telephone2, fnt1, Brushes.Black, 8 * unite_largeur, 7 * unite_hauteur + 9);
                graphic.DrawString(entreprise.Adresse, fnt1, Brushes.Black, 8 * unite_largeur, 8 * unite_hauteur + 6);

                //graphic.FillRectangle(Brushes.Black, unite_largeur - 3, 12 * unite_hauteur - 15, 34 * unite_largeur +0, 2 * unite_hauteur);
                graphic.DrawString("Nom & Prenom  ".ToUpper(), fnt33, Brushes.Black, unite_largeur, 12 * unite_hauteur - 15);
                graphic.DrawString("Date".ToUpper(), fnt33, Brushes.Black, 9 * unite_largeur, 12 * unite_hauteur - 15);
                graphic.DrawString("Désignation ".ToUpper(), fnt33, Brushes.Black, 12 * unite_largeur, 12 * unite_hauteur - 15);
                graphic.DrawString("Qté  ".ToUpper(), fnt33, Brushes.Black, 23 * unite_largeur, 12 * unite_hauteur - 15);
                graphic.DrawString("P unit ".ToUpper(), fnt33, Brushes.Black, 24 * unite_largeur + 10, 12 * unite_hauteur - 15);
                graphic.DrawString("Montant  ".ToUpper(), fnt33, Brushes.Black, 26 * unite_largeur, 12 * unite_hauteur - 15);
                graphic.DrawString("Charge \nAssuré - ".ToUpper() + charge + "%", fnt33, Brushes.Black, 29 * unite_largeur - 2, 12 * unite_hauteur - 15);
                var chargeAssureur = 100- charge;
                graphic.DrawString("Charge As\nsureur - ".ToUpper() + chargeAssureur.ToString() + "%", fnt33, Brushes.Black, 32 * unite_largeur - 5, 12 * unite_hauteur - 15);

                for (var i = 0; i <= dtGrid.Rows.Count - 1; i++)
                {

                    var Yloc = unite_hauteur * i + 14 * unite_hauteur; if (i % 2 == 1)
                        if (i % 2 == 1)
                            graphic.FillRectangle(Brushes.WhiteSmoke, unite_largeur - 3, Yloc, 34 * unite_largeur + 0, unite_hauteur);
                    ...
                    if (dtGrid.Rows[i].Cells[2].Value.ToString().Contains("TOTAL") && string.IsNullOrEmpty(dtGrid.Rows[i].Cells[3].Value.ToString()))
                    {
                        graphic.FillRectangle(Brushes.WhiteSmoke, unite_largeur - 3, Yloc, 34 * unite_largeur + 0, unite_hauteur);
                        graphic.DrawString(patient, fnt0, Brushes.Black, unite_largeur, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[1].Value.ToString(), fnt11, Brushes.Black, 9 * unite_largeur, Yloc);

                        if (dtGrid.Rows[i].Cells[2].Value.ToString().Length > 35)
                        {
                            graphic.DrawString(dtGrid.Rows[i].Cells[2].Value.ToString().Substring(0, 35).ToUpper(),
                        ...
                        graphic.DrawString(dtGrid.Rows[i].Cells[3].Value.ToString(), fnt11, Brushes.Black, 23 * unite_largeur +5, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[4].Value.ToString(), fnt11, Brushes.Black, 24 * unite_largeur+10, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[5].Value.ToString(), fnt11, Brushes.Black, 26 * unite_largeur+20, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[6].Value.ToString(), fnt11, Brushes.Black, 29 * unite_largeur+10, Yloc);
                    ...
                    else
                    {
                        ...
                        graphic.DrawString(dtGrid.Rows[i].Cells[3].Value.ToString(), fnt1, Brushes.Black, 23 * unite_largeur + 5, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[4].Value.ToString(), fnt1, Brushes.Black, 24 * unite_largeur+10, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[5].Value.ToString(), fnt1, Brushes.Black, 26 * unite_largeur+20, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[6].Value.ToString(), fnt1, Brushes.Black, 29 * unite_largeur+10, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[7].Value.ToString(), fnt1, Brushes.Black, 32 * unite_largeur, Yloc);
                    }
                }

                var Kloc = 15 * unite_hauteur+ unite_hauteur* dtGrid.Rows.Count;
                graphic.FillRectangle(Brushes.White, 20, 27*unite_hauteur, 36 * unite_largeur + 10, unite_hauteur * 10);
                if (dtGrid.Rows.Count<=13)
                {
                    graphic.DrawLine(Pens.Black, 20, Kloc-15, 34 * unite_largeur + 10, Kloc-15);
                    //graphic.DrawString("Arrêtée la présente facture à la somme de : ", fnt1, Brushes.Black, 20, Kloc + 2 * unite_hauteur);
                    //graphic.DrawString(Converti((long)montantTotal) + " Francs CFA", fnt1, Brushes.Black, 9 * unite_largeur + 15, Kloc + 2 * unite_hauteur);
                    graphic.DrawString("Le Service Administratif et Financier".ToUpper(), fnt1, Brushes.Black, 14 * unite_largeur, Kloc + 0 * unite_hauteur + 7);
                    graphic.DrawString(GestionAcademique.LoginFrm.nom.ToUpper(), fnt1, Brushes.Black, 14 * unite_largeur, Kloc +7* unite_hauteur + 5);
        ...
        public static Bitmap RapportDuneEntrepriseParPageAvecCharge(DataGridView dtGrid, double montantTotal, int start,double charge)
        {
            ...
            try
            {
                ...
                int hauteur_facture  = 33 * unite_hauteur;
                bool flag = false;
                if (dtGrid.Rows.Count <= 13 + 25 * (1 + start))
                {
                    //hauteur_facture = 23 * unite_hauteur;
                    flag = true;
                }
                else
                {
                    //hauteur_facture = 20 * unite_hauteur;
                    flag = false;
                }
                //creer un bit map
                bitmap = new Bitmap(largeur_facture, hauteur_facture, System.Drawing.Imaging.PixelFormat.Format24bppRgb);
                ...
                //definir les polices 
                Font fnt1 = new Font("Century Gothic", 10, FontStyle.Regular);
                Font fnt33 = new Font("Century Gothic", 9, FontStyle.Bold);
                Font fnt0 = new Font("Century Gothic", 11, FontStyle.Regular);
                Font fnt11 = new Font("Century Gothic", 10, FontStyle.Bold);
                Font fnt2 = new Font("Century Gothic", 13, FontStyle.Bold);
                Font fnt3 = new Font("Century Gothic", 17, FontStyle.Bold);
                Font fnt22 = new Font("Century Gothic", 10, FontStyle.Regular);

                #endregion

                var page = start +1;
                graphic.DrawString("Page "+page, fnt0, Brushes.Black, 32 * unite_largeur, 5);

                //graphic.FillRectangle(Brushes.Black, unite_largeur - 3, unite_hauteur + 10, 34 * unite_largeur + 8, 2 * unite_hauteur - 15);

                //graphic.FillRectangle(Brushes.Black, unite_largeur - 3, 19 * unite_hauteur - 15, 34 * unite_largeur + 0, 2 * unite_hauteur);
                graphic.DrawString("Nom & Prenom  ".ToUpper(), fnt33, Brushes.Black, unite_largeur, unite_hauteur + 10);
                graphic.DrawString("Date".ToUpper(), fnt33, Brushes.Black, 9 * unite_largeur, unite_hauteur + 10);
                graphic.DrawString("Désignation ".ToUpper(), fnt33, Brushes.Black, 12 * unite_largeur, unite_hauteur + 10);
                graphic.DrawString("Qté  ".ToUpper(), fnt33, Brushes.Black, 23 * unite_largeur, unite_hauteur + 10);
                graphic.DrawString("P unit ".ToUpper(), fnt33, Brushes.Black, 24 * unite_largeur + 10, unite_hauteur + 10);
                graphic.DrawString("Montant  ".ToUpper(), fnt33, Brushes.Black, 26 * unite_largeur, unite_hauteur + 10);
                graphic.DrawString("Charge \nAssuré - ".ToUpper() + charge + "%", fnt33, Brushes.Black, 29 * unite_largeur - 5, unite_hauteur + 10);
                var chargeAssureur = 100 - charge;
                graphic.DrawString("Charge As\nsureur - ".ToUpper() + chargeAssureur.ToString() + "%", fnt33, Brushes.Black, 32 * unite_largeur - 7, unite_hauteur + 10);

                var j = 0;
                for (var i = 13 + start * 25; i <= dtGrid.Rows.Count - 1; i++)
                {
                   
                    var Yloc = unite_hauteur * j + 3 * unite_hauteur+0;
                    if (i % 2 == 1)
                        graphic.FillRectangle(Brushes.WhiteSmoke, unite_largeur - 3, Yloc, 34 * unite_largeur + 0, unite_hauteur);
                    var patient = dtGrid.Rows[i].Cells[0].Value.ToString().ToUpper();
                    if (patient.ToLower().Contains("s/c"))
                ...
                graphic.FillRectangle(Brushes.White, 20, 28 * unite_hauteur+0, 36 * unite_largeur + 10, unite_hauteur * 10);

                var Kloc = 23 * unite_hauteur+1;
                if (flag == true)
                {
                    //graphic.DrawLine(Pens.Black, 20, Kloc, 34 * unite_largeur + 10, Kloc);
         
                    graphic.DrawString("Le Service Administratif et Financier".ToUpper(), fnt1, Brushes.Black, 14 * unite_largeur, Kloc + 0 * unite_hauteur + 7);
                    graphic.DrawString(GestionAcademique.LoginFrm.nom.ToUpper(), fnt1, Brushes.Black, 14 * unite_largeur, Kloc + 8 * unite_hauteur + 5);
        ...
        //fonction pour dessiner le recu de la facture consultation
        public static Bitmap FactureEmployeDuneEntreprise(string titre, Patient patient, string entreprise, decimal montantTotal,
             decimal totalConsultation, decimal totalActes, decimal totalPharmacie, string caissier, DataGridView dtGrid, int index)
        {
            Bitmap bitmap = null;
            try
            {
                ...
                int hauteur_facture;
                var flag = false;
                if (dtGrid.Rows.Count <= (1+index)*28)
                {
                ...
                Font fnt3 = new Font("Ubuntu", 20, FontStyle.Bold | FontStyle.Underline);
                Font fnt22 = new Font("Ubuntu", 10.5f, FontStyle.Bold);
                Font fnt0 = new Font("Ubuntu", 11, FontStyle.Bold | FontStyle.Underline);

                try
                {
                    Image logo = global::GestionDuneClinique.Properties.Resources.logo;
                    graphic.DrawImage(logo, unite_largeur, 2 * unite_hauteur, 13 * unite_largeur, 5 * unite_hauteur);
                ...
                graphic.DrawString(titre, fnt3, Brushes.Black, unite_largeur,7 * unite_hauteur);
                graphic.DrawString("Date d'émission :  " + DateTime.Now.ToString(), fnt1, Brushes.Black, 15*unite_largeur-0, 7 * unite_hauteur+2);


                graphic.FillRectangle(Brushes.Black, unite_largeur - 5, 9 * unite_hauteur, 23 * unite_largeur + 2, unite_hauteur);
                graphic.DrawRectangle(Pens.Black, unite_largeur - 5, 10 * unite_hauteur - 3, 23 * unite_largeur, 4 * unite_hauteur+5);
                graphic.DrawString("Informations du patient  ", fnt1, Brushes.White, 6 * unite_largeur, 9 * unite_hauteur);
                graphic.DrawString(string.Format("{0,-25} {1,-80}", "Identifiant : ", patient.NumeroPatient.ToString()), fnt22, Brushes.Black, 5 * unite_largeur, 10 * unite_hauteur);
                graphic.DrawString(string.Format("{0,-25} {1,-80}", "Patient :      ", patient.Nom + " " + patient.Prenom), fnt1, Brushes.Black, 5 * unite_largeur, 11 * unite_hauteur);
                graphic.DrawString(string.Format("{0,-25} {1,-80}", "Sexe :          ", patient.Sexe + "     " + "Age :    ", AfficherAge(patient.An, patient.Mois)), fnt1, Brushes.Black, 5 * unite_largeur, 12 * unite_hauteur - 1);
                graphic.DrawString(string.Format("{0,-25} {1,-80}", "Convention  :          ",entreprise), fnt1, Brushes.Black, 5 * unite_largeur, 13 * unite_hauteur - 2);

                graphic.FillRectangle(Brushes.Black, unite_largeur - 5, 15 * unite_hauteur, 23 * unite_largeur, unite_hauteur);
                graphic.DrawString("Date", fnt22, Brushes.White, unite_largeur, 15 * unite_hauteur);
                graphic.DrawString("Libellé  ", fnt22, Brushes.White, 4 * unite_largeur, 15 * unite_hauteur);
                graphic.DrawString("Qté  ", fnt22, Brushes.White, 18 * unite_largeur - 15, 15 * unite_hauteur);
                graphic.DrawString("P unit  ", fnt22, Brushes.White, 19 * unite_largeur, 15 * unite_hauteur);
                graphic.DrawString("P Total  ", fnt22, Brushes.White, 22 * unite_largeur-5, 15 * unite_hauteur);

                var j = 0;
                for (var i = 30 * index; i <= dtGrid.Rows.Count - 1; i++)
                {

                    var Yloc = unite_hauteur * j + 16 * unite_hauteur+10;
                ...
                #endregion
                graphic.FillRectangle(Brushes.White, unite_largeur - 5, 44 * unite_hauteur +10, 24 * unite_largeur, 5*unite_hauteur);
                if (flag == true)
                {
                    graphic.FillRectangle(Brushes.Black, unite_largeur - 5, 49 * unite_hauteur - 10, 24 * unite_largeur, unite_hauteur+2);
                    graphic.DrawString("Total  :  " + string.Format(elGR, "{0:0,0}", montantTotal), fnt22, Brushes.White, 1 * unite_largeur + 10, 49 * unite_hauteur - 10);
                    graphic.DrawString("Total Consultation : " + string.Format(elGR, "{0:0,0}", totalConsultation), fnt22, Brushes.White, 6 * unite_largeur - 5, 49 * unite_hauteur - 10);
                    graphic.DrawString("Total acte  :  " + string.Format(elGR, "{0:0,0}", totalActes), fnt22, Brushes.White, 13 * unite_largeur - 20, 49 * unite_hauteur - 10);
                    graphic.DrawString("Total pharmacie   :  " + string.Format(elGR, "{0:0,0}", totalPharmacie), fnt22, Brushes.White, 18 * unite_largeur - 20, 49 * unite_hauteur - 10);
                    graphic.DrawString("Arrêtée la présente facture à la somme de : " + Converti((long)montantTotal) + " Francs CFA", fnt11, Brushes.Black, unite_largeur, 50 * unite_hauteur);

                    graphic.DrawLine(Pens.Black, 10 * unite_largeur-23, 51 * unite_hauteur, 24 * unite_largeur + 25, 51 * unite_hauteur);
                    graphic.DrawString("Le Service Administratif et Financier".ToUpper(), fnt0, Brushes.Black, 7 * unite_largeur, 52 * unite_hauteur -5);
                    //graphic.DrawString(caissier.ToUpper(), fnt0, Brushes.Black, 9 * unite_largeur, 53 * unite_hauteur);
        ...
        public static Bitmap FactureDependantsEmployeDuneEntreprise(string titre, Patient patient, string entreprise, decimal montantTotal,
            decimal totalConsultation, decimal totalActes, decimal totalPharmacie, string caissier, DataGridView dtGrid, int index)
        {
            Bitmap bitmap = null;
            try
            {
                ...
                Font fnt3 = new Font("Ubuntu", 20, FontStyle.Bold | FontStyle.Underline);
                Font fnt22 = new Font("Ubuntu", 10.5f, FontStyle.Bold);
                Font fnt0 = new Font("Ubuntu", 12, FontStyle.Bold | FontStyle.Underline);
                ...
                graphic.DrawRectangle(Pens.Black, unite_largeur - 5, 10 * unite_hauteur - 3, 23 * unite_largeur, 4 * unite_hauteur + 5);
                graphic.DrawString("Informations du patient  ", fnt1, Brushes.White, 6 * unite_largeur, 9 * unite_hauteur);
                graphic.DrawString(string.Format("{0,-25} {1,-80}", "Identifiant : ", patient.NumeroPatient.ToString()), fnt22, Brushes.Black, 8 * unite_largeur, 10 * unite_hauteur);
                graphic.DrawString(string.Format("{0,-25} {1,-80}", "Patient :      ", patient.Nom + " " + patient.Prenom), fnt1, Brushes.Black, 8 * unite_largeur, 11 * unite_hauteur);
                graphic.DrawString(string.Format("{0,-25} {1,-80}", "Sexe :          ", patient.Sexe + "     " + "Age :    ", AfficherAge(patient.An, patient.Mois)), fnt1, Brushes.Black, 8 * unite_largeur, 12 * unite_hauteur - 1);
                graphic.DrawString(string.Format("{0,-25} {1,-80}", "Convention  :          ", entreprise), fnt1, Brushes.Black, 8 * unite_largeur, 13 * unite_hauteur - 2);

                graphic.FillRectangle(Brushes.Black, unite_largeur - 5, 15 * unite_hauteur, 23 * unite_largeur, unite_hauteur);
                graphic.DrawString("Nom & Prénom", fnt22, Brushes.White, unite_largeur, 15 * unite_hauteur);
                graphic.DrawString("Date", fnt22, Brushes.White, 7*unite_largeur+10, 15 * unite_hauteur);
                graphic.DrawString("Libellé  ", fnt22, Brushes.White, 10 * unite_largeur, 15 * unite_hauteur);
                graphic.DrawString("Qté  ", fnt22, Brushes.White, 19 * unite_largeur , 15 * unite_hauteur);
                graphic.DrawString("P unit  ", fnt22, Brushes.White, 20 * unite_largeur+5, 15 * unite_hauteur);
                ...
                for (var i = 30 * index; i <= dtGrid.Rows.Count - 1; i++)
                {
                    ...
                    var Yloc = unite_hauteur * j + 16 * unite_hauteur + 10;
                    if (dtGrid.Rows[i].Cells[3].Value.ToString() == "SOUS TOTAL")
                    {
                        graphic.DrawString(dtGrid.Rows[i].Cells[3].Value.ToString().ToUpper(), fnt22,
                            Brushes.Black, 10 * unite_largeur, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[2].Value.ToString(), fnt22, Brushes.Black, unite_largeur, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[4].Value.ToString(), fnt22, Brushes.Black, 19 * unite_largeur - 10, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[5].Value.ToString(), fnt22, Brushes.Black, 20 * unite_largeur - 10, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[6].Value.ToString(), fnt22, Brushes.Black, 22 * unite_largeur - 10, Yloc);
                    }
                    else
                    {
                        if ( ! string.IsNullOrEmpty(dtGrid.Rows[i].Cells[1].Value.ToString().ToUpper() ))
                        {
                            graphic.DrawString(dtGrid.Rows[i].Cells[1].Value.ToString().ToUpper() + " ( " + dtGrid.Rows[i].Cells[0].Value.ToString().ToUpper() + ")", fnt1, Brushes.Black, 1 * unite_largeur, Yloc);
                        }
                        graphic.DrawString(dtGrid.Rows[i].Cells[2].Value.ToString(), fnt1, Brushes.Black, 7 * unite_largeur + 10, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[3].Value.ToString().ToUpper(), fnt1, Brushes.Black, 10* unite_largeur, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[4].Value.ToString(), fnt1, Brushes.Black, 19 * unite_largeur -0, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[5].Value.ToString(), fnt1, Brushes.Black, 20 * unite_largeur - 10, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[6].Value.ToString(), fnt1, Brushes.Black, 22 * unite_largeur - 5, Yloc);
                    }
                    j++;
                }
                ...
                {
                    graphic.FillRectangle(Brushes.Black, unite_largeur - 5, 49 * unite_hauteur - 10, 24 * unite_largeur, unite_hauteur + 2);
                    graphic.DrawString("Total  :  " + string.Format(elGR, "{0:0,0}", montantTotal), fnt22, Brushes.White, 1 * unite_largeur +5, 49 * unite_hauteur - 10);
                    graphic.DrawString("Total Consultation :    " + string.Format(elGR, "{0:0,0}", totalConsultation), fnt22, Brushes.White, 6 * unite_largeur - 10, 49 * unite_hauteur - 10);
                    graphic.DrawString("Total acte  :    " + string.Format(elGR, "{0:0,0}", totalActes), fnt22, Brushes.White, 13 * unite_largeur - 20, 49 * unite_hauteur - 10);
                    graphic.DrawString("Total pharmacie   :  " + string.Format(elGR, "{0:0,0}", totalPharmacie), fnt22, Brushes.White, 18 * unite_largeur - 20, 49 * unite_hauteur - 10);
                    graphic.DrawString("Arrêtée la présente facture à la somme de : " + Converti((long)montantTotal) + " Francs CFA", fnt11, Brushes.Black, unite_largeur, 50 * unite_hauteur);
        ...
        public static Bitmap RapportPatient(string titre,Patient patient, DateTime date1, DateTime date2)
        {
            ...
            try
            {
                ...
                Font fnt2 = new Font("Bodoni MT", 12, FontStyle.Bold);
               ...
               graphic.DrawString(titre, fnt3, Brushes.Black, unite_largeur,6 * unite_hauteur);
                ...
                graphic.FillRectangle(Brushes.SteelBlue, unite_largeur - 5, 9 * unite_hauteur, 23 * unite_largeur , unite_hauteur);
                graphic.FillRectangle(Brushes.WhiteSmoke, unite_largeur - 5, 10 * unite_hauteur - 3, 23 * unite_largeur, 4 * unite_hauteur - 3);
                graphic.DrawString("Informations du patient  ", fnt2, Brushes.White, 6 * unite_largeur, 9 * unite_hauteur);
                ...
                graphic.FillRectangle(Brushes.SteelBlue, unite_largeur - 5, 15 * unite_hauteur, 23 * unite_largeur, unite_hauteur);
                graphic.DrawString("Date", fnt1, Brushes.White, unite_largeur, 15 * unite_hauteur);
                graphic.DrawString("Libellé  ", fnt1, Brushes.White, 4 * unite_largeur, 15 * unite_hauteur);
                graphic.DrawString("Qté  ", fnt1, Brushes.White, 16 * unite_largeur+ 20, 15 * unite_hauteur);
                graphic.DrawString("P unit  ", fnt1, Brushes.White, 18 * unite_largeur+18, 1* unite_hauteur);
                graphic.DrawString("P Total  ", fnt1, Brushes.White, 21 * unite_largeur+18, 15 * unite_hauteur);
                ...
                graphic.FillRectangle(Brushes.SteelBlue, unite_largeur - 5, 49 * unite_hauteur - 10, 23* unite_largeur, unite_hauteur);
                graphic.DrawString("Total     " + montantTotal.ToString(), fnt2, Brushes.White,  unite_largeur *2, 49 * unite_hauteur - 10);
                graphic.DrawString("Arrêtée la présente facture des soins à la somme de : ", fnt11, Brushes.Black, unite_largeur, 50 * unite_hauteur);

                graphic.DrawLine(Pens.SteelBlue, 11 * unite_largeur -8, 51 * unite_hauteur - 5, 24* unite_largeur , 51 * unite_hauteur - 5);
                graphic.DrawString(Converti((long)montantTotal) + " Francs CFA", fnt11, Brushes.Black,11* unite_largeur-5, 50* unite_hauteur);
        ...
        public static Bitmap RapportDesAnalysesDunMedecin(DataGridView dtGrid,
               GestionPharmacetique.AppCode.Employe employe, string titreRapport, int start,bool state)
        {
            try
            {
            #region facture1
            ...
            bool flag;
            if (dtGrid.Rows.Count <= 37 * (1 + start))
            {
                flag = true;
            }
            else
            ...
            {
                Image logo = global::GestionDuneClinique.Properties.Resources.logo;
                graphic.DrawImage(logo,  unite_largeur,  unite_hauteur, 12*unite_largeur, 4*unite_hauteur);
            }
            catch { }
            //definir les polices   
            Font fnt1 = new Font("Arial Narrow", 11, FontStyle.Regular); Font fnt2 = new Font("Arial Narrow", 11, FontStyle.Bold);
            Font fnt11 = new Font("Arial Narrow", 8, FontStyle.Regular);
            Font fnt3 = new Font("Arial Narrow", 11, FontStyle.Bold);
            #endregion

            graphic.DrawString(DateTime.Now.ToString(), fnt1, Brushes.Black, 19*unite_largeur+5, 10 * unite_hauteur + 10);
            graphic.DrawString("Page " + (start + 1).ToString(), fnt11, Brushes.Black, 32 * unite_largeur, 15);

            graphic.FillRectangle(Brushes.SteelBlue, unite_largeur - 5, 7 * unite_hauteur, 23* unite_largeur, unite_hauteur);
            graphic.FillRectangle(Brushes.Lavender, unite_largeur - 5, 8 * unite_hauteur - 3, 23 * unite_largeur, 2* unite_hauteur - 3);

            graphic.DrawString("Nom du prescripteur", fnt2, Brushes.White, 9 * unite_largeur, 7 * unite_hauteur);
            try
            {
                graphic.DrawString(employe.NomEmployee , fnt1, Brushes.Black, 4 * unite_largeur, 9 * unite_hauteur-15);

            }
            catch (Exception)
            {
            }
            graphic.DrawString(titreRapport, fnt3, Brushes.Black, unite_largeur, 10 * unite_hauteur + 10);
            graphic.FillRectangle(Brushes.SteelBlue, unite_largeur - 5, 12* unite_hauteur-1, 23 * unite_largeur , unite_hauteur);

            if (state)
            {
                graphic.DrawString("DESCRIPTION ".ToUpper(), fnt2, Brushes.White, unite_largeur, 12 * unite_hauteur);
                graphic.DrawString("NBRE  ", fnt2, Brushes.White, 15 * unite_largeur + 10, 12 * unite_hauteur);
                graphic.DrawString("FRAIS  ", fnt2, Brushes.White, 17 * unite_largeur + 0, 12 * unite_hauteur);
                graphic.DrawString("TOTAL ", fnt2, Brushes.White, 19 * unite_largeur + 0, 12 * unite_hauteur);
                graphic.DrawString("PART MED ", fnt2, Brushes.White, 21 * unite_largeur + 8, 12 * unite_hauteur);
            }
            else
            {
                graphic.DrawString("DESCRIPTION".ToUpper(), fnt2, Brushes.White, unite_largeur, 12 * unite_hauteur);
                graphic.DrawString("NBRE  ", fnt2, Brushes.White, 21 * unite_largeur+5, 12 * unite_hauteur);
            }
            var total = 0.0;
            var partDocteur = 0.0;
            var j = 0;
           
            for (var i = start * 37; i <= dtGrid.Rows.Count - 1; i++)
            {
                var Yloc = unite_hauteur * j + 13 * unite_hauteur ;
                ...
                if (state)
                {
                    ...
                    if (dtGrid.Rows[i].DefaultCellStyle.BackColor == Color.Yellow)
                    {
                        ...
                        graphic.DrawString(dtGrid.Rows[i].Cells[0].Value.ToString(), fnt3, Brushes.White, unite_largeur, Yloc);
                    }
                    //else if (dtGrid.Rows[i].DefaultCellStyle.BackColor == Color.GreenYellow)
                    //{
                    //    graphic.FillRectangle(Brushes.Lavender, unite_largeur - 5, Yloc, 11 * unite_largeur + 15, unite_hauteur - 2);
                    //    graphic.DrawString(dtGrid.Rows[i].Cells[0].Value.ToString(), fnt3, Brushes.White, unite_largeur, Yloc);
                    //}
                    ...
                    else if (dtGrid.Rows[i].Cells[0].Value.ToString() == "SOUS TOTAL ")
                    {
                        graphic.DrawString(dtGrid.Rows[i].Cells[0].Value.ToString(), fnt2, Brushes.Black, unite_largeur, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[3].Value.ToString(), fnt2, Brushes.Black, 19 * unite_largeur + 5, Yloc);
                    }
                    else
                    {
                        graphic.FillRectangle(Brushes.WhiteSmoke, unite_largeur - 5, Yloc, 23 * unite_largeur + 2, unite_hauteur-2 );
                        graphic.DrawString(dtGrid.Rows[i].Cells[0].Value.ToString(), fnt1, Brushes.Black, unite_largeur, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[1].Value.ToString(), fnt1, Brushes.Black, 15 * unite_largeur + 20, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[2].Value.ToString(), fnt1, Brushes.Black, 17* unite_largeur+10, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[3].Value.ToString(), fnt1, Brushes.Black, 19 * unite_largeur + 5, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[5].Value.ToString(), fnt1, Brushes.Black, 21 * unite_largeur+20, Yloc);
                        if (double.TryParse(dtGrid.Rows[i].Cells[3].Value.ToString(), out tot))
                            total += Double.Parse(dtGrid.Rows[i].Cells[3].Value.ToString());
                        if (double.TryParse(dtGrid.Rows[i].Cells[5].Value.ToString(), out tot))
                            partDocteur += Double.Parse(dtGrid.Rows[i].Cells[5].Value.ToString());
                    }
                }
                else
                {
                    if (dtGrid.Rows[i].DefaultCellStyle.BackColor == Color.Yellow)
                    {
                        graphic.FillRectangle(Brushes.SteelBlue, unite_largeur - 5, Yloc, 11 * unite_largeur + 15, unite_hauteur - 2);
                        graphic.DrawString(dtGrid.Rows[i].Cells[0].Value.ToString(), fnt2, Brushes.White, unite_largeur, Yloc);
                    }
                    else if (dtGrid.Rows[i].DefaultCellStyle.BackColor == Color.GreenYellow)
                    {
                        graphic.FillRectangle(Brushes.Lavender, unite_largeur - 5, Yloc, 11 * unite_largeur + 15, unite_hauteur - 2);
                    ...
                    {
                        graphic.FillRectangle(Brushes.LightSteelBlue, unite_largeur - 5, Yloc, 20 * unite_largeur + 3, unite_hauteur - 2);
                        graphic.FillRectangle(Brushes.LightSteelBlue, 21 * unite_largeur, Yloc, 3 * unite_largeur - 5, unite_hauteur - 2);
                        graphic.DrawString(dtGrid.Rows[i].Cells[0].Value.ToString(), fnt1, Brushes.Black, unite_largeur, Yloc);
                        graphic.DrawString(dtGrid.Rows[i].Cells[1].Value.ToString(), fnt1, Brushes.Black, 22 * unite_largeur + 0, Yloc);
                    }
                }

                j++;
            }
            graphic.FillRectangle(Brushes.White, unite_largeur-10, 50* unite_hauteur-2, 24* unite_largeur , 8 * unite_hauteur);
            ...
            GestionPharmacetique.AppCode.Employe employe, string titreRapport)
        {
            ...
            {
                Image logo = global::GestionDuneClinique.Properties.Resources.logo;
                graphic.DrawImage(logo, unite_largeur, 2 * unite_hauteur, 12*unite_largeur, 3*unite_hauteur+15);
            }
            catch { }
            //definir les polices 
            Font fnt1 = new Font("Century Gothic", 11, FontStyle.Regular);
             ...
             GestionPharmacetique.AppCode.Employe employe, string titreRapport)
        {
            ...
            {
                Image logo = global::GestionDuneClinique.Properties.Resources.logo;
                graphic.DrawImage(logo,  unite_largeur, 2 * unite_hauteur, 12 * unite_largeur, 4* unite_hauteur);
            }
            catch { }
            //definir les polices 
            Font fnt1 = new Font("Century Gothic", 11, FontStyle.Regular);
            Font fnt11 = new Font("Century Gothic", 8, FontStyle.Regular);
            Font fnt2 = new Font("Bodoni MT", 28, FontStyle.Bold);
            Font fnt3 = new Font("Century Gothic", 11, FontStyle.Bold);

            graphic.DrawString("Page 1 ", fnt11, Brushes.Black, 22 * unite_largeur, 5);
             #endregion

            graphic.DrawString("N'Djamena le :  " + DateTime.Now.ToString(), fnt1, Brushes.Black, unite_largeur, 7 * unite_hauteur + 10);

            //graphic.DrawString("information employé", fnt1, Brushes.Black, 5 * unite_largeur, 6 * unite_hauteur);
            if (employe != null)
            {
                graphic.FillRectangle(Brushes.Lavender, unite_largeur - 5, 6 * unite_hauteur, 23 * unite_largeur ,
                    unite_hauteur);
                graphic.DrawString("CAISSIER(E) :  " +employe.NomEmployee.ToUpper(), fnt1, Brushes.Black, 5 * unite_largeur, 6 * unite_hauteur);
            }
            graphic.DrawString(titreRapport, fnt1, Brushes.Black, unite_largeur, 8 * unite_hauteur + 10);

            graphic.FillRectangle(Brushes.Lavender, unite_largeur - 5, 10 * unite_hauteur, 23 * unite_largeur + 0, unite_hauteur);
            graphic.DrawString("Date ", fnt3, Brushes.Black, unite_largeur, 10 * unite_hauteur);
            graphic.DrawString("Patient  ", fnt3, Brushes.Black, 5 * unite_largeur + 15, 10 * unite_hauteur);
            graphic.DrawString("Montant ", fnt3, Brushes.Black, 18 * unite_largeur + 15, 10 * unite_hauteur);
            graphic.DrawString("Payé ", fnt3, Brushes.Black, 21 * unite_largeur + 15, 10 * unite_hauteur);
            var totalPaye = 0.0;
            var total= 0.0;
            for (var i = 0; i <= dtGrid.Rows.Count - 1; i++)
            {
                var Yloc = unite_hauteur * i + 11 * unite_hauteur + 5;
                graphic.DrawString(i + " " +dtGrid.Rows[i].Cells[0].Value.ToString(), fnt1, Brushes.Black, unite_largeur, Yloc);
                graphic.DrawString(dtGrid.Rows[i].Cells[1].Value.ToString(), fnt1, Brushes.Black, 5* unite_largeur+15, Yloc);
                graphic.DrawString(dtGrid.Rows[i].Cells[2].Value.ToString(), fnt1, Brushes.Black, 18 * unite_largeur + 15, Yloc);
                graphic.DrawString(dtGrid.Rows[i].Cells[3].Value.ToString(), fnt1, Brushes.Black, 21 * unite_largeur + 15, Yloc);
                totalPaye += Double.Parse(dtGrid.Rows[i].Cells[3].Value.ToString());
                total += Double.Parse(dtGrid.Rows[i].Cells[2].Value.ToString());
            }
            graphic.FillRectangle(Brushes.White, unite_largeur - 5, 49 * unite_hauteur + 5, 24 * unite_largeur + 0, 5*unite_hauteur);
            if (dtGrid.Rows.Count <= 38)
            {
                graphic.FillRectangle(Brushes.Lavender, unite_largeur - 5, 49 * unite_hauteur + 5, 23 * unite_largeur + 0, unite_hauteur);
                graphic.DrawString("Total : " + string.Format(elGR, "{0:0,0}", total) + " F CFA", fnt3, Brushes.Black, 1 * unite_largeur + 5, 49 * unite_hauteur + 5);
                graphic.DrawString("Total payé :  " + string.Format(elGR, "{0:0,0}", totalPaye) + " F CFA", fnt3, Brushes.Black, 9 * unite_largeur - 15, 49 * unite_hauteur + 5);
                graphic.DrawString("Reste à payer :  " + string.Format(elGR, "{0:0,0}", total - totalPaye) + " F CFA", fnt3, Brushes.Black, 16 * unite_largeur, 49 * unite_hauteur + 5);
            }
        ...
        GestionPharmacetique.AppCode.Employe employe, string titreRapport, int numeroPage, int index, int start)
        {
            ...
            graphic.FillRectangle(Brushes.Lavender, unite_largeur - 5, 3 * unite_hauteur, 23 * unite_largeur + 2, unite_hauteur);
            graphic.DrawString("Date ", fnt3, Brushes.Black, unite_largeur, 3 * unite_hauteur);
            graphic.DrawString("Patient  ", fnt3, Brushes.Black, 5 * unite_largeur + 15, 3 * unite_hauteur);
            graphic.DrawString("Montant ", fnt3, Brushes.Black, 18 * unite_largeur + 15, 3 * unite_hauteur);
            graphic.DrawString("Payé ", fnt3, Brushes.Black, 21 * unite_largeur + 15, 3 * unite_hauteur);
            ...
            {
                totalPaye += Double.Parse(dtRows.Cells[3].Value.ToString());
                total += Double.Parse(dtRows.Cells[2].Value.ToString());
            }
            for (var i = 38 + start * index; i <= dtGrid.Rows.Count - 1; i++)
            {
                var Yloc = unite_hauteur * j + 4 * unite_hauteur + 3;
                graphic.DrawString(i + " " + dtGrid.Rows[i].Cells[0].Value.ToString(), fnt1, Brushes.Black, unite_largeur, Yloc);
                graphic.DrawString(dtGrid.Rows[i].Cells[1].Value.ToString(), fnt1, Brushes.Black, 5 * unite_largeur + 15, Yloc);
                graphic.DrawString(dtGrid.Rows[i].Cells[2].Value.ToString(), fnt1, Brushes.Black, 18 * unite_largeur + 15, Yloc);
                graphic.DrawString(dtGrid.Rows[i].Cells[3].Value.ToString(), fnt1, Brushes.Black, 21 * unite_largeur + 15, Yloc);
            ...
            graphic.FillRectangle(Brushes.White, unite_largeur - 15, 49 * unite_hauteur + 5, 25* unite_largeur + 0, 5*unite_hauteur);
            if  (dtGrid.Rows.Count <= 38 + index * (1 + start))
            {
                graphic.FillRectangle(Brushes.Lavender, unite_largeur - 5, 49 * unite_hauteur+5, 23 * unite_largeur + 0, unite_hauteur);
                graphic.DrawString("Total : " + string.Format(elGR, "{0:0,0}", total) + " F CFA", fnt3, Brushes.Black, 1 * unite_largeur + 5, 49 * unite_hauteur + 5);
                graphic.DrawString("Total payé :  " + string.Format(elGR, "{0:0,0}", totalPaye) + " F CFA", fnt3, Brushes.Black, 9 * unite_largeur-15, 49 * unite_hauteur + 5);
    ...
    fnt22, Brushes.Black, 10 * unite_largeur-15, 13 * unite_hauteur);
        ...
        public static Bitmap ListeDesExamen(DataGridView dgvView , int start)
        {
            ...
            try
            {
                ...
                {
                    Image logo = global::GestionDuneClinique.Properties.Resources.logo;
                    graphic.DrawImage(logo, unite_largeur, 10, 23 * unite_largeur, 6 * unite_hauteur);
                }
                catch { }
                //definir les polices 
                Font fnt1 = new Font("Century Gothic", 11, FontStyle.Regular);
                ...
                graphic.FillRectangle(Brushes.DodgerBlue, unite_largeur, 9*unite_hauteur-2, unite_largeur * 2 - 18, unite_hauteur +2);
                graphic.FillRectangle(Brushes.DodgerBlue, unite_largeur * 3-16, 9 * unite_hauteur - 2, unite_largeur * 14 -8, unite_hauteur + 2);
                graphic.FillRectangle(Brushes.DodgerBlue, unite_largeur * 16 +10, 9 * unite_hauteur - 2, unite_largeur * 2 +16, unite_hauteur + 2);
                graphic.FillRectangle(Brushes.DodgerBlue, unite_largeur * 19 -4, 9 * unite_hauteur - 2, unite_largeur * 2 + 16, unite_hauteur + 2);
                graphic.FillRectangle(Brushes.DodgerBlue, unite_largeur * 21 + 14, 9 * unite_hauteur - 2, unite_largeur * 2 + 16, unite_hauteur + 2);
               
                graphic.DrawString("N°".ToUpper(), fnt22, Brushes.White, unite_largeur + 15, 9 * unite_hauteur);
                graphic.DrawString("TYPE D'EXAMEN ".ToUpper(), fnt22, Brushes.White, 3* unite_largeur -10, 9 * unite_hauteur);
                graphic.DrawString("FRAIS P".ToUpper(), fnt1, Brushes.White, 16 * unite_largeur + 20, 9 * unite_hauteur);
                graphic.DrawString("FRAIS MI".ToUpper(), fnt1, Brushes.White, 19 * unite_largeur + 2, 9 * unite_hauteur);
                graphic.DrawString("FRAIS CN".ToUpper(), fnt22, Brushes.White, 21 * unite_largeur + 18, 9 * unite_hauteur);
                ...
                for (var i = start * 40; i <= dgvView.Rows.Count - 1; i++)
                {
                    ...
                    //graphic.FillRectangle(Brushes.LightSteelBlue, unite_largeur, Yloc, unite_largeur * 2 - 3, unite_hauteur - 2);
                    //graphic.FillRectangle(Brushes.LightSteelBlue, unite_largeur * 3, Yloc, unite_largeur * 18 - 3, unite_hauteur - 2);
                    //graphic.FillRectangle(Brushes.LightSteelBlue, unite_largeur * 21 - 1, Yloc, unite_largeur * 3 - 3, unite_hauteur - 2);


                    if (dgvView.Rows[i].Cells[2].Value.ToString().Length > 70)

                        graphic.DrawString(dgvView.Rows[i].Cells[2].Value.ToString().Substring(0, 70) + "...", fnt1, Brushes.Black, 3 * unite_largeur-10, Yloc);
                    else
                        graphic.DrawString(dgvView.Rows[i].Cells[2].Value.ToString(), fnt1, Brushes.Black, 3 * unite_largeur -10, Yloc);

                    graphic.DrawString((i+1).ToString(), fnt1, Brushes.Black, 15+unite_largeur, Yloc);
                    graphic.DrawString(dgvView.Rows[i].Cells[3].Value.ToString(), fnt1, Brushes.Black, 16 * unite_largeur+20, Yloc);
                    graphic.DrawString(dgvView.Rows[i].Cells[4].Value.ToString(), fnt1, Brushes.Black, 19 * unite_largeur + 5, Yloc);
                    graphic.DrawString(dgvView.Rows[i].Cells[5].Value.ToString(), fnt1, Brushes.Black, 21 * unite_largeur + 20, Yloc);
                    j++;
                }
        ...
        public static Bitmap ImprimerRapportComptabilite(string titre, System.Windows.Forms.DataGridView dgvRapport, int start)
        {
            ...
            {
                Image logo = global::GestionDuneClinique.Properties.Resources.logo;
                graphic.DrawImage(logo, unite_largeur, 5, 12 * unite_largeur, 3 * unite_hauteur);
            }
            catch (Exception)
            { }
            ...
            graphic.FillRectangle(Brushes.SaddleBrown, unite_largeur, 6 * unite_hauteur - 9, 23 * unite_largeur, unite_hauteur + 10);
            graphic.DrawString(dgvRapport.Columns[0].HeaderText, fnt1, Brushes.White, 10 + unite_largeur,6 * unite_hauteur - 10);
            graphic.DrawString(dgvRapport.Columns[2].HeaderText, fnt1, Brushes.White, 8 * unite_largeur, 6 * unite_hauteur - 5);
            graphic.DrawString(dgvRapport.Columns[3].HeaderText, fnt1, Brushes.White, 20 * unite_largeur, 6 * unite_hauteur - 5);
            ...
            for (var i = start * 48; i <= dgvRapport.Rows.Count - 1; i++)
            {
                ...
                {
                    graphic.DrawString(dgvRapport.Rows[i].Cells[2].Value.ToString(), fnt11, Brushes.Black, 5*unite_largeur + 10, Yloc);
                ...
                else
                {
                    ...
                    graphic.DrawString(dgvRapport.Rows[i].Cells[2].Value.ToString(), fnt1, Brushes.Black, 5 * unite_largeur + 15, Yloc);
        ...
        public static Bitmap ImprimerStatistiqueDeLaboratoire(DataGridView dgvExamen, DateTime dt1, DateTime dt2, int index)
        {
            #region facture1
            //les dimension de la facture
            int unite_hauteur = 23;
            ...
            int hauteur_facture = 35 * unite_hauteur + 7;
            ...
            for (var rows = 0; rows < 2; rows++)
            {
                for (var cols = 0; cols < dgvExamen.Columns.Count; cols++)
                {
                    var columns = dgvExamen.Columns[cols].HeaderText;
                    if (columns.ToLower().Contains(" "))
                    {
                        columns = columns.Substring(0, columns.IndexOf(" ")) +
                            "\n " + columns.Substring(columns.IndexOf(" ") + 1);
                    ...
                    else if (cols > 9 && cols < dgvExamen.Columns.Count - 1)
                    {
                        xLoc = unite_largeur * 8 + unite_largeur * cols * 3;
                        graphic.DrawString(columns
            ...
            for(var rows =0 ; rows <2; rows++)
            {
                ...
                if (rows == 0)
                {
                    ...
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[1].Value.ToString()
                         , fnt33, Brushes.Black, unite_largeur * 9 + 15, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[3].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 12 +15, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[5].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 15 + 15, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[7].Value.ToString()
                ...
                else if(rows==1)
                {
                    ...
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[0].Value.ToString()
                          , fnt33, Brushes.Black, 18, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[1].Value.ToString()
                         , fnt33, Brushes.Black, unite_largeur * 9 +16, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[2].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 11, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[3].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 12 + 9, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[4].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 14 -7, yLoc + 5);

                    graphic.DrawString(dgvExamen.Rows[rows].Cells[5].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 15 + 14, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[6].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 16 + 30, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[7].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 18 + 10, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[8].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 19 + 25, yLoc + 5);

                    graphic.DrawString(dgvExamen.Rows[rows].Cells[9].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 21 + 1, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[10].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 22 + 16, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[11].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 24 + 1, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[12].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 25 + 17, yLoc + 5);

                    graphic.DrawString(dgvExamen.Rows[rows].Cells[13].Value.ToString()
                , fnt33, Brushes.Black, unite_largeur * 27 + 1, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[14].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 28 + 16, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[15].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 30 + 1, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[16].Value.ToString()
                        , fnt33, Brushes.Black, unite_largeur * 31 + 17, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[17].Value.ToString()
                       , fnt33, Brushes.Black, unite_largeur * 33 + 1, yLoc + 5);
                    graphic.DrawString(dgvExamen.Rows[rows].Cells[18].Value.ToString()
            ...
            var p = 0;
            for (var rows = 2+(index*21); rows < dgvExamen.Rows.Count; rows++)
            {
                var yLoc = 6 * unite_hauteur + 24+ 30 * p;
                #region
                //else 
                {
                    graphic.DrawRectangle(Pens.Black, 10, yLoc, 9 * unite_largeur - 10, 30);
            ...
            #endregion
            graphic.FillRectangle(Brushes.White, 0, 34 * unite_hauteur + 12, 38 * unite_largeur - 10, 120);
            return bitmap;
        }


        public static Bitmap ImprimerStatistiqueDePharmacie(DataGridView dgvConsultation, DateTime dt1, DateTime dt2, int index)
        {
            #region facture1
            //les dimension de la facture
            int unite_hauteur = 23;
            int unite_largeur = 32;
            int largeur_facture = 36 * unite_largeur;
            int hauteur_facture = 34 * unite_hauteur + 15;
            ...
            #region Rows
              ...
              var p = 0;
            for (var rows = 1+(index*21); rows < dgvConsultation.Rows.Count; rows++)
            {
                var yLoc = 5 * unite_hauteur + 17 + 30 * p;
            ...
            #endregion
            graphic.FillRectangle(Brushes.White, 0, 33 * unite_hauteur + 4, 38 * unite_largeur - 10, 120);
            return bitmap;
        }


        public static Bitmap ImprimerUnProgramme(Programme programme,DataGridView dgvProgramme)
        {
            #region facture1
            //les dimension de la facture
            int unite_hauteur = 20;
            ...
            graphic.DrawString(programme.Libelle, fnt3, Brushes.Black, 2 * unite_largeur, 10);

            graphic.FillRectangle(Brushes.YellowGreen, 16, 1 * unite_hauteur + 20, 40 * unite_largeur + 12, 1 * unite_hauteur);

            #region Columns
            var xLoc = 0;
            for (var rows = 0; rows < 2; rows++)
            {
                for (var cols = 1; cols < dgvProgramme.Columns.Count; cols++)
                {
                    var columns = dgvProgramme.Columns[cols].HeaderText;
                    if (columns.ToLower().Contains(" "))
                    {
                        columns = columns.Substring(0, columns.IndexOf(" ")) +
                                  "\n " + columns.Substring(columns.IndexOf(" ") + 1);
                    ...
                    //if (cols == 0)
                    //{
                    double divident = (double)dgvProgramme.Columns[cols].Width / dgvProgramme.Width;
                    xLoc += (int)(35*unite_largeur *divident);
                    //}
                    //else if (cols == 1)
                    //{
                    //    xLoc = unite_largeur * 15 - 16;
                    ...
                    if (cols == 1)
                    {
                        largeur = (int)divident * unite_largeur;
                        graphic.DrawRectangle(Pens.Black, 18, 1 * unite_hauteur + 18, 12 * unite_largeur + 16, 1 * unite_hauteur + 16);
                        graphic.DrawString(columns
                            , fnt33, Brushes.Black, 20, 1 * unite_hauteur + 20);
                    }
                    else
                    {
                        var medium = 35 * unite_largeur / (dgvProgramme.ColumnCount - 1);
                         largeur = (int) (divident *unite_largeur*medium );
                        graphic.DrawRectangle(Pens.Black, xLoc+largeur-15, 1 * unite_hauteur + 18, largeur, 1 * unite_hauteur + 16); graphic.DrawString(columns
                        , fnt33, Brushes.Black, xLoc, 1* unite_hauteur + 20);
                    }
                }
            }
            #endregion
            ...
            //#region Rows
            //for (var rows = 0; rows < dgvProgramme.Rows.Count; rows++)
            //{
            //    var yLoc = 4 * unite_hauteur + 10 + 30 * rows;
            ...
            //    if (rows == 0)
            //    {
            //        graphic.DrawString(dgvProgramme.Rows[rows].Cells[0].Value.ToString()
            //            , fnt33, Brushes.Black, unite_largeur * 6, yLoc + 5);
            //        graphic.DrawString(dgvProgramme.Rows[rows].Cells[1].Value.ToString()
            //            , fnt33, Brushes.Black, unite_largeur * 14 + 1, yLoc + 5);
            //        graphic.DrawString(dgvProgramme.Rows[rows].Cells[2].Value.ToString()
            //            , fnt33, Brushes.Black, unite_largeur * 16 + 17, yLoc + 5);
            //        graphic.DrawString(dgvProgramme.Rows[rows].Cells[3].Value.ToString()
            //            , fnt33, Brushes.Black, unite_largeur * 19 + 0, yLoc + 5);
            //        graphic.DrawString(dgvProgramme.Rows[rows].Cells[4].Value.ToString()
            //            , fnt33, Brushes.Black, unite_largeur * 21 + 16, yLoc + 5);
            //        graphic.DrawString(dgvProgramme.Rows[rows].Cells[5].Value.ToString()
            //            , fnt0, Brushes.Black, unite_largeur * 23 + 6, yLoc + 5);
            //        graphic.DrawString(dgvProgramme.Rows[rows].Cells[6].Value.ToString()
            //            , fnt0, Brushes.Black, unite_largeur * 25 + 23, yLoc + 5);
            //        graphic.DrawString(dgvProgramme.Rows[rows].Cells[7].Value.ToString()
            //            , fnt0, Brushes.Black, unite_largeur * 28 + 0, yLoc + 5);
            //        graphic.DrawString(dgvProgramme.Rows[rows].Cells[8].Value.ToString()
            //            , fnt0, Brushes.Black, unite_largeur * 30 + 15, yLoc + 5);
            //        graphic.DrawString(dgvProgramme.Rows[rows].Cells[9].Value.ToString()
            //            , fnt0, Brushes.Black, unite_largeur * 33 + 15, yLoc + 5);
            //    }
            //    else
            //    {
