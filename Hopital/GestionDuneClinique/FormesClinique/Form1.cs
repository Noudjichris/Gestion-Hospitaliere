...
namespace GestionAcademique
{
    public partial class Form1 : Form
    {
        ...
        private void menuStrip1_Paint(object sender, PaintEventArgs e)
        {
            ...
            var linearGradientBrush = new LinearGradientBrush(area1,    Color.DodgerBlue, Color.SteelBlue, LinearGradientMode.Vertical);
            mGraphics.FillRectangle(linearGradientBrush, area1);
            mGraphics.DrawRectangle(pen1, area1);
        }
       ...
       public static int  height, width, xLocation, yLocation;
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                var path2 = @"C:\\Backup Folder\\Donnees_SGSP_du_" + DateTime.Now.ToShortDateString().Trim().Replace("/", "_") + "_" + DateTime.Now.ToShortTimeString().Replace(":", "_");
                ...
                GestionDuneClinique.AppCode.ConnectionClassSGSP.Backup(path2);
            }
            catch (Exception Exception) 
            {
                MonMessageBox.ShowBox("Back up", Exception);
            }
        }
        ...
        private void lunettesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var frm = new GestionDuneClinique.FormesClinique.LunetteFrm();
            frm.ShowDialog();
        }
        ...
        private void planningsDeTravailToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var frm = new GestionDuneClinique.FormesClinique.ProgrammeFrm();
            frm.Size = new Size(GestionAcademique.Form1.width, GestionAcademique.Form1.height);
            frm.Location = new Point(xLocation, yLocation);
            frm.ShowDialog();
        }
        ...
        private void facturesDesConventionn2ToolStripMenuItem_Click(object sender, EventArgs e)
        {
