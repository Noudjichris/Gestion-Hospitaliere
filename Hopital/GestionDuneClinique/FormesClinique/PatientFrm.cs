    ...
    public partial class PatientFrm : Form
    {
                    ...
                    try
                    {
                        ...
                        foreach (Patient patient in listePatient)
                        {
                            ...
                            dgvPatient.Rows.Add(
                                ...
                                patient.SousCouvert,
                                patient.NomEntreprise,
                                patient.Couvert,patient.Matricule
                                );
                        }
                    }
                    catch { }
            ...
            try
            {
                if (DateFrm.ShowBox())
                {
                    ...
                    if (dgvPatient.SelectedRows.Count > 0)
                    {
                        ...
                        var date = jour.ToString() + "_" + mois.ToString() + "_" + year.ToString() + "_" + hour + "_" +
                                   min + "_" + sec;
                        ...
                        {
                            var rapportCaissier = Impression.RapportPatient("RAPPORTS DES ACTES DU PATIENT ", patient,
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (EmployeEntreprise entreEmpl in listeEmpl)
                {
                    if(entreEmpl.Nom==comboBox1.Text)
