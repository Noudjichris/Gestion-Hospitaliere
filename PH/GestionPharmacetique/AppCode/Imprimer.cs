   ...
   public  class Imprimer
    {
       ...
       #region InventaireStock
            ...
            int index, DateTime dt,double total, bool flag)
        {
            ...
            {
                Image logo = global::GestionPharmacetique.Properties.Resources.logo;
                graphic.DrawImage(logo, 15,  5,12 * unite_largeur, 3 * unite_hauteur+5);
            }
            catch { }
            graphic.FillRectangle(Brushes.Lavender, 15, 4 * unite_hauteur +5, unite_largeur * 23 , unite_hauteur + 8);

            graphic.DrawString("Inventaire de stock " +typeInventaire + " du " + dt.ToString(), fnt3, Brushes.Black, unite_largeur * 5, 4 * unite_hauteur+7);
           ...
           graphic.DrawString("Expire le".ToUpper(), fnt11, Brushes.Black, 11 * unite_largeur + 15, 7 * unite_hauteur - 2);
            ...
            for (int i = index * 45; i < dgvInventaire.Rows.Count; i++)
            {
                ...
                {
                    //numero--;
                    graphic.FillRectangle(Brushes.Lavender, 15, Yloc+1, unite_largeur * 23 + 0, unite_hauteur -2);
        ...
        public static Bitmap ImprimerEvaluationInventaireStockPage(DataGridView dgvInventaire, string typeInventaire,
          int index, DateTime dt, double total, bool flag)
        {
            ...
            graphic.FillRectangle(Brushes.Lavender, unite_largeur * 14, 7 * unite_hauteur - 5, unite_largeur * 2 - 3, unite_hauteur + 8);
            graphic.FillRectangle(Brushes.Lavender, unite_largeur * 16, 7 * unite_hauteur - 5, unite_largeur * 2 - 3, unite_hauteur + 8);
            graphic.FillRectangle(Brushes.Lavender, unite_largeur * 18, 7 * unite_hauteur - 5, unite_largeur * 2 +13, unite_hauteur + 8);
            graphic.FillRectangle(Brushes.Lavender, unite_largeur * 20+16, 7 * unite_hauteur - 5, unite_largeur * 3 + 0, unite_hauteur + 8);

            graphic.DrawString("N°".ToUpper(), fnt11, Brushes.Black, 20, 7 * unite_hauteur - 2);
            graphic.DrawString("designation".ToUpper(), fnt11, Brushes.Black, unite_largeur * 2, 7 * unite_hauteur - 2);
            graphic.DrawString("Ecart".ToUpper(), fnt11, Brushes.Black, 11 * unite_largeur + 15, 7 * unite_hauteur - 2);
            graphic.DrawString("PRIX ACHAT".ToUpper(), fnt11, Brushes.Black, 14 * unite_largeur + 2, 7 * unite_hauteur - 2);
            graphic.DrawString("PRIX VENTE".ToUpper(), fnt11, Brushes.Black, 16 * unite_largeur + 0, 7 * unite_hauteur - 2);
            graphic.DrawString("TOTAL ACHAT".ToUpper(), fnt11, Brushes.Black, 18 * unite_largeur + 2, 7 * unite_hauteur - 2);
            graphic.DrawString("TOTAL VENTE".ToUpper(), fnt11, Brushes.Black, 20 * unite_largeur + 20, 7 * unite_hauteur - 2);
            ...
            for (int i = index * 45; i < dgvInventaire.Rows.Count; i++)
            {
                ...
                else
                {
                    ...
                    graphic.DrawRectangle(Pens.Black, unite_largeur * 14, Yloc, unite_largeur * 2 - 3, unite_hauteur + 0);
                    graphic.DrawRectangle(Pens.Black, unite_largeur * 16, Yloc, unite_largeur * 2 - 3, unite_hauteur + 0);
                    graphic.DrawRectangle(Pens.Black, unite_largeur * 18, Yloc, unite_largeur * 2 +13, unite_hauteur + 0);
                    graphic.DrawRectangle(Pens.Black, unite_largeur * 20+16, Yloc, unite_largeur * 3 + 1, unite_hauteur + 0);
                    ...
                    if (flag)
                    {
                        graphic.DrawString(dgvInventaire.Rows[i].Cells[6].Value.ToString(), fnt1, Brushes.Black, 11 * unite_largeur + 10, Yloc);
                        graphic.DrawString(dgvInventaire.Rows[i].Cells[2].Value.ToString() , fnt1, Brushes.Black, 14 * unite_largeur + 10, Yloc);
                        graphic.DrawString(dgvInventaire.Rows[i].Cells[3].Value.ToString() , fnt1, Brushes.Black, 16 * unite_largeur + 10, Yloc);
                        var totalachat = Convert.ToDecimal(dgvInventaire.Rows[i].Cells[2].Value.ToString())*Convert.ToInt32(dgvInventaire.Rows[i].Cells[6].Value.ToString());
                        var totalvente = Convert.ToDecimal(dgvInventaire.Rows[i].Cells[3].Value.ToString()) * Convert.ToInt32(dgvInventaire.Rows[i].Cells[6].Value.ToString());
                        graphic.DrawString(totalachat.ToString(), fnt1, Brushes.Black, 18 * unite_largeur + 10, Yloc);
                        graphic.DrawString(totalvente.ToString(), fnt1, Brushes.Black, 21 * unite_largeur + 10, Yloc);
            ...
            if (flag)
            {
                if (dgvInventaire.Rows.Count <= (index + 1) * +45)
                {
                    graphic.FillRectangle(Brushes.Lavender, unite_largeur, 54 * unite_hauteur + 1, unite_largeur * 26, unite_hauteur);
                    graphic.DrawString("Stock total", fnt1, Brushes.Black, 2 * unite_largeur, 54 * unite_hauteur + 2);
                    graphic.DrawString(totalAchat.ToString(), fnt1, Brushes.Black, 18 * unite_largeur + 10, 54 * unite_hauteur + 2);
                    graphic.DrawString(totalVente.ToString(), fnt1, Brushes.Black, 21 * unite_largeur + 10, 54 * unite_hauteur + 2);
                }
            }
            return bitmap;
        }
       ...
       public static Bitmap ImprimerInventaireStockAnnuel(string titre , ListView lstView, int start)
       {
           ...
           {
               Image logo = global::GestionPharmacetique.Properties.Resources.logo;
               graphic.DrawImage(logo, unite_largeur, unite_hauteur + 5, 12 * unite_largeur, 3 * unite_hauteur+15);
           }
           catch { }
           ...
           graphic.DrawString("G. depôt", fnt2, Brushes.White, 13 * unite_largeur, 8 * unite_hauteur);
           graphic.DrawString("Px. achat", fnt2, Brushes.White, 14 * unite_largeur+25, 8 * unite_hauteur);
           graphic.DrawString("Px vente", fnt2, Brushes.White, 17 * unite_largeur, 8 * unite_hauteur);
           graphic.DrawString("Achat tot.", fnt2, Brushes.White, 19 * unite_largeur + 25, 8 * unite_hauteur);
           ...
           for (var i = start * 45; i <= lstView.Items.Count - 1; i++)
           {
               ...
               graphic.DrawString(string.Format(elGR, "{0:0,0}",Double.Parse(lstView.Items[i].SubItems[3].Text)), fnt1, Brushes.Black, 13 * unite_largeur - 2, Yloc);
               graphic.DrawString(string.Format(elGR, "{0:0,0}",Double.Parse(lstView.Items[i].SubItems[4].Text)), fnt1, Brushes.Black, 15 * unite_largeur , Yloc);
               graphic.DrawString(string.Format(elGR, "{0:0,0}",Double.Parse(lstView.Items[i].SubItems[5].Text)), fnt1, Brushes.Black, 17 * unite_largeur, Yloc);
               graphic.DrawString(string.Format(elGR, "{0:0,0}",Double.Parse(lstView.Items[i].SubItems[6].Text)), fnt1, Brushes.Black, 20 * unite_largeur , Yloc);
               graphic.DrawString(string.Format(elGR, "{0:0,0}",Double.Parse(lstView.Items[i].SubItems[7].Text)), fnt1, Brushes.Black, 22 * unite_largeur + 15, Yloc);
                j++;
           }

           for (var l = 0; l < lstView.Items.Count; l++)
           {
               montantTotalAchat += Double.Parse(lstView.Items[l].SubItems[6].Text);
          ...
          if (flag)
           {
              ...
              graphic.FillRectangle(Brushes.SteelBlue, unite_largeur, 53 * unite_hauteur, 24 * unite_largeur+2, unite_hauteur);
               graphic.DrawString("Montant  total  ", fnt1, Brushes.White, unite_largeur, 53 * unite_hauteur);
               graphic.DrawString(string.Format(elGR, "{0:0,0}", montantTotalAchat), fnt1, Brushes.White, 20 * unite_largeur + 0, 53 * unite_hauteur);
               graphic.DrawString(string.Format(elGR, "{0:0,0}", montantTotalVente), fnt1, Brushes.White, 22 * unite_largeur+10, 53 * unite_hauteur);
              }
           return bitmap;
       }
