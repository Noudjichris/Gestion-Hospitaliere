   ...
   public  class Imprimer
    {
       ...
       #region InventaireStock
        public static Bitmap ImprimerInventaireStockPage(DataGridView dgvInventaire,
            int index, DateTime dt,double total, bool flag)
        {
            ...
            graphic.FillRectangle(Brushes.DimGray, unite_largeur, 6 * unite_hauteur , unite_largeur * 24 - 3, unite_hauteur + 8);

            graphic.DrawString("Inventaire magasin principal de stock du " + dt.ToString(), fnt3, Brushes.White, unite_largeur * 5, 6 * unite_hauteur+3);
            graphic.DrawString("Page " + (index + 1).ToString(), fnt1, Brushes.Black, 12 * unite_largeur, 10);

            graphic.FillRectangle(Brushes.DimGray, unite_largeur, 8 * unite_hauteur-10, unite_largeur * 11- 2, unite_hauteur + 8);
            graphic.FillRectangle(Brushes.DimGray, unite_largeur * 12, 8 * unite_hauteur-10, unite_largeur * 3 - 2, unite_hauteur + 8);
            graphic.FillRectangle(Brushes.DimGray, unite_largeur * 15, 8 * unite_hauteur-10, unite_largeur * 3 - 2, unite_hauteur + 8);
            graphic.FillRectangle(Brushes.DimGray, unite_largeur * 18, 8 * unite_hauteur-10, unite_largeur * 3 - 2, unite_hauteur + 8);
            graphic.FillRectangle(Brushes.DimGray, unite_largeur * 21, 8 * unite_hauteur-10, unite_largeur * 3 + 1, unite_hauteur + 8);

            graphic.DrawString("designation \ndu produit".ToUpper(), fnt11, Brushes.White, unite_largeur * 5, 8 * unite_hauteur-8);
            graphic.DrawString("Prix \nVente".ToUpper(), fnt11, Brushes.White, 13 * unite_largeur, 8 * unite_hauteur-8 );
            graphic.DrawString("STOCK \n PREC".ToUpper(), fnt11, Brushes.White, 16 * unite_largeur -5, 8 * unite_hauteur -8);
            graphic.DrawString("STOCK \n REEL".ToUpper(), fnt11, Brushes.White, 19 * unite_largeur - 5, 8 * unite_hauteur - 8);
            graphic.DrawString("Ecart".ToUpper(), fnt11, Brushes.White, 22 * unite_largeur , 8 * unite_hauteur -8);
            //graphic.DrawString("prix vente".ToUpper(), fnt1, Brushes.Black, 21 * unite_largeur + 10, 8 * unite_hauteur); 
            ...
            for (int i = index * 45; i < dgvInventaire.Rows.Count; i++)
            {
                ...
                graphic.DrawRectangle(Pens.Black, unite_largeur * 12, Yloc, unite_largeur * 3 - 3, unite_hauteur);
                graphic.DrawRectangle(Pens.Black, unite_largeur * 15, Yloc, unite_largeur * 3- 3, unite_hauteur);
                graphic.DrawRectangle(Pens.Black, unite_largeur * 18, Yloc, unite_largeur * 3 - 3, unite_hauteur);
                graphic.DrawRectangle(Pens.Black, unite_largeur * 21, Yloc, unite_largeur * 3, unite_hauteur);

                graphic.DrawString(dgvInventaire.Rows[i].Cells[1].Value.ToString(), fnt1, Brushes.Black, unite_largeur + 10, Yloc);
                graphic.DrawString(dgvInventaire.Rows[i].Cells[3].Value.ToString(), fnt1, Brushes.Black, 13 * unite_largeur , Yloc);
                graphic.DrawString(dgvInventaire.Rows[i].Cells[5].Value.ToString() + ",00", fnt1, Brushes.Black, 16 * unite_largeur , Yloc);
                if (flag)
                {
                   
                    graphic.DrawString(dgvInventaire.Rows[i].Cells[4].Value.ToString() + ",00", fnt1, Brushes.Black, 19 * unite_largeur, Yloc);
                    graphic.DrawString(dgvInventaire.Rows[i].Cells[6].Value.ToString() + ",00", fnt1, Brushes.Black, 22 * unite_largeur, Yloc);
                }
                else
                {
                    graphic.DrawString("", fnt1, Brushes.Black, 19 * unite_largeur, Yloc);
                    graphic.DrawString("", fnt1, Brushes.Black, 22 * unite_largeur, Yloc);
            ...
            graphic.FillRectangle(Brushes.White, unite_largeur, 54 * unite_hauteur + 1, unite_largeur * 26, unite_hauteur * 4);
            if (flag)
            {
                if (dgvInventaire.Rows.Count <= (index +1)*+45)
                {
                    graphic.FillRectangle(Brushes.DimGray, unite_largeur, 54 * unite_hauteur + 1, unite_largeur * 26, unite_hauteur);
                    graphic.DrawString("Stock total", fnt1, Brushes.White, 2 * unite_largeur, 54 * unite_hauteur + 2);
                    graphic.DrawString(total.ToString(), fnt1, Brushes.White, 22 * unite_largeur, 54 * unite_hauteur + 2);
                }
            }
            return bitmap;
        }
       ...
       public static Bitmap ImprimerInventaireStockAnnuel(string titre , ListView lstView, int start)
       {
           //les dimension de la facture
           #region
           int unite_hauteur = 20;
           ...
           bool flag = false;
           if (lstView.Items.Count <= 45 * (1 + start))
           {
           ...
           Font fnt3 = new Font("Arial Unicode MS", 14, FontStyle.Bold | FontStyle.Underline);
           Font fnt33 = new Font("Arial Unicode MS", 10, FontStyle.Regular);
           Font fnt2 = new Font("Arial Unicode MS", 9, FontStyle.Bold);
           try
           {
               Image logo = global::GestionPharmacetique.Properties.Resources.logo;
           ...
           graphic.DrawString("Page " + (start + 1).ToString(), fnt33, Brushes.Black, 12 * unite_largeur, 0);

           graphic.DrawString(titre, fnt1, Brushes.Black, unite_largeur, 7 * unite_hauteur-5 );

           graphic.FillRectangle(Brushes.SteelBlue, unite_largeur, 8 * unite_hauteur - 2, 24 * unite_largeur , unite_hauteur);
           graphic.DrawString("Désignation", fnt2, Brushes.White, unite_largeur, 8 * unite_hauteur);
           graphic.DrawString("Qté ", fnt2, Brushes.White, 12 * unite_largeur - 14, 8 * unite_hauteur);
           graphic.DrawString("G. Stock ", fnt2, Brushes.White, 13 * unite_largeur, 8 * unite_hauteur);
           graphic.DrawString("Px. achat", fnt2, Brushes.White, 14 * unite_largeur+25, 8 * unite_hauteur);
           graphic.DrawString("Achat tot.", fnt2, Brushes.White, 17 * unite_largeur , 8 * unite_hauteur);
           graphic.DrawString("Px vente", fnt2, Brushes.White, 19 * unite_largeur+25 , 8 * unite_hauteur);
           graphic.DrawString("Vente Tot.", fnt2, Brushes.White, 22 * unite_largeur+15, 8 * unite_hauteur);
       
           var montantTotalAchat = 0.0;
           var montantTotalVente = 0.0;
           var j = 0;
           for (var i = start * 45; i <= lstView.Items.Count - 1; i++)
           {
               var Yloc = unite_hauteur * j + 9 * unite_hauteur;

               graphic.DrawRectangle(Pens.Black, unite_largeur, Yloc, unite_largeur * 10+ 8, unite_hauteur - 2);
               graphic.DrawRectangle(Pens.Black, unite_largeur * 11 + 10, Yloc, unite_largeur + 15, unite_hauteur - 2);
               graphic.DrawRectangle(Pens.Black, unite_largeur * 13 - 4, Yloc, unite_largeur  +23, unite_hauteur - 2);
               graphic.DrawRectangle(Pens.Black, unite_largeur * 14 + 22, Yloc, unite_largeur * 2 - 2, unite_hauteur - 2);
               graphic.DrawRectangle(Pens.Black, unite_largeur * 16+22, Yloc, unite_largeur * 3 - 2, unite_hauteur - 2);
               graphic.DrawRectangle(Pens.Black, unite_largeur * 19+22, Yloc, unite_largeur * 3-25, unite_hauteur - 2);
               graphic.DrawRectangle(Pens.Black, unite_largeur * 22 , Yloc, unite_largeur * 3 , unite_hauteur - 2);
            

               if (lstView.Items[i].SubItems[0].Text.Length > 32)

                   graphic.DrawString(lstView.Items[i].SubItems[0].Text.Substring(0, 32) + "...", fnt1, Brushes.Black, unite_largeur, Yloc);
               else
                   graphic.DrawString(lstView.Items[i].SubItems[0].Text, fnt1, Brushes.Black, unite_largeur, Yloc);


               graphic.DrawString(lstView.Items[i].SubItems[2].Text, fnt1, Brushes.Black, 12 * unite_largeur - 19, Yloc);
               graphic.DrawString(lstView.Items[i].SubItems[3].Text, fnt1, Brushes.Black, 13 * unite_largeur - 5, Yloc);
               graphic.DrawString(lstView.Items[i].SubItems[4].Text, fnt1, Brushes.Black, 15 * unite_largeur , Yloc);
               graphic.DrawString(lstView.Items[i].SubItems[5].Text, fnt1, Brushes.Black, 17 * unite_largeur, Yloc);
               graphic.DrawString(lstView.Items[i].SubItems[6].Text, fnt1, Brushes.Black, 20 * unite_largeur , Yloc);
               graphic.DrawString(lstView.Items[i].SubItems[7].Text, fnt1, Brushes.Black, 22 * unite_largeur + 15, Yloc);
                j++;
           }

           for (var l = 0; l < lstView.Items.Count; l++)
           {
               montantTotalAchat += Double.Parse(lstView.Items[l].SubItems[7].Text);
               montantTotalVente += Double.Parse(lstView.Items[l].SubItems[7].Text);
           }
           graphic.FillRectangle(Brushes.White, unite_largeur, 54 * unite_hauteur, 25 * unite_largeur + 15, 3*unite_hauteur);
          if (flag)
           {

              graphic.FillRectangle(Brushes.SteelBlue, unite_largeur, 54 * unite_hauteur, 24 * unite_largeur+2, unite_hauteur);
               graphic.DrawString("Montant  total  ", fnt1, Brushes.White, unite_largeur, 54 * unite_hauteur);
               graphic.DrawString(string.Format(elGR, "{0:0,0}", montantTotalAchat), fnt1, Brushes.White, 17 * unite_largeur + 15, 54 * unite_hauteur);
               graphic.DrawString(string.Format(elGR, "{0:0,0}", montantTotalVente), fnt1, Brushes.White, 21 * unite_largeur, 54 * unite_hauteur);
              }
           return bitmap;
       }
