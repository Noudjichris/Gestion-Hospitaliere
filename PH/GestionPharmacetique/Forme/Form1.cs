...
namespace GestionPharmacetique
{
    public partial class Form1 : Form
    {
        ...
        private void grp_banniere_Paint(object sender, PaintEventArgs e)
        {
            ...
            LinearGradientBrush linearGradientBrush = new LinearGradientBrush(area1, Color.SkyBlue, Color.DodgerBlue, LinearGradientMode.ForwardDiagonal);
        ...
        private void grp_cote_Paint(object sender, PaintEventArgs e)
        {
            ...
            LinearGradientBrush linearGradientBrush = new LinearGradientBrush(area1, Color.DodgerBlue, Color.SkyBlue, LinearGradientMode.ForwardDiagonal);
            mGraphics.FillRectangle(linearGradientBrush, area1);
            mGraphics.DrawRectangle(pen1, area1);
        }
        ...
        private void menuStrip1_Paint(object sender, PaintEventArgs e)
        {
            ...
            LinearGradientBrush linearGradientBrush = new LinearGradientBrush(area1, Color.Black, Color.Black, LinearGradientMode.ForwardDiagonal);
            mGraphics.FillRectangle(linearGradientBrush, area1);
            mGraphics.DrawRectangle(pen1, area1);
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    label1.Text = "Systeme de Gestion du " + depot[0].NomDepot;
                }
                else
                {
                    label1.Text = "Systeme de Gestion de la " + depot[0].NomDepot;
                }
        ...
        private void SeConnecter()
        {
            if (typeUtilisateur == "caissier")
            {
                ...
                journalDesPaiementsToolStripMenuItem.Enabled = true;
                gestionDsLivraisonsToolStripMenuItem.Visible = true;
                btnInventaire.Enabled = true;
                //etatStockParDateToolStripMenuItem.Enabled = true;
                //sortieStockToolStripMenuItem1.Visible = true;
                toolStripMenuItem13.Enabled = false;
                toolStripMenuItem14.Enabled = false;
                entréeStcokToolStripMenuItem.Enabled = false;
            ...
            else if (typeUtilisateur == "admin")
            {
                ...
                entréeStcokToolStripMenuItem.Enabled = true;
            ...
            else if (typeUtilisateur == "intermediaire")
            {
                toolStripMenuItem13.Visible = true ;
                toolStripMenuItem14.Visible = true ;
                entréeStcokToolStripMenuItem.Visible = true ;
                ...
                journalDesPaiementsToolStripMenuItem.Enabled = false;
                toolStripMenuItem3.Enabled = false;
                btnParametre.Enabled = false;
                btnInventaire.Enabled = true;
            }
            else if (typeUtilisateur == "moyen")
            {
                toolStripMenuItem10.Enabled = true;
                gestionDsLivraisonsToolStripMenuItem.Visible = true;
                //administrerToolStripMenuItem.Visible = true;
        ...
        private void timerProgressBar1_Tick(object sender, EventArgs e)
        {
            ...
            {
                loginFrm.lblEtat.Text = "Connection établie  Vérification du mot de passe...";
                ...
                string mot_passe = loginFrm.txtPassword.Text.Trim().GetHashCode().ToString();
                    Utilisateur utilisateur = ConnectionClass.SeConnecter(nom_util, mot_passe);
                //linkLabel1.Text = loginFrm.txtPassword.Text + " - " + mot_passe;
                    if (utilisateur != null)
                    {
                ...
                ConnectionClass.InsererDansLog(GestionPharmacetique.Form1.nomEmploye, "Authentification reussie ", this.Name);
                //timerProgressBar2_Tick(null, null);
      ...
      public SpeechSynthesizer _synthesizer;
        ...
        private void gestionDsLivraisonsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmVente.Location = new Point(5, 33);
            frmVente.Size = new System.Drawing.Size(width1 + width2+13 , this.grp_principal.Height + 160);            
            frmVente.ShowDialog();
        }
        static int h, w;
        ...
        private void btnRapportLivraison_Click(object sender, EventArgs e)
        {
            try
            {
                StatistiquePharmacieFrm frm = new StatistiquePharmacieFrm();
            ...
            try
            {
              ...
              "TOTAL PHARMACIE DE CESSION",
                ...
                foreach (Medicament medicament in liste)
                {
                 ...
                 "", "", "", totalTMontant);
               frm.label1.Text = "Nombre de medicament expiré ou en voie d'expiration : " + frm.dataGridView1.Rows.Count  ;
               timerExpiration1.Stop();
               timerExpiration2.Stop();
        ...
        private void toolStripMenuItem13_Click(object sender, EventArgs e)
        {
            ...
            frmVente.Size = new System.Drawing.Size(width1 + width2 + 10, this.grp_principal.Height + 6);
            frmVente.ShowDialog();
        }
        ...
        private void gestionDeFamilleDeMedicamentToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                MedicamentFrm medicamentFrm = new MedicamentFrm();
                medicamentFrm.etat = "1";
                medicamentFrm.Location = new Point(grp_cote.Location.X, grp_principal.Location.Y + 25);
                medicamentFrm.Size = new System.Drawing.Size(this.grp_principal.Width + grp_cote.Width + 10, this.grp_principal.Height + 0);
        ...
        {
            var frm = new ImpoterLesDonneesExcels.Form1();
            frm.ShowDialog();
        }

        private void etatStockParDateToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void logErreurToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void logCompteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void statistiquesDépôtToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void journalToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (SGDP.Formes.DateFrm.ShowBox())
                {
                    ...
                    var frm = new CommandeRapportFrm();
                    frm.dateFin = dateFin;
                    frm.dateDebut = dateDebut;
                    frm.Size = new System.Drawing.Size(this.grp_principal.Width + this.grp_cote.Width + 10, this.grp_principal.Height);
                    frm.Location = new Point(this.grp_cote.Location.X, this.grp_cote.Location.Y + 25);
        ...
        private void ctnJournal_Opening(object sender, System.ComponentModel.CancelEventArgs e)
        {
