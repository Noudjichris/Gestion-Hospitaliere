    ...
    public partial class Form1 : Form
    {
      ...
      public SpeechSynthesizer _synthesizer;
        ...
        private void gestionDsLivraisonsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmVente.Size = new System.Drawing.Size(width1 + width2+8 , this.grp_principal.Height + 50);            
            frmVente.ShowDialog();
        }
        static int h, w;
        ...
        private void btnRapportLivraison_Click(object sender, EventArgs e)
        {
            try
            {
                StatistiqueFrm frm = new StatistiqueFrm();
            ...
            try
            {
               ...
               List<Medicament> listeArrayList = ConnectionClass.ListeDesMedicamentsExpirees();
                foreach (Medicament medicament in listeArrayList)
                {
                    ...
                    montant += medicament.Quantite * medicament.PrixVente;
                }
               frm.label1.Text = "Nombre de medicament expiré ou en voie d'expiration : " + frm.dataGridView1.Rows.Count +" montant de "+ montant ;
               timerExpiration1.Stop();
               timerExpiration2.Stop();
        ...
        private void toolStripMenuItem13_Click(object sender, EventArgs e)
        {
            ...
            frmVente.Location = new Point(grp_cote.Location.X, grp_cote.Location.Y + 20);
