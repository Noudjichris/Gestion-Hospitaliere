    ...
    dgvRapport.Rows.Clear();
                    ...
                    foreach (var fournisseur in listeFournisseur)
                    {
                        ...
                        if (listeLivraison.Rows.Count == 1)
                        {
                           ...
                           totalNetAPayer += montant;
                            dgvRapport.Rows.Add
                                (
                                   fournisseur,
                                   DateTime.Parse(listeLivraison.Rows[0].ItemArray[7].ToString()).ToShortDateString(),
                                   listeLivraison.Rows[0].ItemArray[6].ToString(),
                        ...
                        else if (listeLivraison.Rows.Count > 1)
                        {
                           ...
                           montant = montant  +double.Parse(listeLivraison.Rows[0].ItemArray[3].ToString());
                            ...
                            for (var i = 1; i < listeLivraison.Rows.Count; i++)
                            {
                                ...
                                (
                                   "",
                                    DateTime.Parse(listeLivraison.Rows[i].ItemArray[7].ToString()).ToShortDateString(),
                    ...
                    //{
                        ...
                        "TOTAL",
                        "", "",
                         String.Format(elGR, "{0:0,0}", totalNetAPayer)
                        );
                    //}
