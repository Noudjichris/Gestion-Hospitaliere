...
namespace GestionPharmacetique.AppCode
{
    public class ConnectionClass
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    foreach (DataGridViewRow dgvRow in dgvLivraison.Rows)
                    {
                        ...
                        requete = "UPDATE medicament SET prix_achat = @prix_achat, prix_vente = @prix_vente,  date_expiration =@date_expiration " +
                             "WHERE (num_medi =@num_medi)";
                        command.Parameters.Add(new MySqlParameter("num_medi",livraison.NumProduit));
                        command.Parameters.Add(new MySqlParameter("prix_achat", livraison.PrixAchat));
                        command.Parameters.Add(new MySqlParameter("prix_vente", livraison.PrixVente));
        ...
        public static List<Medicament> ListeDesMedicamentsRechercherParGroupe(string famille)
        {
            List<Medicament> listeMedicament = new List<Medicament>();
            try
            {
                string requete = @"SELECT medicament.num_medi, familleTbl.designation, medicament.nom_medi, " +
                                 ...
                                 "medicament.date_expiration, stock.quantite,medicament.nbreBoite,medicament.nbreDetail,medicament.prixDetail, stock.grd_stock FROM (((medicament INNER JOIN " +
                                 " stock ON medicament.num_medi = stock.num_medi) INNER JOIN familleTbl ON medicament.numeroFamille" +
                "= familleTbl.numeroFamille) INNER JOIN groupe_tbl ON familleTbl.id_grp = groupe_tbl.id) WHERE groupe_tbl.groupe LIKE @designation  ORDER BY medicament.nom_medi";
                command.CommandText = requete;
                connection.Open();
                command.Parameters.AddWithValue("designation", famille );
                MySqlDataReader reader = command.ExecuteReader();
        ...
        public static List<Medicament> ListeDesMedicamentsRechercherParFamilleQuantiteSupZero(string famille)
        {
            List<Medicament> listeMedicament = new List<Medicament>();
            try
            {
                string requete = @"SELECT medicament.num_medi, familleTbl.designation, medicament.nom_medi, " +
                                 ...
                                 "medicament.date_expiration, stock.quantite,medicament.nbreBoite,medicament.nbreDetail,medicament.prixDetail, stock.grd_stock FROM ((medicament INNER JOIN " +
                                 " stock ON medicament.num_medi = stock.num_medi) INNER JOIN familleTbl ON medicament.numeroFamille" +
                "= familleTbl.numeroFamille) WHERE familleTbl.designation LIKE @designation AND (stock.quantite >0 OR  stock.grd_stock>0)    ORDER BY medicament.nom_medi";
                command.CommandText = requete;
                connection.Open();
                command.Parameters.AddWithValue("designation", famille + "%");
                MySqlDataReader reader = command.ExecuteReader();
        ...
        public static List<Medicament> ListeDesMedicamentsRechercherParGroupeQuantiteSupZero(string famille)
        {
            List<Medicament> listeMedicament = new List<Medicament>();
            try
            {
                string requete = @"SELECT medicament.num_medi, familleTbl.designation, medicament.nom_medi, " +
                                 ...
                                 "medicament.date_expiration, stock.quantite,medicament.nbreBoite,medicament.nbreDetail,medicament.prixDetail, stock.grd_stock FROM (((medicament INNER JOIN " +
                                 " stock ON medicament.num_medi = stock.num_medi) INNER JOIN familleTbl ON medicament.numeroFamille" +
                "= familleTbl.numeroFamille) INNER JOIN groupe_tbl ON familleTbl.id_grp = groupe_tbl.id) WHERE groupe_tbl.groupe LIKE @designation AND (stock.quantite >0 OR  stock.grd_stock>0)    ORDER BY medicament.nom_medi";
                command.CommandText = requete;
                connection.Open();
                command.Parameters.AddWithValue("designation", famille );
                MySqlDataReader reader = command.ExecuteReader();
        ...
        public static List<Medicament> ListeDesMedicamentsExpirees()
        {
            ...
            try
            {
                ...
                var requete = "SELECT medicament.num_medi, medicament.numeroFamille, medicament.nom_medi, " +
                                  ...
                                  " @date_expiration) AND (stock.quantite >0 OR stock.grd_stock>0) ORDER BY medicament.date_expiration";
                ...
                while (reader.Read())
                {
                    ...
                    produit.Quantite = reader.GetInt32(8);
                    produit.DateExpiration = reader.GetDateTime(7);
                    produit.GrandStock =  reader.GetInt32(9) ;
                    listeMedicament.Add(produit);
                }
            }
            catch (Exception ex)
        ...
        public static List<Medicament> ListeDesLotsProduitsParCode(string Code)
        {
            ...
            try
            {
                string requete = "SELECT * FROM  lot_tbl WHERE num_prod ='" + Code + "'  ORDER BY `date`";
                command.CommandText = requete;
                connection.Open();
                MySqlDataReader reader = command.ExecuteReader();
                while (reader.Read())
        ...
        // // methode pour ajouter un nouveau medicament
        public static bool AjouterFamilleMedicament(int typeId, string typeMedicament,int idGroupe)
        {
            ...
            try
            {
                ...
                {
                    requete = string.Format("INSERT INTO `familleTbl` (`numeroFamille`, `designation`,id_grp) " +
                                            " VaLUES ({0},@designation, {1})", typeId, idGroupe);
                ...
                {
                    //requete = string.Format("UPDATE`familleTbl`  id_grp = {0} WHERE numeroFamille = {1})", idGroupe, typeId);
                    //command.CommandText = requete;
                    //command.ExecuteNonQuery();
                    return false;
                }
        ...
        public static List<Medicament> ListeDesFamille()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    familleMedicament.NombreDetail = !reader.IsDBNull(2) ? reader.GetInt32(2) : -1;
        ...
        // // methode pour modifier un nouveau medicament
        public static void ModifierFamilleMedicament(int typeId, string type_medicament,int idGrp)
        {

            try
            {
                connection.Open();
                string requete = string.Format("UPDATE familleTbl SET designation = @designation, id_grp={1} WHERE numeroFamille = {0}",
                     typeId,idGrp);
    ...
    "Information modification", "affirmation.png");
        ...
        public static void MisAjourLeDosage(string num,string numAnalye, int dosage)
        {
            try
            {
                connection.Open();
                var requete = string.Format("UPDATE `medicament` SET `dosage` = {1}, idanalyse={2} WHERE `num_medi` = ('{0}')", num, dosage,numAnalye);
        ...
        public static int DoseParUnite(string numProduit)
        {
            try
            {
                var _requete = "SELECT dosage FROM medicament WHERE num_medi= '"+numProduit +"'";
                command.CommandText = _requete;
                connection.Open();
                var reader = command.ExecuteReader();
                var dt = new DataTable();dt.Load(reader);
                int nbre;
                if (int.TryParse(dt.Rows[0].ItemArray[0].ToString(), out nbre))
                {
                    return nbre ;
                }
                else { return 0; }
        ...
        // // methode pour ajouter un nouveau medicament
        public static bool AjouterGroupeProduit(int typeId, string groupe)
        {
            string requete = string.Format(@"SELECT * FROM groupe_tbl WHERE id = {0}", typeId);
            command.CommandText = requete;
            try
            {
                connection.Open();
                ...
                if (nombreTypeMedicament < 1)
                {
                    requete = string.Format("INSERT INTO `groupe_tbl` (`groupe`) VaLUES (@designation)");
                    command.Parameters.Add(new MySqlParameter("designation", groupe));
                    command.CommandText = requete;
                    command.ExecuteNonQuery();
                    return true;
                }
                ...
                {
                    requete = string.Format("UPDATE `groupe_tbl` SET  `groupe` = @designation WHERE id = {0}",typeId);
                    command.Parameters.Add(new MySqlParameter("designation", groupe));
                    command.CommandText = requete;
                    command.ExecuteNonQuery();
                    return true;
        ...
        // // methode pour supprimer une familled de medicament
        public static bool SupprimerGroupeProduit(int id)
        {
            try
            {
                connection.Open();
               ...
               var requete = string.Format("UPDATE familletbl SET id_grp =-1 WHERE id_grp = {0}", id);
                command.CommandText = requete;
                command.Transaction = _transaction;
                command.ExecuteNonQuery();

                 requete = string.Format("DELETE FROM `groupe_tbl` WHERE `id` = {0}", id);
                command.CommandText = requete;
                command.Transaction = _transaction;
                command.ExecuteNonQuery();
        ...
        //liste des familles medicament
        public static List<Medicament> ListeDesGroupe()
        {
            var listeFamille = new List<Medicament>();
            try
            {
                string requete = "SELECT * FROM groupe_tbl WHERE id>0 ORDER BY groupe";
                command.CommandText = requete;
                connection.Open();
                MySqlDataReader reader = command.ExecuteReader();
                while (reader.Read())
                {
                    var familleMedicament = new Medicament();
                    familleMedicament.CodeFamille = reader.GetInt32(0);
                    familleMedicament.Groupe = reader.GetString(1);
                    listeFamille.Add(familleMedicament);
                }
            }
            catch (Exception ex)
        ...
        public static List<Medicament> ListeGroupe()
        {
            var listeFamille = new List<Medicament>();
            try
            {
                string requete = "SELECT * FROM groupe_tbl ORDER BY groupe";
                command.CommandText = requete;
                connection.Open();
                MySqlDataReader reader = command.ExecuteReader();
                while (reader.Read())
        ...
        public static bool EnregistrerVente(Vente vente, DataGridView dgvVente, Client client, bool part, bool remise)
        {
            bool flag = false;
            try
            {
      ...
      " WHERE detail_vente.date_vente>=@date_vente1 AND detail_vente.date_vente <@date_vente2 ORDER BY medicament.nom_medi, detail_vente.date_vente DESC, detail_vente.heure DESC";
       ...
       #region Encaissement
        ...
        public static List<Medicament> RapportStatistiqueParMontant(DateTime dateDebut, DateTime dateFin, string nomMedicament)
        {
            ...
            string query = "SELECT medicament.nom_medi, medicament.prix_vente, SUM(vente.quantite) , SUM( vente.prixTotal )," +
                 "detail_vente.date_vente FROM vente INNER JOIN detail_vente ON vente.num_vente = detail_vente.num_vente INNER JOIN medicament " +
                 " ON vente.num_medi = medicament.num_medi  WHERE (detail_vente.date_vente >= @Param1 AND detail_vente.date_vente < @Param2) AND medicament.nom_medi LIKE '%" +nomMedicament +
                 "%'  GROUP BY medicament.nom_medi  ORDER BY  medicament.nom_medi ";
                connection.Open();
                command.CommandText = query;
        ...
        public static DataTable RapportDeLivraisonGroupe( string fournisseur)
        {
            DataTable dT = new DataTable();
            try
            {
                string requete = "SELECT  medicament.nom_medi,SUM(cmd_tbl.quantite),cmd_tbl.prix_achat," +
                                 " SUM(cmd_tbl.quantite)*cmd_tbl.prix_achat FROM cmd_tbl INNER JOIN medicament ON cmd_tbl.num_medi" +
                                 "  = medicament.num_medi INNER JOIN detail_bl ON detail_bl .num_bl = cmd_tbl.num_bl INNER JOIN fournisseur "+
                                 " ON fournisseur.num_fourn = detail_bl.num_fourn WHERE  fournisseur.nom_fourn LIKE @fournisseur"+
                                "  GROUP BY  medicament.nom_medi,cmd_tbl.prix_achat ORDER BY  medicament.nom_medi";
                command.Parameters.AddWithValue("fournisseur", fournisseur + "%");
                command.CommandText = requete;
                connection.Open();
                MySqlDataReader reader = command.ExecuteReader();
                dT.Load(reader);
