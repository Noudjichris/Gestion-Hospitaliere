       ...
       private void groupBox4_Paint(object sender, PaintEventArgs e)
        ...
        private void MedicamentFrm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                cmbTrie.Items.Add("");
                comboBox2.Items.Add("");
                foreach (var famille in ConnectionClass.ListeDesGroupe())
                {
                    cmbTrie.Items.Add(famille.Groupe);
                    comboBox2.Items.Add(famille.Groupe.ToUpper());
                }
       ...
       private void button5_Click(object sender, EventArgs e)
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                comboBox1.Items.Clear();
                if (comboBox2.Text != "")
                    groupe = comboBox2.Text;

                var listeFamille = from f in ConnectionClass.ListeDesFamille()
                                   join g in ConnectionClass.ListeGroupe()
                                   on f.NombreDetail equals g.CodeFamille
                                   where g.Groupe.ToUpper() == groupe.ToUpper()
                                   select new
                                   {
                                       f.Designation
                                   };
                foreach (var g in listeFamille)
                    comboBox1.Items.Add(g.Designation.ToUpper());
            }
            catch { }
        }
