    ...
    public partial class RapportVenteFrm : Form
    {
        ...
        private void RapportVenteFrm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                button1.Location = new Point(Width - 82, 4);
            ...
            try
            {
                ...
                for (int i = 0; i < dataTable.Rows.Count; i++)
                {
                    ...
                    dataGridView1.Rows.Add(
                        ...
                        double.Parse(dataTable.Rows[i].ItemArray[1].ToString()),
                         double.Parse(dataTable.Rows[i].ItemArray[2].ToString()),
                         total
                    );
                ...
                borderLabel2.Text =Montant.ToString();
                        ...
                        if (sfd.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                        {
                            ...
                            var count = dataGridView1.Rows.Count;
                                ...
                                for (var i = 0; i <= index; i++)
                                {
                                    if (i * 45 < count)
                                    {
                                        var _listeImpression = ImprimerRaportVente.ImprimerRapportDesVentes(titre, dataGridView1, i, double.Parse(borderLabel2.Text));
